...
exports.init = init;
var emitter_create = Module.cwrap("emitter_create", "TEmitter", []);
var emitter_dispatch = Module.cwrap("emitter_dispatch", "TRet", ["TEmitter", "TEvent"]);
var emitter_dispatch_simple_event = Module.cwrap("emitter_dispatch_simple_event", "TRet", ["TEmitter", "number"]);
var emitter_on = Module.cwrap("emitter_on", "number", ["TEmitter", "TEventType", "Function", "any"]);
var emitter_off = Module.cwrap("emitter_off", "TRet", ["TEmitter", "number"]);
var emitter_enable = Module.cwrap("emitter_enable", "TRet", ["TEmitter"]);
var emitter_disable = Module.cwrap("emitter_disable", "TRet", ["TEmitter"]);
var emitter_destroy = Module.cwrap("emitter_destroy", "TRet", ["TEmitter"]);
var emitter_cast = Module.cwrap("emitter_cast", "TEmitter", ["TEmitter"]);
...
var rect_create = Module.cwrap("rect_create", "TRect", ["number", "number", "number", "number"]);
var rect_set = Module.cwrap("rect_set", "TRect", ["TRect", "number", "number", "number", "number"]);
var rect_cast = Module.cwrap("rect_cast", "TRect", ["TRect"]);
var rect_destroy = Module.cwrap("rect_destroy", "TRet", ["TRect"]);
...
var bitmap_create = Module.cwrap("bitmap_create", "TBitmap", []);
var bitmap_create_ex = Module.cwrap("bitmap_create_ex", "TBitmap", ["number", "number", "number", "TBitmapFormat"]);
var bitmap_get_bpp = Module.cwrap("bitmap_get_bpp", "number", ["TBitmap"]);
var bitmap_destroy_with_self = Module.cwrap("bitmap_destroy_with_self", "TRet", ["TBitmap"]);
var bitmap_get_bpp_of_format = Module.cwrap("bitmap_get_bpp_of_format", "number", ["TBitmapFormat"]);
...
var object_unref = Module.cwrap("object_unref", "TRet", ["TObject"]);
var object_ref = Module.cwrap("object_ref", "TObject", ["TObject"]);
var object_get_type = Module.cwrap("object_get_type", "string", ["TObject"]);
var object_get_desc = Module.cwrap("object_get_desc", "string", ["TObject"]);
var object_get_size = Module.cwrap("object_get_size", "number", ["TObject"]);
var object_is_collection = Module.cwrap("object_is_collection", "boolean", ["TObject"]);
var object_set_name = Module.cwrap("object_set_name", "TRet", ["TObject", "string"]);
var object_compare = Module.cwrap("object_compare", "number", ["TObject", "TObject"]);
var object_get_prop = Module.cwrap("object_get_prop", "TRet", ["TObject", "string", "TValue"]);
var object_get_prop_str = Module.cwrap("object_get_prop_str", "string", ["TObject", "string"]);
var object_get_prop_pointer = Module.cwrap("object_get_prop_pointer", "any", ["TObject", "string"]);
var object_get_prop_object = Module.cwrap("object_get_prop_object", "TObject", ["TObject", "string"]);
var object_get_prop_int = Module.cwrap("object_get_prop_int", "number", ["TObject", "string", "number"]);
var object_get_prop_bool = Module.cwrap("object_get_prop_bool", "boolean", ["TObject", "string", "boolean"]);
var object_get_prop_float = Module.cwrap("object_get_prop_float", "number", ["TObject", "string", "number"]);
var object_get_prop_double = Module.cwrap("object_get_prop_double", "number", ["TObject", "string", "number"]);
var object_remove_prop = Module.cwrap("object_remove_prop", "TRet", ["TObject", "string"]);
var object_set_prop = Module.cwrap("object_set_prop", "TRet", ["TObject", "string", "TValue"]);
var object_set_prop_str = Module.cwrap("object_set_prop_str", "TRet", ["TObject", "string", "string"]);
var object_set_prop_object = Module.cwrap("object_set_prop_object", "TRet", ["TObject", "string", "TObject"]);
var object_set_prop_int = Module.cwrap("object_set_prop_int", "TRet", ["TObject", "string", "number"]);
var object_set_prop_bool = Module.cwrap("object_set_prop_bool", "TRet", ["TObject", "string", "boolean"]);
var object_set_prop_float = Module.cwrap("object_set_prop_float", "TRet", ["TObject", "string", "number"]);
var object_set_prop_double = Module.cwrap("object_set_prop_double", "TRet", ["TObject", "string", "number"]);
var object_copy_prop = Module.cwrap("object_copy_prop", "TRet", ["TObject", "TObject", "string"]);
var object_has_prop = Module.cwrap("object_has_prop", "boolean", ["TObject", "string"]);
var object_eval = Module.cwrap("object_eval", "TRet", ["TObject", "string", "TValue"]);
var object_can_exec = Module.cwrap("object_can_exec", "boolean", ["TObject", "string", "string"]);
var object_exec = Module.cwrap("object_exec", "TRet", ["TObject", "string", "string"]);
var object_notify_changed = Module.cwrap("object_notify_changed", "TRet", ["TObject"]);
var object_has_prop_by_path = Module.cwrap("object_has_prop_by_path", "boolean", ["TObject", "string"]);
var object_get_prop_str_by_path = Module.cwrap("object_get_prop_str_by_path", "string", ["TObject", "string"]);
var object_get_prop_pointer_by_path = Module.cwrap("object_get_prop_pointer_by_path", "any", ["TObject", "string"]);
var object_get_prop_object_by_path = Module.cwrap("object_get_prop_object_by_path", "TObject", ["TObject", "string"]);
var object_get_prop_int_by_path = Module.cwrap("object_get_prop_int_by_path", "number", ["TObject", "string", "number"]);
var object_get_prop_bool_by_path = Module.cwrap("object_get_prop_bool_by_path", "boolean", ["TObject", "string", "boolean"]);
var object_get_prop_float_by_path = Module.cwrap("object_get_prop_float_by_path", "number", ["TObject", "string", "number"]);
var object_set_prop_by_path = Module.cwrap("object_set_prop_by_path", "TRet", ["TObject", "string", "TValue"]);
var object_set_prop_str_by_path = Module.cwrap("object_set_prop_str_by_path", "TRet", ["TObject", "string", "string"]);
var object_set_prop_object_by_path = Module.cwrap("object_set_prop_object_by_path", "TRet", ["TObject", "string", "TObject"]);
var object_set_prop_int_by_path = Module.cwrap("object_set_prop_int_by_path", "TRet", ["TObject", "string", "number"]);
var object_set_prop_bool_by_path = Module.cwrap("object_set_prop_bool_by_path", "TRet", ["TObject", "string", "boolean"]);
var object_set_prop_float_by_path = Module.cwrap("object_set_prop_float_by_path", "TRet", ["TObject", "string", "number"]);
var object_can_exec_by_path = Module.cwrap("object_can_exec_by_path", "boolean", ["TObject", "string", "string"]);
var object_exec_by_path = Module.cwrap("object_exec_by_path", "TRet", ["TObject", "string", "string"]);
var object_get_prop_int8 = Module.cwrap("object_get_prop_int8", "number", ["TObject", "string", "number"]);
var object_set_prop_int8 = Module.cwrap("object_set_prop_int8", "TRet", ["TObject", "string", "number"]);
var object_get_prop_uint8 = Module.cwrap("object_get_prop_uint8", "number", ["TObject", "string", "number"]);
var object_set_prop_uint8 = Module.cwrap("object_set_prop_uint8", "TRet", ["TObject", "string", "number"]);
var object_get_prop_int16 = Module.cwrap("object_get_prop_int16", "number", ["TObject", "string", "number"]);
var object_set_prop_int16 = Module.cwrap("object_set_prop_int16", "TRet", ["TObject", "string", "number"]);
var object_get_prop_uint16 = Module.cwrap("object_get_prop_uint16", "number", ["TObject", "string", "number"]);
var object_set_prop_uint16 = Module.cwrap("object_set_prop_uint16", "TRet", ["TObject", "string", "number"]);
var object_get_prop_int32 = Module.cwrap("object_get_prop_int32", "number", ["TObject", "string", "number"]);
var object_set_prop_int32 = Module.cwrap("object_set_prop_int32", "TRet", ["TObject", "string", "number"]);
var object_get_prop_uint32 = Module.cwrap("object_get_prop_uint32", "number", ["TObject", "string", "number"]);
var object_set_prop_uint32 = Module.cwrap("object_set_prop_uint32", "TRet", ["TObject", "string", "number"]);
var object_get_prop_int64 = Module.cwrap("object_get_prop_int64", "number", ["TObject", "string", "number"]);
var object_set_prop_int64 = Module.cwrap("object_set_prop_int64", "TRet", ["TObject", "string", "number"]);
var object_get_prop_uint64 = Module.cwrap("object_get_prop_uint64", "number", ["TObject", "string", "number"]);
var object_set_prop_uint64 = Module.cwrap("object_set_prop_uint64", "TRet", ["TObject", "string", "number"]);
...
var value_set_bool = Module.cwrap("value_set_bool", "TValue", ["TValue", "boolean"]);
var value_bool = Module.cwrap("value_bool", "boolean", ["TValue"]);
var value_set_int8 = Module.cwrap("value_set_int8", "TValue", ["TValue", "number"]);
var value_int8 = Module.cwrap("value_int8", "number", ["TValue"]);
var value_set_uint8 = Module.cwrap("value_set_uint8", "TValue", ["TValue", "number"]);
var value_uint8 = Module.cwrap("value_uint8", "number", ["TValue"]);
var value_set_int16 = Module.cwrap("value_set_int16", "TValue", ["TValue", "number"]);
var value_int16 = Module.cwrap("value_int16", "number", ["TValue"]);
var value_set_uint16 = Module.cwrap("value_set_uint16", "TValue", ["TValue", "number"]);
var value_uint16 = Module.cwrap("value_uint16", "number", ["TValue"]);
var value_set_int32 = Module.cwrap("value_set_int32", "TValue", ["TValue", "number"]);
var value_int32 = Module.cwrap("value_int32", "number", ["TValue"]);
var value_set_uint32 = Module.cwrap("value_set_uint32", "TValue", ["TValue", "number"]);
var value_set_int64 = Module.cwrap("value_set_int64", "TValue", ["TValue", "number"]);
var value_int64 = Module.cwrap("value_int64", "number", ["TValue"]);
var value_set_uint64 = Module.cwrap("value_set_uint64", "TValue", ["TValue", "number"]);
var value_uint64 = Module.cwrap("value_uint64", "number", ["TValue"]);
var value_set_float = Module.cwrap("value_set_float", "TValue", ["TValue", "number"]);
var value_float32 = Module.cwrap("value_float32", "number", ["TValue"]);
var value_set_double = Module.cwrap("value_set_double", "TValue", ["TValue", "number"]);
var value_double = Module.cwrap("value_double", "number", ["TValue"]);
var value_dup_str = Module.cwrap("value_dup_str", "TValue", ["TValue", "string"]);
var value_str = Module.cwrap("value_str", "string", ["TValue"]);
var value_str_ex = Module.cwrap("value_str_ex", "string", ["TValue", "string", "number"]);
var value_is_null = Module.cwrap("value_is_null", "boolean", ["TValue"]);
var value_set_int = Module.cwrap("value_set_int", "TValue", ["TValue", "number"]);
var value_set_object = Module.cwrap("value_set_object", "TValue", ["TValue", "TObject"]);
var value_object = Module.cwrap("value_object", "TObject", ["TValue"]);
var value_set_token = Module.cwrap("value_set_token", "TValue", ["TValue", "number"]);
var value_token = Module.cwrap("value_token", "number", ["TValue"]);
var value_create = Module.cwrap("value_create", "TValue", []);
var value_destroy = Module.cwrap("value_destroy", "TRet", ["TValue"]);
var value_reset = Module.cwrap("value_reset", "TRet", ["TValue"]);
var value_cast = Module.cwrap("value_cast", "TValue", ["TValue"]);
var tk_init = Module.cwrap("tk_init", "TRet", ["number", "number", "TAppType", "string", "string"]);
var tk_run = Module.cwrap("tk_run", "TRet", []);
var tk_quit = Module.cwrap("tk_quit", "TRet", []);
var tk_get_pointer_x = Module.cwrap("tk_get_pointer_x", "number", []);
var tk_get_pointer_y = Module.cwrap("tk_get_pointer_y", "number", []);
var tk_is_pointer_pressed = Module.cwrap("tk_is_pointer_pressed", "boolean", []);
var BIDI_TYPE_AUTO = Module.cwrap("BIDI_TYPE_AUTO", "number", []);
var BIDI_TYPE_LTR = Module.cwrap("BIDI_TYPE_LTR", "number", []);
var BIDI_TYPE_RTL = Module.cwrap("BIDI_TYPE_RTL", "number", []);
var BIDI_TYPE_LRO = Module.cwrap("BIDI_TYPE_LRO", "number", []);
var BIDI_TYPE_RLO = Module.cwrap("BIDI_TYPE_RLO", "number", []);
var BIDI_TYPE_WLTR = Module.cwrap("BIDI_TYPE_WLTR", "number", []);
var BIDI_TYPE_WRTL = Module.cwrap("BIDI_TYPE_WRTL", "number", []);
var IMAGE_DRAW_DEFAULT = Module.cwrap("IMAGE_DRAW_DEFAULT", "number", []);
var IMAGE_DRAW_CENTER = Module.cwrap("IMAGE_DRAW_CENTER", "number", []);
var IMAGE_DRAW_ICON = Module.cwrap("IMAGE_DRAW_ICON", "number", []);
var IMAGE_DRAW_SCALE = Module.cwrap("IMAGE_DRAW_SCALE", "number", []);
var IMAGE_DRAW_SCALE_AUTO = Module.cwrap("IMAGE_DRAW_SCALE_AUTO", "number", []);
var IMAGE_DRAW_SCALE_DOWN = Module.cwrap("IMAGE_DRAW_SCALE_DOWN", "number", []);
var IMAGE_DRAW_SCALE_W = Module.cwrap("IMAGE_DRAW_SCALE_W", "number", []);
var IMAGE_DRAW_SCALE_H = Module.cwrap("IMAGE_DRAW_SCALE_H", "number", []);
var IMAGE_DRAW_REPEAT = Module.cwrap("IMAGE_DRAW_REPEAT", "number", []);
var IMAGE_DRAW_REPEAT_X = Module.cwrap("IMAGE_DRAW_REPEAT_X", "number", []);
var IMAGE_DRAW_REPEAT_Y = Module.cwrap("IMAGE_DRAW_REPEAT_Y", "number", []);
var IMAGE_DRAW_REPEAT_Y_INVERSE = Module.cwrap("IMAGE_DRAW_REPEAT_Y_INVERSE", "number", []);
var IMAGE_DRAW_PATCH9 = Module.cwrap("IMAGE_DRAW_PATCH9", "number", []);
var IMAGE_DRAW_PATCH3_X = Module.cwrap("IMAGE_DRAW_PATCH3_X", "number", []);
var IMAGE_DRAW_PATCH3_Y = Module.cwrap("IMAGE_DRAW_PATCH3_Y", "number", []);
var IMAGE_DRAW_PATCH3_X_SCALE_Y = Module.cwrap("IMAGE_DRAW_PATCH3_X_SCALE_Y", "number", []);
var IMAGE_DRAW_PATCH3_Y_SCALE_X = Module.cwrap("IMAGE_DRAW_PATCH3_Y_SCALE_X", "number", []);
var IMAGE_DRAW_REPEAT9 = Module.cwrap("IMAGE_DRAW_REPEAT9", "number", []);
var IMAGE_DRAW_REPEAT3_X = Module.cwrap("IMAGE_DRAW_REPEAT3_X", "number", []);
var IMAGE_DRAW_REPEAT3_Y = Module.cwrap("IMAGE_DRAW_REPEAT3_Y", "number", []);
var canvas_get_width = Module.cwrap("canvas_get_width", "number", ["TCanvas"]);
var canvas_get_height = Module.cwrap("canvas_get_height", "number", ["TCanvas"]);
var canvas_get_clip_rect = Module.cwrap("canvas_get_clip_rect", "TRet", ["TCanvas", "TRect"]);
var canvas_set_clip_rect = Module.cwrap("canvas_set_clip_rect", "TRet", ["TCanvas", "TRect"]);
var canvas_set_clip_rect_ex = Module.cwrap("canvas_set_clip_rect_ex", "TRet", ["TCanvas", "TRect", "boolean"]);
var canvas_set_fill_color_str = Module.cwrap("canvas_set_fill_color_str", "TRet", ["TCanvas", "string"]);
var canvas_set_text_color_str = Module.cwrap("canvas_set_text_color_str", "TRet", ["TCanvas", "string"]);
var canvas_set_stroke_color_str = Module.cwrap("canvas_set_stroke_color_str", "TRet", ["TCanvas", "string"]);
var canvas_set_global_alpha = Module.cwrap("canvas_set_global_alpha", "TRet", ["TCanvas", "number"]);
var canvas_translate = Module.cwrap("canvas_translate", "TRet", ["TCanvas", "number", "number"]);
var canvas_untranslate = Module.cwrap("canvas_untranslate", "TRet", ["TCanvas", "number", "number"]);
var canvas_draw_vline = Module.cwrap("canvas_draw_vline", "TRet", ["TCanvas", "number", "number", "number"]);
var canvas_draw_hline = Module.cwrap("canvas_draw_hline", "TRet", ["TCanvas", "number", "number", "number"]);
var canvas_fill_rect = Module.cwrap("canvas_fill_rect", "TRet", ["TCanvas", "number", "number", "number", "number"]);
var canvas_clear_rect = Module.cwrap("canvas_clear_rect", "TRet", ["TCanvas", "number", "number", "number", "number"]);
var canvas_stroke_rect = Module.cwrap("canvas_stroke_rect", "TRet", ["TCanvas", "number", "number", "number", "number"]);
var canvas_set_font = Module.cwrap("canvas_set_font", "TRet", ["TCanvas", "string", "number"]);
var canvas_measure_utf8 = Module.cwrap("canvas_measure_utf8", "number", ["TCanvas", "string"]);
var canvas_draw_utf8 = Module.cwrap("canvas_draw_utf8", "TRet", ["TCanvas", "string", "number", "number"]);
var canvas_draw_utf8_in_rect = Module.cwrap("canvas_draw_utf8_in_rect", "TRet", ["TCanvas", "string", "TRect"]);
var canvas_draw_icon = Module.cwrap("canvas_draw_icon", "TRet", ["TCanvas", "TBitmap", "number", "number"]);
var canvas_draw_image = Module.cwrap("canvas_draw_image", "TRet", ["TCanvas", "TBitmap", "TRect", "TRect"]);
var canvas_draw_image_ex = Module.cwrap("canvas_draw_image_ex", "TRet", ["TCanvas", "TBitmap", "TImageDrawType", "TRect"]);
var canvas_draw_image_ex2 = Module.cwrap("canvas_draw_image_ex2", "TRet", ["TCanvas", "TBitmap", "TImageDrawType", "TRect", "TRect"]);
var canvas_get_vgcanvas = Module.cwrap("canvas_get_vgcanvas", "TVgcanvas", ["TCanvas"]);
var canvas_cast = Module.cwrap("canvas_cast", "TCanvas", ["TCanvas"]);
var canvas_reset = Module.cwrap("canvas_reset", "TRet", ["TCanvas"]);
...
var CLIP_BOARD_DATA_TYPE_NONE = Module.cwrap("CLIP_BOARD_DATA_TYPE_NONE", "number", []);
var CLIP_BOARD_DATA_TYPE_TEXT = Module.cwrap("CLIP_BOARD_DATA_TYPE_TEXT", "number", []);
var clip_board_set_text = Module.cwrap("clip_board_set_text", "TRet", ["string"]);
var clip_board_get_text = Module.cwrap("clip_board_get_text", "string", []);
var DIALOG_QUIT_NONE = Module.cwrap("DIALOG_QUIT_NONE", "number", []);
var DIALOG_QUIT_OK = Module.cwrap("DIALOG_QUIT_OK", "number", []);
var DIALOG_QUIT_YES = Module.cwrap("DIALOG_QUIT_YES", "number", []);
var DIALOG_QUIT_CANCEL = Module.cwrap("DIALOG_QUIT_CANCEL", "number", []);
var DIALOG_QUIT_NO = Module.cwrap("DIALOG_QUIT_NO", "number", []);
var DIALOG_QUIT_OTHER = Module.cwrap("DIALOG_QUIT_OTHER", "number", []);
var EVT_POINTER_DOWN = Module.cwrap("EVT_POINTER_DOWN", "number", []);
var EVT_POINTER_DOWN_BEFORE_CHILDREN = Module.cwrap("EVT_POINTER_DOWN_BEFORE_CHILDREN", "number", []);
var EVT_POINTER_MOVE = Module.cwrap("EVT_POINTER_MOVE", "number", []);
var EVT_POINTER_MOVE_BEFORE_CHILDREN = Module.cwrap("EVT_POINTER_MOVE_BEFORE_CHILDREN", "number", []);
var EVT_POINTER_UP = Module.cwrap("EVT_POINTER_UP", "number", []);
var EVT_POINTER_UP_BEFORE_CHILDREN = Module.cwrap("EVT_POINTER_UP_BEFORE_CHILDREN", "number", []);
var EVT_WHEEL = Module.cwrap("EVT_WHEEL", "number", []);
var EVT_WHEEL_BEFORE_CHILDREN = Module.cwrap("EVT_WHEEL_BEFORE_CHILDREN", "number", []);
var EVT_POINTER_DOWN_ABORT = Module.cwrap("EVT_POINTER_DOWN_ABORT", "number", []);
var EVT_CONTEXT_MENU = Module.cwrap("EVT_CONTEXT_MENU", "number", []);
var EVT_POINTER_ENTER = Module.cwrap("EVT_POINTER_ENTER", "number", []);
var EVT_POINTER_LEAVE = Module.cwrap("EVT_POINTER_LEAVE", "number", []);
var EVT_LONG_PRESS = Module.cwrap("EVT_LONG_PRESS", "number", []);
var EVT_CLICK = Module.cwrap("EVT_CLICK", "number", []);
var EVT_FOCUS = Module.cwrap("EVT_FOCUS", "number", []);
var EVT_BLUR = Module.cwrap("EVT_BLUR", "number", []);
var EVT_KEY_DOWN = Module.cwrap("EVT_KEY_DOWN", "number", []);
var EVT_KEY_LONG_PRESS = Module.cwrap("EVT_KEY_LONG_PRESS", "number", []);
var EVT_KEY_DOWN_BEFORE_CHILDREN = Module.cwrap("EVT_KEY_DOWN_BEFORE_CHILDREN", "number", []);
var EVT_KEY_REPEAT = Module.cwrap("EVT_KEY_REPEAT", "number", []);
var EVT_KEY_UP = Module.cwrap("EVT_KEY_UP", "number", []);
var EVT_KEY_UP_BEFORE_CHILDREN = Module.cwrap("EVT_KEY_UP_BEFORE_CHILDREN", "number", []);
var EVT_WILL_MOVE = Module.cwrap("EVT_WILL_MOVE", "number", []);
var EVT_MOVE = Module.cwrap("EVT_MOVE", "number", []);
var EVT_WILL_RESIZE = Module.cwrap("EVT_WILL_RESIZE", "number", []);
var EVT_RESIZE = Module.cwrap("EVT_RESIZE", "number", []);
var EVT_WILL_MOVE_RESIZE = Module.cwrap("EVT_WILL_MOVE_RESIZE", "number", []);
var EVT_MOVE_RESIZE = Module.cwrap("EVT_MOVE_RESIZE", "number", []);
var EVT_VALUE_WILL_CHANGE = Module.cwrap("EVT_VALUE_WILL_CHANGE", "number", []);
var EVT_VALUE_CHANGED = Module.cwrap("EVT_VALUE_CHANGED", "number", []);
var EVT_VALUE_CHANGING = Module.cwrap("EVT_VALUE_CHANGING", "number", []);
var EVT_PAINT = Module.cwrap("EVT_PAINT", "number", []);
var EVT_BEFORE_PAINT = Module.cwrap("EVT_BEFORE_PAINT", "number", []);
var EVT_AFTER_PAINT = Module.cwrap("EVT_AFTER_PAINT", "number", []);
var EVT_PAINT_DONE = Module.cwrap("EVT_PAINT_DONE", "number", []);
var EVT_LOCALE_CHANGED = Module.cwrap("EVT_LOCALE_CHANGED", "number", []);
var EVT_ANIM_START = Module.cwrap("EVT_ANIM_START", "number", []);
var EVT_ANIM_STOP = Module.cwrap("EVT_ANIM_STOP", "number", []);
var EVT_ANIM_PAUSE = Module.cwrap("EVT_ANIM_PAUSE", "number", []);
var EVT_ANIM_ONCE = Module.cwrap("EVT_ANIM_ONCE", "number", []);
var EVT_ANIM_END = Module.cwrap("EVT_ANIM_END", "number", []);
var EVT_WINDOW_LOAD = Module.cwrap("EVT_WINDOW_LOAD", "number", []);
var EVT_WIDGET_LOAD = Module.cwrap("EVT_WIDGET_LOAD", "number", []);
var EVT_WINDOW_WILL_OPEN = Module.cwrap("EVT_WINDOW_WILL_OPEN", "number", []);
var EVT_WINDOW_OPEN = Module.cwrap("EVT_WINDOW_OPEN", "number", []);
var EVT_WINDOW_TO_BACKGROUND = Module.cwrap("EVT_WINDOW_TO_BACKGROUND", "number", []);
var EVT_WINDOW_TO_FOREGROUND = Module.cwrap("EVT_WINDOW_TO_FOREGROUND", "number", []);
var EVT_WINDOW_CLOSE = Module.cwrap("EVT_WINDOW_CLOSE", "number", []);
var EVT_REQUEST_CLOSE_WINDOW = Module.cwrap("EVT_REQUEST_CLOSE_WINDOW", "number", []);
var EVT_TOP_WINDOW_CHANGED = Module.cwrap("EVT_TOP_WINDOW_CHANGED", "number", []);
var EVT_IM_START = Module.cwrap("EVT_IM_START", "number", []);
var EVT_IM_STOP = Module.cwrap("EVT_IM_STOP", "number", []);
var EVT_IM_COMMIT = Module.cwrap("EVT_IM_COMMIT", "number", []);
var EVT_IM_CLEAR = Module.cwrap("EVT_IM_CLEAR", "number", []);
var EVT_IM_CANCEL = Module.cwrap("EVT_IM_CANCEL", "number", []);
var EVT_IM_PREEDIT = Module.cwrap("EVT_IM_PREEDIT", "number", []);
var EVT_IM_PREEDIT_CONFIRM = Module.cwrap("EVT_IM_PREEDIT_CONFIRM", "number", []);
var EVT_IM_PREEDIT_ABORT = Module.cwrap("EVT_IM_PREEDIT_ABORT", "number", []);
var EVT_IM_SHOW_CANDIDATES = Module.cwrap("EVT_IM_SHOW_CANDIDATES", "number", []);
var EVT_IM_SHOW_PRE_CANDIDATES = Module.cwrap("EVT_IM_SHOW_PRE_CANDIDATES", "number", []);
var EVT_IM_LANG_CHANGED = Module.cwrap("EVT_IM_LANG_CHANGED", "number", []);
var EVT_IM_ACTION = Module.cwrap("EVT_IM_ACTION", "number", []);
var EVT_IM_ACTION_INFO = Module.cwrap("EVT_IM_ACTION_INFO", "number", []);
var EVT_DRAG_START = Module.cwrap("EVT_DRAG_START", "number", []);
var EVT_DRAG = Module.cwrap("EVT_DRAG", "number", []);
var EVT_DRAG_END = Module.cwrap("EVT_DRAG_END", "number", []);
var EVT_RESET = Module.cwrap("EVT_RESET", "number", []);
var EVT_SCREEN_SAVER = Module.cwrap("EVT_SCREEN_SAVER", "number", []);
var EVT_LOW_MEMORY = Module.cwrap("EVT_LOW_MEMORY", "number", []);
var EVT_OUT_OF_MEMORY = Module.cwrap("EVT_OUT_OF_MEMORY", "number", []);
var EVT_ORIENTATION_WILL_CHANGED = Module.cwrap("EVT_ORIENTATION_WILL_CHANGED", "number", []);
var EVT_ORIENTATION_CHANGED = Module.cwrap("EVT_ORIENTATION_CHANGED", "number", []);
var EVT_WIDGET_CREATED = Module.cwrap("EVT_WIDGET_CREATED", "number", []);
var EVT_REQUEST_QUIT_APP = Module.cwrap("EVT_REQUEST_QUIT_APP", "number", []);
var EVT_THEME_CHANGED = Module.cwrap("EVT_THEME_CHANGED", "number", []);
var EVT_WIDGET_ADD_CHILD = Module.cwrap("EVT_WIDGET_ADD_CHILD", "number", []);
var EVT_WIDGET_REMOVE_CHILD = Module.cwrap("EVT_WIDGET_REMOVE_CHILD", "number", []);
var EVT_SCROLL_START = Module.cwrap("EVT_SCROLL_START", "number", []);
var EVT_SCROLL = Module.cwrap("EVT_SCROLL", "number", []);
var EVT_SCROLL_END = Module.cwrap("EVT_SCROLL_END", "number", []);
var EVT_MULTI_GESTURE = Module.cwrap("EVT_MULTI_GESTURE", "number", []);
var EVT_PAGE_CHANGED = Module.cwrap("EVT_PAGE_CHANGED", "number", []);
var EVT_ASSET_MANAGER_LOAD_ASSET = Module.cwrap("EVT_ASSET_MANAGER_LOAD_ASSET", "number", []);
var EVT_ASSET_MANAGER_UNLOAD_ASSET = Module.cwrap("EVT_ASSET_MANAGER_UNLOAD_ASSET", "number", []);
var EVT_ASSET_MANAGER_CLEAR_CACHE = Module.cwrap("EVT_ASSET_MANAGER_CLEAR_CACHE", "number", []);
var EVT_TIMER = Module.cwrap("EVT_TIMER", "number", []);
var EVT_REQ_START = Module.cwrap("EVT_REQ_START", "number", []);
var EVT_USER_START = Module.cwrap("EVT_USER_START", "number", []);
var EVT_NONE = Module.cwrap("EVT_NONE", "number", []);
var EVT_PROP_WILL_CHANGE = Module.cwrap("EVT_PROP_WILL_CHANGE", "number", []);
var EVT_PROP_CHANGED = Module.cwrap("EVT_PROP_CHANGED", "number", []);
var EVT_CMD_WILL_EXEC = Module.cwrap("EVT_CMD_WILL_EXEC", "number", []);
var EVT_CMD_EXECED = Module.cwrap("EVT_CMD_EXECED", "number", []);
var EVT_CMD_CAN_EXEC = Module.cwrap("EVT_CMD_CAN_EXEC", "number", []);
var EVT_ITEMS_WILL_CHANGE = Module.cwrap("EVT_ITEMS_WILL_CHANGE", "number", []);
var EVT_ITEMS_CHANGED = Module.cwrap("EVT_ITEMS_CHANGED", "number", []);
var EVT_PROPS_CHANGED = Module.cwrap("EVT_PROPS_CHANGED", "number", []);
var EVT_PROGRESS = Module.cwrap("EVT_PROGRESS", "number", []);
var EVT_DONE = Module.cwrap("EVT_DONE", "number", []);
var EVT_ERROR = Module.cwrap("EVT_ERROR", "number", []);
var EVT_DESTROY = Module.cwrap("EVT_DESTROY", "number", []);
var event_from_name = Module.cwrap("event_from_name", "number", ["string"]);
var event_cast = Module.cwrap("event_cast", "TEvent", ["TEvent"]);
var event_get_type = Module.cwrap("event_get_type", "number", ["TEvent"]);
var event_create = Module.cwrap("event_create", "TEvent", ["number"]);
var event_destroy = Module.cwrap("event_destroy", "TRet", ["TEvent"]);
...
var event_t_get_prop_target = Module.cwrap("event_t_get_prop_target", "any", ["number"]);
var font_manager_unload_font = Module.cwrap("font_manager_unload_font", "TRet", ["TFontManager", "string", "number"]);
var font_manager_shrink_cache = Module.cwrap("font_manager_shrink_cache", "TRet", ["TFontManager", "number"]);
var font_manager_unload_all = Module.cwrap("font_manager_unload_all", "TRet", ["TFontManager"]);
var GLYPH_FMT_ALPHA = Module.cwrap("GLYPH_FMT_ALPHA", "number", []);
var GLYPH_FMT_MONO = Module.cwrap("GLYPH_FMT_MONO", "number", []);
var GLYPH_FMT_RGBA = Module.cwrap("GLYPH_FMT_RGBA", "number", []);
var idle_add = Module.cwrap("idle_add", "number", ["Function", "any"]);
var idle_remove = Module.cwrap("idle_remove", "TRet", ["number"]);
var idle_remove_all_by_ctx = Module.cwrap("idle_remove_all_by_ctx", "TRet", ["any"]);
var image_manager = Module.cwrap("image_manager", "TImageManager", []);
var image_manager_get_bitmap = Module.cwrap("image_manager_get_bitmap", "TRet", ["TImageManager", "string", "TBitmap"]);
var image_manager_preload = Module.cwrap("image_manager_preload", "TRet", ["TImageManager", "string"]);
var INPUT_TEXT = Module.cwrap("INPUT_TEXT", "number", []);
var INPUT_INT = Module.cwrap("INPUT_INT", "number", []);
var INPUT_UINT = Module.cwrap("INPUT_UINT", "number", []);
var INPUT_HEX = Module.cwrap("INPUT_HEX", "number", []);
var INPUT_FLOAT = Module.cwrap("INPUT_FLOAT", "number", []);
var INPUT_UFLOAT = Module.cwrap("INPUT_UFLOAT", "number", []);
var INPUT_EMAIL = Module.cwrap("INPUT_EMAIL", "number", []);
var INPUT_PASSWORD = Module.cwrap("INPUT_PASSWORD", "number", []);
var INPUT_PHONE = Module.cwrap("INPUT_PHONE", "number", []);
var INPUT_IPV4 = Module.cwrap("INPUT_IPV4", "number", []);
var INPUT_DATE = Module.cwrap("INPUT_DATE", "number", []);
var INPUT_TIME = Module.cwrap("INPUT_TIME", "number", []);
var INPUT_TIME_FULL = Module.cwrap("INPUT_TIME_FULL", "number", []);
var INPUT_CUSTOM = Module.cwrap("INPUT_CUSTOM", "number", []);
var INPUT_CUSTOM_PASSWORD = Module.cwrap("INPUT_CUSTOM_PASSWORD", "number", []);
var INPUT_ASCII = Module.cwrap("INPUT_ASCII", "number", []);
var input_method_commit_text = Module.cwrap("input_method_commit_text", "TRet", ["TInputMethod", "string"]);
var input_method_set_lang = Module.cwrap("input_method_set_lang", "TRet", ["TInputMethod", "string"]);
var input_method_get_lang = Module.cwrap("input_method_get_lang", "string", ["TInputMethod"]);
var input_method_dispatch_key = Module.cwrap("input_method_dispatch_key", "TRet", ["TInputMethod", "number"]);
var input_method_dispatch_keys = Module.cwrap("input_method_dispatch_keys", "TRet", ["TInputMethod", "string"]);
var input_method_dispatch_preedit = Module.cwrap("input_method_dispatch_preedit", "TRet", ["TInputMethod"]);
var input_method_dispatch_preedit_confirm = Module.cwrap("input_method_dispatch_preedit_confirm", "TRet", ["TInputMethod"]);
var input_method_dispatch_preedit_abort = Module.cwrap("input_method_dispatch_preedit_abort", "TRet", ["TInputMethod"]);
var input_method = Module.cwrap("input_method", "TInputMethod", []);
var TK_KEY_RETURN = Module.cwrap("TK_KEY_RETURN", "number", []);
var TK_KEY_ESCAPE = Module.cwrap("TK_KEY_ESCAPE", "number", []);
var TK_KEY_BACKSPACE = Module.cwrap("TK_KEY_BACKSPACE", "number", []);
var TK_KEY_TAB = Module.cwrap("TK_KEY_TAB", "number", []);
var TK_KEY_SPACE = Module.cwrap("TK_KEY_SPACE", "number", []);
var TK_KEY_EXCLAIM = Module.cwrap("TK_KEY_EXCLAIM", "number", []);
var TK_KEY_QUOTEDBL = Module.cwrap("TK_KEY_QUOTEDBL", "number", []);
var TK_KEY_HASH = Module.cwrap("TK_KEY_HASH", "number", []);
var TK_KEY_PERCENT = Module.cwrap("TK_KEY_PERCENT", "number", []);
var TK_KEY_DOLLAR = Module.cwrap("TK_KEY_DOLLAR", "number", []);
var TK_KEY_AMPERSAND = Module.cwrap("TK_KEY_AMPERSAND", "number", []);
var TK_KEY_QUOTE = Module.cwrap("TK_KEY_QUOTE", "number", []);
var TK_KEY_LEFTPAREN = Module.cwrap("TK_KEY_LEFTPAREN", "number", []);
var TK_KEY_RIGHTPAREN = Module.cwrap("TK_KEY_RIGHTPAREN", "number", []);
var TK_KEY_ASTERISK = Module.cwrap("TK_KEY_ASTERISK", "number", []);
var TK_KEY_PLUS = Module.cwrap("TK_KEY_PLUS", "number", []);
var TK_KEY_COMMA = Module.cwrap("TK_KEY_COMMA", "number", []);
var TK_KEY_MINUS = Module.cwrap("TK_KEY_MINUS", "number", []);
var TK_KEY_PERIOD = Module.cwrap("TK_KEY_PERIOD", "number", []);
var TK_KEY_SLASH = Module.cwrap("TK_KEY_SLASH", "number", []);
var TK_KEY_0 = Module.cwrap("TK_KEY_0", "number", []);
var TK_KEY_1 = Module.cwrap("TK_KEY_1", "number", []);
var TK_KEY_2 = Module.cwrap("TK_KEY_2", "number", []);
var TK_KEY_3 = Module.cwrap("TK_KEY_3", "number", []);
var TK_KEY_4 = Module.cwrap("TK_KEY_4", "number", []);
var TK_KEY_5 = Module.cwrap("TK_KEY_5", "number", []);
var TK_KEY_6 = Module.cwrap("TK_KEY_6", "number", []);
var TK_KEY_7 = Module.cwrap("TK_KEY_7", "number", []);
var TK_KEY_8 = Module.cwrap("TK_KEY_8", "number", []);
var TK_KEY_9 = Module.cwrap("TK_KEY_9", "number", []);
var TK_KEY_COLON = Module.cwrap("TK_KEY_COLON", "number", []);
var TK_KEY_SEMICOLON = Module.cwrap("TK_KEY_SEMICOLON", "number", []);
var TK_KEY_LESS = Module.cwrap("TK_KEY_LESS", "number", []);
var TK_KEY_EQUAL = Module.cwrap("TK_KEY_EQUAL", "number", []);
var TK_KEY_GREATER = Module.cwrap("TK_KEY_GREATER", "number", []);
var TK_KEY_QUESTION = Module.cwrap("TK_KEY_QUESTION", "number", []);
var TK_KEY_AT = Module.cwrap("TK_KEY_AT", "number", []);
var TK_KEY_LEFTBRACKET = Module.cwrap("TK_KEY_LEFTBRACKET", "number", []);
var TK_KEY_BACKSLASH = Module.cwrap("TK_KEY_BACKSLASH", "number", []);
var TK_KEY_RIGHTBRACKET = Module.cwrap("TK_KEY_RIGHTBRACKET", "number", []);
var TK_KEY_CARET = Module.cwrap("TK_KEY_CARET", "number", []);
var TK_KEY_UNDERSCORE = Module.cwrap("TK_KEY_UNDERSCORE", "number", []);
var TK_KEY_BACKQUOTE = Module.cwrap("TK_KEY_BACKQUOTE", "number", []);
var TK_KEY_a = Module.cwrap("TK_KEY_a", "number", []);
var TK_KEY_b = Module.cwrap("TK_KEY_b", "number", []);
var TK_KEY_c = Module.cwrap("TK_KEY_c", "number", []);
var TK_KEY_d = Module.cwrap("TK_KEY_d", "number", []);
var TK_KEY_e = Module.cwrap("TK_KEY_e", "number", []);
var TK_KEY_f = Module.cwrap("TK_KEY_f", "number", []);
var TK_KEY_g = Module.cwrap("TK_KEY_g", "number", []);
var TK_KEY_h = Module.cwrap("TK_KEY_h", "number", []);
var TK_KEY_i = Module.cwrap("TK_KEY_i", "number", []);
var TK_KEY_j = Module.cwrap("TK_KEY_j", "number", []);
var TK_KEY_k = Module.cwrap("TK_KEY_k", "number", []);
var TK_KEY_l = Module.cwrap("TK_KEY_l", "number", []);
var TK_KEY_m = Module.cwrap("TK_KEY_m", "number", []);
var TK_KEY_n = Module.cwrap("TK_KEY_n", "number", []);
var TK_KEY_o = Module.cwrap("TK_KEY_o", "number", []);
var TK_KEY_p = Module.cwrap("TK_KEY_p", "number", []);
var TK_KEY_q = Module.cwrap("TK_KEY_q", "number", []);
var TK_KEY_r = Module.cwrap("TK_KEY_r", "number", []);
var TK_KEY_s = Module.cwrap("TK_KEY_s", "number", []);
var TK_KEY_t = Module.cwrap("TK_KEY_t", "number", []);
var TK_KEY_u = Module.cwrap("TK_KEY_u", "number", []);
var TK_KEY_v = Module.cwrap("TK_KEY_v", "number", []);
var TK_KEY_w = Module.cwrap("TK_KEY_w", "number", []);
var TK_KEY_x = Module.cwrap("TK_KEY_x", "number", []);
var TK_KEY_y = Module.cwrap("TK_KEY_y", "number", []);
var TK_KEY_z = Module.cwrap("TK_KEY_z", "number", []);
var TK_KEY_A = Module.cwrap("TK_KEY_A", "number", []);
var TK_KEY_B = Module.cwrap("TK_KEY_B", "number", []);
var TK_KEY_C = Module.cwrap("TK_KEY_C", "number", []);
var TK_KEY_D = Module.cwrap("TK_KEY_D", "number", []);
...
var TK_KEY_Y = Module.cwrap("TK_KEY_Y", "number", []);
var TK_KEY_Z = Module.cwrap("TK_KEY_Z", "number", []);
var TK_KEY_DOT = Module.cwrap("TK_KEY_DOT", "number", []);
var TK_KEY_DELETE = Module.cwrap("TK_KEY_DELETE", "number", []);
var TK_KEY_LEFTBRACE = Module.cwrap("TK_KEY_LEFTBRACE", "number", []);
var TK_KEY_RIGHTBRACE = Module.cwrap("TK_KEY_RIGHTBRACE", "number", []);
var TK_KEY_LSHIFT = Module.cwrap("TK_KEY_LSHIFT", "number", []);
var TK_KEY_RSHIFT = Module.cwrap("TK_KEY_RSHIFT", "number", []);
var TK_KEY_LCTRL = Module.cwrap("TK_KEY_LCTRL", "number", []);
var TK_KEY_RCTRL = Module.cwrap("TK_KEY_RCTRL", "number", []);
var TK_KEY_LALT = Module.cwrap("TK_KEY_LALT", "number", []);
var TK_KEY_RALT = Module.cwrap("TK_KEY_RALT", "number", []);
var TK_KEY_CAPSLOCK = Module.cwrap("TK_KEY_CAPSLOCK", "number", []);
var TK_KEY_HOME = Module.cwrap("TK_KEY_HOME", "number", []);
var TK_KEY_END = Module.cwrap("TK_KEY_END", "number", []);
var TK_KEY_INSERT = Module.cwrap("TK_KEY_INSERT", "number", []);
var TK_KEY_UP = Module.cwrap("TK_KEY_UP", "number", []);
var TK_KEY_DOWN = Module.cwrap("TK_KEY_DOWN", "number", []);
var TK_KEY_LEFT = Module.cwrap("TK_KEY_LEFT", "number", []);
var TK_KEY_RIGHT = Module.cwrap("TK_KEY_RIGHT", "number", []);
var TK_KEY_PAGEUP = Module.cwrap("TK_KEY_PAGEUP", "number", []);
var TK_KEY_PAGEDOWN = Module.cwrap("TK_KEY_PAGEDOWN", "number", []);
var TK_KEY_F1 = Module.cwrap("TK_KEY_F1", "number", []);
var TK_KEY_F2 = Module.cwrap("TK_KEY_F2", "number", []);
var TK_KEY_F3 = Module.cwrap("TK_KEY_F3", "number", []);
var TK_KEY_F4 = Module.cwrap("TK_KEY_F4", "number", []);
var TK_KEY_F5 = Module.cwrap("TK_KEY_F5", "number", []);
var TK_KEY_F6 = Module.cwrap("TK_KEY_F6", "number", []);
var TK_KEY_F7 = Module.cwrap("TK_KEY_F7", "number", []);
var TK_KEY_F8 = Module.cwrap("TK_KEY_F8", "number", []);
var TK_KEY_F9 = Module.cwrap("TK_KEY_F9", "number", []);
var TK_KEY_F10 = Module.cwrap("TK_KEY_F10", "number", []);
var TK_KEY_F11 = Module.cwrap("TK_KEY_F11", "number", []);
var TK_KEY_F12 = Module.cwrap("TK_KEY_F12", "number", []);
var TK_KEY_MENU = Module.cwrap("TK_KEY_MENU", "number", []);
var TK_KEY_COMMAND = Module.cwrap("TK_KEY_COMMAND", "number", []);
var TK_KEY_BACK = Module.cwrap("TK_KEY_BACK", "number", []);
var TK_KEY_CANCEL = Module.cwrap("TK_KEY_CANCEL", "number", []);
var TK_KEY_WHEEL = Module.cwrap("TK_KEY_WHEEL", "number", []);
var locale_info = Module.cwrap("locale_info", "TLocaleInfo", []);
var locale_info_tr = Module.cwrap("locale_info_tr", "string", ["TLocaleInfo", "string"]);
var locale_info_change = Module.cwrap("locale_info_change", "TRet", ["TLocaleInfo", "string", "string"]);
var locale_info_off = Module.cwrap("locale_info_off", "TRet", ["TLocaleInfo", "number"]);
var STYLE_ID_BG_COLOR = Module.cwrap("STYLE_ID_BG_COLOR", "string", []);
var STYLE_ID_FG_COLOR = Module.cwrap("STYLE_ID_FG_COLOR", "string", []);
var STYLE_ID_MASK_COLOR = Module.cwrap("STYLE_ID_MASK_COLOR", "string", []);
var STYLE_ID_FONT_NAME = Module.cwrap("STYLE_ID_FONT_NAME", "string", []);
var STYLE_ID_FONT_SIZE = Module.cwrap("STYLE_ID_FONT_SIZE", "string", []);
var STYLE_ID_FONT_STYLE = Module.cwrap("STYLE_ID_FONT_STYLE", "string", []);
var STYLE_ID_TEXT_COLOR = Module.cwrap("STYLE_ID_TEXT_COLOR", "string", []);
var STYLE_ID_HIGHLIGHT_FONT_NAME = Module.cwrap("STYLE_ID_HIGHLIGHT_FONT_NAME", "string", []);
var STYLE_ID_HIGHLIGHT_FONT_SIZE = Module.cwrap("STYLE_ID_HIGHLIGHT_FONT_SIZE", "string", []);
var STYLE_ID_HIGHLIGHT_TEXT_COLOR = Module.cwrap("STYLE_ID_HIGHLIGHT_TEXT_COLOR", "string", []);
var STYLE_ID_TIPS_TEXT_COLOR = Module.cwrap("STYLE_ID_TIPS_TEXT_COLOR", "string", []);
var STYLE_ID_TEXT_ALIGN_H = Module.cwrap("STYLE_ID_TEXT_ALIGN_H", "string", []);
var STYLE_ID_TEXT_ALIGN_V = Module.cwrap("STYLE_ID_TEXT_ALIGN_V", "string", []);
var STYLE_ID_BORDER_COLOR = Module.cwrap("STYLE_ID_BORDER_COLOR", "string", []);
var STYLE_ID_BORDER_WIDTH = Module.cwrap("STYLE_ID_BORDER_WIDTH", "string", []);
var STYLE_ID_BORDER = Module.cwrap("STYLE_ID_BORDER", "string", []);
var STYLE_ID_BG_IMAGE = Module.cwrap("STYLE_ID_BG_IMAGE", "string", []);
var STYLE_ID_BG_IMAGE_DRAW_TYPE = Module.cwrap("STYLE_ID_BG_IMAGE_DRAW_TYPE", "string", []);
var STYLE_ID_ICON = Module.cwrap("STYLE_ID_ICON", "string", []);
var STYLE_ID_FG_IMAGE = Module.cwrap("STYLE_ID_FG_IMAGE", "string", []);
var STYLE_ID_FG_IMAGE_DRAW_TYPE = Module.cwrap("STYLE_ID_FG_IMAGE_DRAW_TYPE", "string", []);
var STYLE_ID_SPACER = Module.cwrap("STYLE_ID_SPACER", "string", []);
var STYLE_ID_MARGIN = Module.cwrap("STYLE_ID_MARGIN", "string", []);
var STYLE_ID_MARGIN_LEFT = Module.cwrap("STYLE_ID_MARGIN_LEFT", "string", []);
var STYLE_ID_MARGIN_RIGHT = Module.cwrap("STYLE_ID_MARGIN_RIGHT", "string", []);
var STYLE_ID_MARGIN_TOP = Module.cwrap("STYLE_ID_MARGIN_TOP", "string", []);
var STYLE_ID_MARGIN_BOTTOM = Module.cwrap("STYLE_ID_MARGIN_BOTTOM", "string", []);
var STYLE_ID_ICON_AT = Module.cwrap("STYLE_ID_ICON_AT", "string", []);
var STYLE_ID_ACTIVE_ICON = Module.cwrap("STYLE_ID_ACTIVE_ICON", "string", []);
var STYLE_ID_X_OFFSET = Module.cwrap("STYLE_ID_X_OFFSET", "string", []);
var STYLE_ID_Y_OFFSET = Module.cwrap("STYLE_ID_Y_OFFSET", "string", []);
var STYLE_ID_SELECTED_BG_COLOR = Module.cwrap("STYLE_ID_SELECTED_BG_COLOR", "string", []);
var STYLE_ID_SELECTED_FG_COLOR = Module.cwrap("STYLE_ID_SELECTED_FG_COLOR", "string", []);
var STYLE_ID_SELECTED_TEXT_COLOR = Module.cwrap("STYLE_ID_SELECTED_TEXT_COLOR", "string", []);
var STYLE_ID_ROUND_RADIUS = Module.cwrap("STYLE_ID_ROUND_RADIUS", "string", []);
var STYLE_ID_ROUND_RADIUS_TOP_LETF = Module.cwrap("STYLE_ID_ROUND_RADIUS_TOP_LETF", "string", []);
var STYLE_ID_ROUND_RADIUS_TOP_RIGHT = Module.cwrap("STYLE_ID_ROUND_RADIUS_TOP_RIGHT", "string", []);
var STYLE_ID_ROUND_RADIUS_BOTTOM_LETF = Module.cwrap("STYLE_ID_ROUND_RADIUS_BOTTOM_LETF", "string", []);
var STYLE_ID_ROUND_RADIUS_BOTTOM_RIGHT = Module.cwrap("STYLE_ID_ROUND_RADIUS_BOTTOM_RIGHT", "string", []);
var STYLE_ID_CHILDREN_LAYOUT = Module.cwrap("STYLE_ID_CHILDREN_LAYOUT", "string", []);
var STYLE_ID_SELF_LAYOUT = Module.cwrap("STYLE_ID_SELF_LAYOUT", "string", []);
var STYLE_ID_FOCUSABLE = Module.cwrap("STYLE_ID_FOCUSABLE", "string", []);
var STYLE_ID_FEEDBACK = Module.cwrap("STYLE_ID_FEEDBACK", "string", []);
var style_notify_widget_state_changed = Module.cwrap("style_notify_widget_state_changed", "TRet", ["TStyle", "TWidget"]);
var style_is_valid = Module.cwrap("style_is_valid", "boolean", ["TStyle"]);
var style_get_int = Module.cwrap("style_get_int", "number", ["TStyle", "string", "number"]);
var style_get_uint = Module.cwrap("style_get_uint", "number", ["TStyle", "string", "number"]);
var style_get_str = Module.cwrap("style_get_str", "string", ["TStyle", "string", "string"]);
var style_set = Module.cwrap("style_set", "TRet", ["TStyle", "string", "string", "TValue"]);
var style_update_state = Module.cwrap("style_update_state", "TRet", ["TStyle", "TTheme", "string", "string", "string"]);
var style_get_style_state = Module.cwrap("style_get_style_state", "string", ["TStyle"]);
var style_is_mutable = Module.cwrap("style_is_mutable", "boolean", ["TStyle"]);
var style_get_style_type = Module.cwrap("style_get_style_type", "string", ["TStyle"]);
var theme = Module.cwrap("theme", "TTheme", []);
var timer_add = Module.cwrap("timer_add", "number", ["Function", "any", "number"]);
var timer_remove = Module.cwrap("timer_remove", "TRet", ["number"]);
var timer_remove_all_by_ctx = Module.cwrap("timer_remove_all_by_ctx", "TRet", ["any"]);
var timer_reset = Module.cwrap("timer_reset", "TRet", ["number"]);
var timer_suspend = Module.cwrap("timer_suspend", "TRet", ["number"]);
var timer_resume = Module.cwrap("timer_resume", "TRet", ["number"]);
var timer_modify = Module.cwrap("timer_modify", "TRet", ["number", "number"]);
var ALIGN_V_NONE = Module.cwrap("ALIGN_V_NONE", "number", []);
var ALIGN_V_MIDDLE = Module.cwrap("ALIGN_V_MIDDLE", "number", []);
var ALIGN_V_TOP = Module.cwrap("ALIGN_V_TOP", "number", []);
var ALIGN_V_BOTTOM = Module.cwrap("ALIGN_V_BOTTOM", "number", []);
var ALIGN_H_NONE = Module.cwrap("ALIGN_H_NONE", "number", []);
var ALIGN_H_CENTER = Module.cwrap("ALIGN_H_CENTER", "number", []);
var ALIGN_H_LEFT = Module.cwrap("ALIGN_H_LEFT", "number", []);
var ALIGN_H_RIGHT = Module.cwrap("ALIGN_H_RIGHT", "number", []);
var APP_MOBILE = Module.cwrap("APP_MOBILE", "number", []);
var APP_SIMULATOR = Module.cwrap("APP_SIMULATOR", "number", []);
var APP_DESKTOP = Module.cwrap("APP_DESKTOP", "number", []);
var BITMAP_FMT_NONE = Module.cwrap("BITMAP_FMT_NONE", "number", []);
var BITMAP_FMT_RGBA8888 = Module.cwrap("BITMAP_FMT_RGBA8888", "number", []);
var BITMAP_FMT_ABGR8888 = Module.cwrap("BITMAP_FMT_ABGR8888", "number", []);
var BITMAP_FMT_BGRA8888 = Module.cwrap("BITMAP_FMT_BGRA8888", "number", []);
var BITMAP_FMT_ARGB8888 = Module.cwrap("BITMAP_FMT_ARGB8888", "number", []);
var BITMAP_FMT_RGB565 = Module.cwrap("BITMAP_FMT_RGB565", "number", []);
var BITMAP_FMT_BGR565 = Module.cwrap("BITMAP_FMT_BGR565", "number", []);
var BITMAP_FMT_RGB888 = Module.cwrap("BITMAP_FMT_RGB888", "number", []);
var BITMAP_FMT_BGR888 = Module.cwrap("BITMAP_FMT_BGR888", "number", []);
var BITMAP_FMT_GRAY = Module.cwrap("BITMAP_FMT_GRAY", "number", []);
var BITMAP_FMT_MONO = Module.cwrap("BITMAP_FMT_MONO", "number", []);
var BITMAP_FLAG_NONE = Module.cwrap("BITMAP_FLAG_NONE", "number", []);
var BITMAP_FLAG_OPAQUE = Module.cwrap("BITMAP_FLAG_OPAQUE", "number", []);
var BITMAP_FLAG_IMMUTABLE = Module.cwrap("BITMAP_FLAG_IMMUTABLE", "number", []);
var BITMAP_FLAG_TEXTURE = Module.cwrap("BITMAP_FLAG_TEXTURE", "number", []);
var BITMAP_FLAG_CHANGED = Module.cwrap("BITMAP_FLAG_CHANGED", "number", []);
var BITMAP_FLAG_PREMULTI_ALPHA = Module.cwrap("BITMAP_FLAG_PREMULTI_ALPHA", "number", []);
var vgcanvas_cast = Module.cwrap("vgcanvas_cast", "TVgcanvas", ["TVgcanvas"]);
var vgcanvas_flush = Module.cwrap("vgcanvas_flush", "TRet", ["TVgcanvas"]);
var vgcanvas_begin_path = Module.cwrap("vgcanvas_begin_path", "TRet", ["TVgcanvas"]);
var vgcanvas_move_to = Module.cwrap("vgcanvas_move_to", "TRet", ["TVgcanvas", "number", "number"]);
var vgcanvas_line_to = Module.cwrap("vgcanvas_line_to", "TRet", ["TVgcanvas", "number", "number"]);
var vgcanvas_quad_to = Module.cwrap("vgcanvas_quad_to", "TRet", ["TVgcanvas", "number", "number", "number", "number"]);
var vgcanvas_bezier_to = Module.cwrap("vgcanvas_bezier_to", "TRet", ["TVgcanvas", "number", "number", "number", "number", "number", "number"]);
var vgcanvas_arc_to = Module.cwrap("vgcanvas_arc_to", "TRet", ["TVgcanvas", "number", "number", "number", "number", "number"]);
var vgcanvas_arc = Module.cwrap("vgcanvas_arc", "TRet", ["TVgcanvas", "number", "number", "number", "number", "number", "boolean"]);
var vgcanvas_is_point_in_path = Module.cwrap("vgcanvas_is_point_in_path", "boolean", ["TVgcanvas", "number", "number"]);
var vgcanvas_rect = Module.cwrap("vgcanvas_rect", "TRet", ["TVgcanvas", "number", "number", "number", "number"]);
var vgcanvas_rounded_rect = Module.cwrap("vgcanvas_rounded_rect", "TRet", ["TVgcanvas", "number", "number", "number", "number", "number"]);
var vgcanvas_ellipse = Module.cwrap("vgcanvas_ellipse", "TRet", ["TVgcanvas", "number", "number", "number", "number"]);
var vgcanvas_close_path = Module.cwrap("vgcanvas_close_path", "TRet", ["TVgcanvas"]);
var vgcanvas_path_winding = Module.cwrap("vgcanvas_path_winding", "TRet", ["TVgcanvas", "boolean"]);
var vgcanvas_rotate = Module.cwrap("vgcanvas_rotate", "TRet", ["TVgcanvas", "number"]);
var vgcanvas_scale = Module.cwrap("vgcanvas_scale", "TRet", ["TVgcanvas", "number", "number"]);
var vgcanvas_translate = Module.cwrap("vgcanvas_translate", "TRet", ["TVgcanvas", "number", "number"]);
var vgcanvas_transform = Module.cwrap("vgcanvas_transform", "TRet", ["TVgcanvas", "number", "number", "number", "number", "number", "number"]);
var vgcanvas_set_transform = Module.cwrap("vgcanvas_set_transform", "TRet", ["TVgcanvas", "number", "number", "number", "number", "number", "number"]);
var vgcanvas_clip_path = Module.cwrap("vgcanvas_clip_path", "TRet", ["TVgcanvas"]);
var vgcanvas_clip_rect = Module.cwrap("vgcanvas_clip_rect", "TRet", ["TVgcanvas", "number", "number", "number", "number"]);
var vgcanvas_intersect_clip_rect = Module.cwrap("vgcanvas_intersect_clip_rect", "TRet", ["TVgcanvas", "number", "number", "number", "number"]);
var vgcanvas_fill = Module.cwrap("vgcanvas_fill", "TRet", ["TVgcanvas"]);
var vgcanvas_stroke = Module.cwrap("vgcanvas_stroke", "TRet", ["TVgcanvas"]);
var vgcanvas_paint = Module.cwrap("vgcanvas_paint", "TRet", ["TVgcanvas", "boolean", "TBitmap"]);
var vgcanvas_set_font = Module.cwrap("vgcanvas_set_font", "TRet", ["TVgcanvas", "string"]);
var vgcanvas_set_font_size = Module.cwrap("vgcanvas_set_font_size", "TRet", ["TVgcanvas", "number"]);
var vgcanvas_set_text_align = Module.cwrap("vgcanvas_set_text_align", "TRet", ["TVgcanvas", "string"]);
var vgcanvas_set_text_baseline = Module.cwrap("vgcanvas_set_text_baseline", "TRet", ["TVgcanvas", "string"]);
var vgcanvas_fill_text = Module.cwrap("vgcanvas_fill_text", "TRet", ["TVgcanvas", "string", "number", "number", "number"]);
var vgcanvas_measure_text = Module.cwrap("vgcanvas_measure_text", "number", ["TVgcanvas", "string"]);
var vgcanvas_draw_image = Module.cwrap("vgcanvas_draw_image", "TRet", ["TVgcanvas", "TBitmap", "number", "number", "number", "number", "number", "number", "number", "number"]);
var vgcanvas_draw_icon = Module.cwrap("vgcanvas_draw_icon", "TRet", ["TVgcanvas", "TBitmap", "number", "number", "number", "number", "number", "number", "number", "number"]);
var vgcanvas_set_antialias = Module.cwrap("vgcanvas_set_antialias", "TRet", ["TVgcanvas", "boolean"]);
var vgcanvas_set_global_alpha = Module.cwrap("vgcanvas_set_global_alpha", "TRet", ["TVgcanvas", "number"]);
var vgcanvas_set_line_width = Module.cwrap("vgcanvas_set_line_width", "TRet", ["TVgcanvas", "number"]);
var vgcanvas_set_fill_color_str = Module.cwrap("vgcanvas_set_fill_color_str", "TRet", ["TVgcanvas", "string"]);
var vgcanvas_set_stroke_color_str = Module.cwrap("vgcanvas_set_stroke_color_str", "TRet", ["TVgcanvas", "string"]);
var vgcanvas_set_line_cap = Module.cwrap("vgcanvas_set_line_cap", "TRet", ["TVgcanvas", "string"]);
var vgcanvas_set_line_join = Module.cwrap("vgcanvas_set_line_join", "TRet", ["TVgcanvas", "string"]);
var vgcanvas_set_miter_limit = Module.cwrap("vgcanvas_set_miter_limit", "TRet", ["TVgcanvas", "number"]);
var vgcanvas_save = Module.cwrap("vgcanvas_save", "TRet", ["TVgcanvas"]);
var vgcanvas_restore = Module.cwrap("vgcanvas_restore", "TRet", ["TVgcanvas"]);
...
var vgcanvas_t_get_prop_anti_alias = Module.cwrap("vgcanvas_t_get_prop_anti_alias", "boolean", ["number"]);
...
var VGCANVAS_LINE_CAP_ROUND = Module.cwrap("VGCANVAS_LINE_CAP_ROUND", "string", []);
var VGCANVAS_LINE_CAP_SQUARE = Module.cwrap("VGCANVAS_LINE_CAP_SQUARE", "string", []);
var VGCANVAS_LINE_CAP_BUTT = Module.cwrap("VGCANVAS_LINE_CAP_BUTT", "string", []);
var VGCANVAS_LINE_JOIN_ROUND = Module.cwrap("VGCANVAS_LINE_JOIN_ROUND", "string", []);
var VGCANVAS_LINE_JOIN_BEVEL = Module.cwrap("VGCANVAS_LINE_JOIN_BEVEL", "string", []);
var VGCANVAS_LINE_JOIN_MITTER = Module.cwrap("VGCANVAS_LINE_JOIN_MITTER", "string", []);
var WIDGET_PROP_EXEC = Module.cwrap("WIDGET_PROP_EXEC", "string", []);
var WIDGET_PROP_X = Module.cwrap("WIDGET_PROP_X", "string", []);
var WIDGET_PROP_Y = Module.cwrap("WIDGET_PROP_Y", "string", []);
var WIDGET_PROP_W = Module.cwrap("WIDGET_PROP_W", "string", []);
var WIDGET_PROP_H = Module.cwrap("WIDGET_PROP_H", "string", []);
var WIDGET_PROP_MAX_H = Module.cwrap("WIDGET_PROP_MAX_H", "string", []);
var WIDGET_PROP_DESIGN_W = Module.cwrap("WIDGET_PROP_DESIGN_W", "string", []);
var WIDGET_PROP_DESIGN_H = Module.cwrap("WIDGET_PROP_DESIGN_H", "string", []);
var WIDGET_PROP_AUTO_SCALE_CHILDREN_X = Module.cwrap("WIDGET_PROP_AUTO_SCALE_CHILDREN_X", "string", []);
var WIDGET_PROP_AUTO_SCALE_CHILDREN_Y = Module.cwrap("WIDGET_PROP_AUTO_SCALE_CHILDREN_Y", "string", []);
var WIDGET_PROP_AUTO_SCALE_CHILDREN_W = Module.cwrap("WIDGET_PROP_AUTO_SCALE_CHILDREN_W", "string", []);
var WIDGET_PROP_AUTO_SCALE_CHILDREN_H = Module.cwrap("WIDGET_PROP_AUTO_SCALE_CHILDREN_H", "string", []);
var WIDGET_PROP_INPUTING = Module.cwrap("WIDGET_PROP_INPUTING", "string", []);
var WIDGET_PROP_ALWAYS_ON_TOP = Module.cwrap("WIDGET_PROP_ALWAYS_ON_TOP", "string", []);
var WIDGET_PROP_CARET_X = Module.cwrap("WIDGET_PROP_CARET_X", "string", []);
var WIDGET_PROP_CARET_Y = Module.cwrap("WIDGET_PROP_CARET_Y", "string", []);
var WIDGET_PROP_DIRTY_RECT_TOLERANCE = Module.cwrap("WIDGET_PROP_DIRTY_RECT_TOLERANCE", "string", []);
var WIDGET_PROP_BIDI = Module.cwrap("WIDGET_PROP_BIDI", "string", []);
var WIDGET_PROP_CANVAS = Module.cwrap("WIDGET_PROP_CANVAS", "string", []);
var WIDGET_PROP_LOCALIZE_OPTIONS = Module.cwrap("WIDGET_PROP_LOCALIZE_OPTIONS", "string", []);
var WIDGET_PROP_NATIVE_WINDOW = Module.cwrap("WIDGET_PROP_NATIVE_WINDOW", "string", []);
var WIDGET_PROP_HIGHLIGHT = Module.cwrap("WIDGET_PROP_HIGHLIGHT", "string", []);
var WIDGET_PROP_BAR_SIZE = Module.cwrap("WIDGET_PROP_BAR_SIZE", "string", []);
var WIDGET_PROP_OPACITY = Module.cwrap("WIDGET_PROP_OPACITY", "string", []);
var WIDGET_PROP_MIN_W = Module.cwrap("WIDGET_PROP_MIN_W", "string", []);
var WIDGET_PROP_MAX_W = Module.cwrap("WIDGET_PROP_MAX_W", "string", []);
var WIDGET_PROP_AUTO_ADJUST_SIZE = Module.cwrap("WIDGET_PROP_AUTO_ADJUST_SIZE", "string", []);
var WIDGET_PROP_SINGLE_INSTANCE = Module.cwrap("WIDGET_PROP_SINGLE_INSTANCE", "string", []);
var WIDGET_PROP_STRONGLY_FOCUS = Module.cwrap("WIDGET_PROP_STRONGLY_FOCUS", "string", []);
var WIDGET_PROP_CHILDREN_LAYOUT = Module.cwrap("WIDGET_PROP_CHILDREN_LAYOUT", "string", []);
var WIDGET_PROP_LAYOUT = Module.cwrap("WIDGET_PROP_LAYOUT", "string", []);
var WIDGET_PROP_SELF_LAYOUT = Module.cwrap("WIDGET_PROP_SELF_LAYOUT", "string", []);
var WIDGET_PROP_LAYOUT_W = Module.cwrap("WIDGET_PROP_LAYOUT_W", "string", []);
var WIDGET_PROP_LAYOUT_H = Module.cwrap("WIDGET_PROP_LAYOUT_H", "string", []);
var WIDGET_PROP_VIRTUAL_W = Module.cwrap("WIDGET_PROP_VIRTUAL_W", "string", []);
var WIDGET_PROP_VIRTUAL_H = Module.cwrap("WIDGET_PROP_VIRTUAL_H", "string", []);
var WIDGET_PROP_NAME = Module.cwrap("WIDGET_PROP_NAME", "string", []);
var WIDGET_PROP_TYPE = Module.cwrap("WIDGET_PROP_TYPE", "string", []);
var WIDGET_PROP_CLOSABLE = Module.cwrap("WIDGET_PROP_CLOSABLE", "string", []);
var WIDGET_PROP_POINTER_CURSOR = Module.cwrap("WIDGET_PROP_POINTER_CURSOR", "string", []);
var WIDGET_PROP_VALUE = Module.cwrap("WIDGET_PROP_VALUE", "string", []);
var WIDGET_PROP_RADIO = Module.cwrap("WIDGET_PROP_RADIO", "string", []);
var WIDGET_PROP_REVERSE = Module.cwrap("WIDGET_PROP_REVERSE", "string", []);
var WIDGET_PROP_LENGTH = Module.cwrap("WIDGET_PROP_LENGTH", "string", []);
var WIDGET_PROP_LINE_WRAP = Module.cwrap("WIDGET_PROP_LINE_WRAP", "string", []);
var WIDGET_PROP_WORD_WRAP = Module.cwrap("WIDGET_PROP_WORD_WRAP", "string", []);
var WIDGET_PROP_TEXT = Module.cwrap("WIDGET_PROP_TEXT", "string", []);
var WIDGET_PROP_TR_TEXT = Module.cwrap("WIDGET_PROP_TR_TEXT", "string", []);
var WIDGET_PROP_STYLE = Module.cwrap("WIDGET_PROP_STYLE", "string", []);
var WIDGET_PROP_ENABLE = Module.cwrap("WIDGET_PROP_ENABLE", "string", []);
var WIDGET_PROP_FEEDBACK = Module.cwrap("WIDGET_PROP_FEEDBACK", "string", []);
var WIDGET_PROP_FLOATING = Module.cwrap("WIDGET_PROP_FLOATING", "string", []);
var WIDGET_PROP_MARGIN = Module.cwrap("WIDGET_PROP_MARGIN", "string", []);
var WIDGET_PROP_SPACING = Module.cwrap("WIDGET_PROP_SPACING", "string", []);
var WIDGET_PROP_LEFT_MARGIN = Module.cwrap("WIDGET_PROP_LEFT_MARGIN", "string", []);
var WIDGET_PROP_RIGHT_MARGIN = Module.cwrap("WIDGET_PROP_RIGHT_MARGIN", "string", []);
var WIDGET_PROP_TOP_MARGIN = Module.cwrap("WIDGET_PROP_TOP_MARGIN", "string", []);
var WIDGET_PROP_BOTTOM_MARGIN = Module.cwrap("WIDGET_PROP_BOTTOM_MARGIN", "string", []);
var WIDGET_PROP_STEP = Module.cwrap("WIDGET_PROP_STEP", "string", []);
var WIDGET_PROP_VISIBLE = Module.cwrap("WIDGET_PROP_VISIBLE", "string", []);
var WIDGET_PROP_SENSITIVE = Module.cwrap("WIDGET_PROP_SENSITIVE", "string", []);
var WIDGET_PROP_ANIMATION = Module.cwrap("WIDGET_PROP_ANIMATION", "string", []);
var WIDGET_PROP_ANIM_HINT = Module.cwrap("WIDGET_PROP_ANIM_HINT", "string", []);
var WIDGET_PROP_FULLSCREEN = Module.cwrap("WIDGET_PROP_FULLSCREEN", "string", []);
var WIDGET_PROP_DISABLE_ANIM = Module.cwrap("WIDGET_PROP_DISABLE_ANIM", "string", []);
var WIDGET_PROP_OPEN_ANIM_HINT = Module.cwrap("WIDGET_PROP_OPEN_ANIM_HINT", "string", []);
var WIDGET_PROP_CLOSE_ANIM_HINT = Module.cwrap("WIDGET_PROP_CLOSE_ANIM_HINT", "string", []);
var WIDGET_PROP_MIN = Module.cwrap("WIDGET_PROP_MIN", "string", []);
var WIDGET_PROP_ACTION_TEXT = Module.cwrap("WIDGET_PROP_ACTION_TEXT", "string", []);
var WIDGET_PROP_TIPS = Module.cwrap("WIDGET_PROP_TIPS", "string", []);
var WIDGET_PROP_TR_TIPS = Module.cwrap("WIDGET_PROP_TR_TIPS", "string", []);
var WIDGET_PROP_INPUT_TYPE = Module.cwrap("WIDGET_PROP_INPUT_TYPE", "string", []);
var WIDGET_PROP_KEYBOARD = Module.cwrap("WIDGET_PROP_KEYBOARD", "string", []);
var WIDGET_PROP_DEFAULT_FOCUSED_CHILD = Module.cwrap("WIDGET_PROP_DEFAULT_FOCUSED_CHILD", "string", []);
var WIDGET_PROP_READONLY = Module.cwrap("WIDGET_PROP_READONLY", "string", []);
var WIDGET_PROP_CANCELABLE = Module.cwrap("WIDGET_PROP_CANCELABLE", "string", []);
var WIDGET_PROP_PASSWORD_VISIBLE = Module.cwrap("WIDGET_PROP_PASSWORD_VISIBLE", "string", []);
var WIDGET_PROP_ACTIVE = Module.cwrap("WIDGET_PROP_ACTIVE", "string", []);
var WIDGET_PROP_CURR_PAGE = Module.cwrap("WIDGET_PROP_CURR_PAGE", "string", []);
var WIDGET_PROP_PAGE_MAX_NUMBER = Module.cwrap("WIDGET_PROP_PAGE_MAX_NUMBER", "string", []);
var WIDGET_PROP_VERTICAL = Module.cwrap("WIDGET_PROP_VERTICAL", "string", []);
var WIDGET_PROP_SHOW_TEXT = Module.cwrap("WIDGET_PROP_SHOW_TEXT", "string", []);
var WIDGET_PROP_XOFFSET = Module.cwrap("WIDGET_PROP_XOFFSET", "string", []);
var WIDGET_PROP_YOFFSET = Module.cwrap("WIDGET_PROP_YOFFSET", "string", []);
var WIDGET_PROP_ALIGN_V = Module.cwrap("WIDGET_PROP_ALIGN_V", "string", []);
var WIDGET_PROP_ALIGN_H = Module.cwrap("WIDGET_PROP_ALIGN_H", "string", []);
var WIDGET_PROP_AUTO_PLAY = Module.cwrap("WIDGET_PROP_AUTO_PLAY", "string", []);
var WIDGET_PROP_LOOP = Module.cwrap("WIDGET_PROP_LOOP", "string", []);
var WIDGET_PROP_AUTO_FIX = Module.cwrap("WIDGET_PROP_AUTO_FIX", "string", []);
var WIDGET_PROP_SELECT_NONE_WHEN_FOCUSED = Module.cwrap("WIDGET_PROP_SELECT_NONE_WHEN_FOCUSED", "string", []);
var WIDGET_PROP_OPEN_IM_WHEN_FOCUSED = Module.cwrap("WIDGET_PROP_OPEN_IM_WHEN_FOCUSED", "string", []);
var WIDGET_PROP_CLOSE_IM_WHEN_BLURED = Module.cwrap("WIDGET_PROP_CLOSE_IM_WHEN_BLURED", "string", []);
var WIDGET_PROP_X_MIN = Module.cwrap("WIDGET_PROP_X_MIN", "string", []);
var WIDGET_PROP_X_MAX = Module.cwrap("WIDGET_PROP_X_MAX", "string", []);
var WIDGET_PROP_Y_MIN = Module.cwrap("WIDGET_PROP_Y_MIN", "string", []);
var WIDGET_PROP_Y_MAX = Module.cwrap("WIDGET_PROP_Y_MAX", "string", []);
var WIDGET_PROP_MAX = Module.cwrap("WIDGET_PROP_MAX", "string", []);
var WIDGET_PROP_GRAB_KEYS = Module.cwrap("WIDGET_PROP_GRAB_KEYS", "string", []);
var WIDGET_PROP_ROW = Module.cwrap("WIDGET_PROP_ROW", "string", []);
var WIDGET_PROP_STATE_FOR_STYLE = Module.cwrap("WIDGET_PROP_STATE_FOR_STYLE", "string", []);
var WIDGET_PROP_THEME = Module.cwrap("WIDGET_PROP_THEME", "string", []);
var WIDGET_PROP_STAGE = Module.cwrap("WIDGET_PROP_STAGE", "string", []);
var WIDGET_PROP_IMAGE_MANAGER = Module.cwrap("WIDGET_PROP_IMAGE_MANAGER", "string", []);
var WIDGET_PROP_ASSETS_MANAGER = Module.cwrap("WIDGET_PROP_ASSETS_MANAGER", "string", []);
var WIDGET_PROP_LOCALE_INFO = Module.cwrap("WIDGET_PROP_LOCALE_INFO", "string", []);
var WIDGET_PROP_FONT_MANAGER = Module.cwrap("WIDGET_PROP_FONT_MANAGER", "string", []);
var WIDGET_PROP_THEME_OBJ = Module.cwrap("WIDGET_PROP_THEME_OBJ", "string", []);
var WIDGET_PROP_DEFAULT_THEME_OBJ = Module.cwrap("WIDGET_PROP_DEFAULT_THEME_OBJ", "string", []);
var WIDGET_PROP_ITEM_WIDTH = Module.cwrap("WIDGET_PROP_ITEM_WIDTH", "string", []);
var WIDGET_PROP_ITEM_HEIGHT = Module.cwrap("WIDGET_PROP_ITEM_HEIGHT", "string", []);
var WIDGET_PROP_DEFAULT_ITEM_HEIGHT = Module.cwrap("WIDGET_PROP_DEFAULT_ITEM_HEIGHT", "string", []);
var WIDGET_PROP_XSLIDABLE = Module.cwrap("WIDGET_PROP_XSLIDABLE", "string", []);
var WIDGET_PROP_YSLIDABLE = Module.cwrap("WIDGET_PROP_YSLIDABLE", "string", []);
var WIDGET_PROP_REPEAT = Module.cwrap("WIDGET_PROP_REPEAT", "string", []);
var WIDGET_PROP_LONG_PRESS_TIME = Module.cwrap("WIDGET_PROP_LONG_PRESS_TIME", "string", []);
var WIDGET_PROP_ENABLE_LONG_PRESS = Module.cwrap("WIDGET_PROP_ENABLE_LONG_PRESS", "string", []);
var WIDGET_PROP_CLICK_THROUGH = Module.cwrap("WIDGET_PROP_CLICK_THROUGH", "string", []);
var WIDGET_PROP_ANIMATABLE = Module.cwrap("WIDGET_PROP_ANIMATABLE", "string", []);
var WIDGET_PROP_AUTO_HIDE = Module.cwrap("WIDGET_PROP_AUTO_HIDE", "string", []);
var WIDGET_PROP_AUTO_HIDE_SCROLL_BAR = Module.cwrap("WIDGET_PROP_AUTO_HIDE_SCROLL_BAR", "string", []);
var WIDGET_PROP_IMAGE = Module.cwrap("WIDGET_PROP_IMAGE", "string", []);
var WIDGET_PROP_FORMAT = Module.cwrap("WIDGET_PROP_FORMAT", "string", []);
var WIDGET_PROP_DRAW_TYPE = Module.cwrap("WIDGET_PROP_DRAW_TYPE", "string", []);
var WIDGET_PROP_SELECTABLE = Module.cwrap("WIDGET_PROP_SELECTABLE", "string", []);
var WIDGET_PROP_CLICKABLE = Module.cwrap("WIDGET_PROP_CLICKABLE", "string", []);
var WIDGET_PROP_SCALE_X = Module.cwrap("WIDGET_PROP_SCALE_X", "string", []);
var WIDGET_PROP_SCALE_Y = Module.cwrap("WIDGET_PROP_SCALE_Y", "string", []);
var WIDGET_PROP_ANCHOR_X = Module.cwrap("WIDGET_PROP_ANCHOR_X", "string", []);
var WIDGET_PROP_ANCHOR_Y = Module.cwrap("WIDGET_PROP_ANCHOR_Y", "string", []);
var WIDGET_PROP_ROTATION = Module.cwrap("WIDGET_PROP_ROTATION", "string", []);
var WIDGET_PROP_COMPACT = Module.cwrap("WIDGET_PROP_COMPACT", "string", []);
var WIDGET_PROP_SCROLLABLE = Module.cwrap("WIDGET_PROP_SCROLLABLE", "string", []);
var WIDGET_PROP_ICON = Module.cwrap("WIDGET_PROP_ICON", "string", []);
var WIDGET_PROP_OPTIONS = Module.cwrap("WIDGET_PROP_OPTIONS", "string", []);
var WIDGET_PROP_SELECTED = Module.cwrap("WIDGET_PROP_SELECTED", "string", []);
var WIDGET_PROP_CHECKED = Module.cwrap("WIDGET_PROP_CHECKED", "string", []);
var WIDGET_PROP_ACTIVE_ICON = Module.cwrap("WIDGET_PROP_ACTIVE_ICON", "string", []);
var WIDGET_PROP_LOAD_UI = Module.cwrap("WIDGET_PROP_LOAD_UI", "string", []);
var WIDGET_PROP_OPEN_WINDOW = Module.cwrap("WIDGET_PROP_OPEN_WINDOW", "string", []);
var WIDGET_PROP_SELECTED_INDEX = Module.cwrap("WIDGET_PROP_SELECTED_INDEX", "string", []);
var WIDGET_PROP_CLOSE_WHEN_CLICK = Module.cwrap("WIDGET_PROP_CLOSE_WHEN_CLICK", "string", []);
var WIDGET_PROP_CLOSE_WHEN_CLICK_OUTSIDE = Module.cwrap("WIDGET_PROP_CLOSE_WHEN_CLICK_OUTSIDE", "string", []);
var WIDGET_PROP_CLOSE_WHEN_TIMEOUT = Module.cwrap("WIDGET_PROP_CLOSE_WHEN_TIMEOUT", "string", []);
var WIDGET_PROP_LINE_GAP = Module.cwrap("WIDGET_PROP_LINE_GAP", "string", []);
var WIDGET_PROP_BG_COLOR = Module.cwrap("WIDGET_PROP_BG_COLOR", "string", []);
var WIDGET_PROP_BORDER_COLOR = Module.cwrap("WIDGET_PROP_BORDER_COLOR", "string", []);
var WIDGET_PROP_DELAY = Module.cwrap("WIDGET_PROP_DELAY", "string", []);
var WIDGET_PROP_IS_KEYBOARD = Module.cwrap("WIDGET_PROP_IS_KEYBOARD", "string", []);
var WIDGET_PROP_FOCUSED = Module.cwrap("WIDGET_PROP_FOCUSED", "string", []);
var WIDGET_PROP_FOCUS = Module.cwrap("WIDGET_PROP_FOCUS", "string", []);
var WIDGET_PROP_FOCUSABLE = Module.cwrap("WIDGET_PROP_FOCUSABLE", "string", []);
var WIDGET_PROP_WITH_FOCUS_STATE = Module.cwrap("WIDGET_PROP_WITH_FOCUS_STATE", "string", []);
var WIDGET_PROP_MOVE_FOCUS_PREV_KEY = Module.cwrap("WIDGET_PROP_MOVE_FOCUS_PREV_KEY", "string", []);
var WIDGET_PROP_MOVE_FOCUS_NEXT_KEY = Module.cwrap("WIDGET_PROP_MOVE_FOCUS_NEXT_KEY", "string", []);
var WIDGET_PROP_MOVE_FOCUS_UP_KEY = Module.cwrap("WIDGET_PROP_MOVE_FOCUS_UP_KEY", "string", []);
var WIDGET_PROP_MOVE_FOCUS_DOWN_KEY = Module.cwrap("WIDGET_PROP_MOVE_FOCUS_DOWN_KEY", "string", []);
var WIDGET_PROP_MOVE_FOCUS_LEFT_KEY = Module.cwrap("WIDGET_PROP_MOVE_FOCUS_LEFT_KEY", "string", []);
var WIDGET_PROP_MOVE_FOCUS_RIGHT_KEY = Module.cwrap("WIDGET_PROP_MOVE_FOCUS_RIGHT_KEY", "string", []);
var WIDGET_TYPE_NONE = Module.cwrap("WIDGET_TYPE_NONE", "string", []);
var WIDGET_TYPE_WINDOW_MANAGER = Module.cwrap("WIDGET_TYPE_WINDOW_MANAGER", "string", []);
var WIDGET_TYPE_NORMAL_WINDOW = Module.cwrap("WIDGET_TYPE_NORMAL_WINDOW", "string", []);
var WIDGET_TYPE_OVERLAY = Module.cwrap("WIDGET_TYPE_OVERLAY", "string", []);
var WIDGET_TYPE_TOOL_BAR = Module.cwrap("WIDGET_TYPE_TOOL_BAR", "string", []);
var WIDGET_TYPE_DIALOG = Module.cwrap("WIDGET_TYPE_DIALOG", "string", []);
var WIDGET_TYPE_POPUP = Module.cwrap("WIDGET_TYPE_POPUP", "string", []);
var WIDGET_TYPE_SYSTEM_BAR = Module.cwrap("WIDGET_TYPE_SYSTEM_BAR", "string", []);
var WIDGET_TYPE_SYSTEM_BAR_BOTTOM = Module.cwrap("WIDGET_TYPE_SYSTEM_BAR_BOTTOM", "string", []);
var WIDGET_TYPE_SPRITE = Module.cwrap("WIDGET_TYPE_SPRITE", "string", []);
var WIDGET_TYPE_KEYBOARD = Module.cwrap("WIDGET_TYPE_KEYBOARD", "string", []);
var WIDGET_TYPE_DND = Module.cwrap("WIDGET_TYPE_DND", "string", []);
var WIDGET_TYPE_LABEL = Module.cwrap("WIDGET_TYPE_LABEL", "string", []);
var WIDGET_TYPE_BUTTON = Module.cwrap("WIDGET_TYPE_BUTTON", "string", []);
var WIDGET_TYPE_IMAGE = Module.cwrap("WIDGET_TYPE_IMAGE", "string", []);
var WIDGET_TYPE_EDIT = Module.cwrap("WIDGET_TYPE_EDIT", "string", []);
var WIDGET_TYPE_PROGRESS_BAR = Module.cwrap("WIDGET_TYPE_PROGRESS_BAR", "string", []);
var WIDGET_TYPE_GROUP_BOX = Module.cwrap("WIDGET_TYPE_GROUP_BOX", "string", []);
var WIDGET_TYPE_CHECK_BUTTON = Module.cwrap("WIDGET_TYPE_CHECK_BUTTON", "string", []);
var WIDGET_TYPE_RADIO_BUTTON = Module.cwrap("WIDGET_TYPE_RADIO_BUTTON", "string", []);
var WIDGET_TYPE_DIALOG_TITLE = Module.cwrap("WIDGET_TYPE_DIALOG_TITLE", "string", []);
var WIDGET_TYPE_DIALOG_CLIENT = Module.cwrap("WIDGET_TYPE_DIALOG_CLIENT", "string", []);
var WIDGET_TYPE_SLIDER = Module.cwrap("WIDGET_TYPE_SLIDER", "string", []);
var WIDGET_TYPE_VIEW = Module.cwrap("WIDGET_TYPE_VIEW", "string", []);
var WIDGET_TYPE_COMBO_BOX = Module.cwrap("WIDGET_TYPE_COMBO_BOX", "string", []);
var WIDGET_TYPE_COMBO_BOX_ITEM = Module.cwrap("WIDGET_TYPE_COMBO_BOX_ITEM", "string", []);
var WIDGET_TYPE_SLIDE_VIEW = Module.cwrap("WIDGET_TYPE_SLIDE_VIEW", "string", []);
var WIDGET_TYPE_SLIDE_INDICATOR = Module.cwrap("WIDGET_TYPE_SLIDE_INDICATOR", "string", []);
var WIDGET_TYPE_SLIDE_INDICATOR_ARC = Module.cwrap("WIDGET_TYPE_SLIDE_INDICATOR_ARC", "string", []);
var WIDGET_TYPE_PAGES = Module.cwrap("WIDGET_TYPE_PAGES", "string", []);
var WIDGET_TYPE_TAB_BUTTON = Module.cwrap("WIDGET_TYPE_TAB_BUTTON", "string", []);
var WIDGET_TYPE_TAB_CONTROL = Module.cwrap("WIDGET_TYPE_TAB_CONTROL", "string", []);
var WIDGET_TYPE_TAB_BUTTON_GROUP = Module.cwrap("WIDGET_TYPE_TAB_BUTTON_GROUP", "string", []);
var WIDGET_TYPE_BUTTON_GROUP = Module.cwrap("WIDGET_TYPE_BUTTON_GROUP", "string", []);
var WIDGET_TYPE_CANDIDATES = Module.cwrap("WIDGET_TYPE_CANDIDATES", "string", []);
var WIDGET_TYPE_SPIN_BOX = Module.cwrap("WIDGET_TYPE_SPIN_BOX", "string", []);
var WIDGET_TYPE_DRAGGER = Module.cwrap("WIDGET_TYPE_DRAGGER", "string", []);
var WIDGET_TYPE_SCROLL_BAR = Module.cwrap("WIDGET_TYPE_SCROLL_BAR", "string", []);
var WIDGET_TYPE_SCROLL_BAR_DESKTOP = Module.cwrap("WIDGET_TYPE_SCROLL_BAR_DESKTOP", "string", []);
var WIDGET_TYPE_SCROLL_BAR_MOBILE = Module.cwrap("WIDGET_TYPE_SCROLL_BAR_MOBILE", "string", []);
var WIDGET_TYPE_SCROLL_VIEW = Module.cwrap("WIDGET_TYPE_SCROLL_VIEW", "string", []);
var WIDGET_TYPE_LIST_VIEW = Module.cwrap("WIDGET_TYPE_LIST_VIEW", "string", []);
var WIDGET_TYPE_LIST_VIEW_H = Module.cwrap("WIDGET_TYPE_LIST_VIEW_H", "string", []);
var WIDGET_TYPE_LIST_ITEM = Module.cwrap("WIDGET_TYPE_LIST_ITEM", "string", []);
var WIDGET_TYPE_COLOR_PICKER = Module.cwrap("WIDGET_TYPE_COLOR_PICKER", "string", []);
var WIDGET_TYPE_COLOR_COMPONENT = Module.cwrap("WIDGET_TYPE_COLOR_COMPONENT", "string", []);
var WIDGET_TYPE_COLOR_TILE = Module.cwrap("WIDGET_TYPE_COLOR_TILE", "string", []);
var WIDGET_TYPE_CLIP_VIEW = Module.cwrap("WIDGET_TYPE_CLIP_VIEW", "string", []);
var WIDGET_TYPE_RICH_TEXT = Module.cwrap("WIDGET_TYPE_RICH_TEXT", "string", []);
var WIDGET_TYPE_APP_BAR = Module.cwrap("WIDGET_TYPE_APP_BAR", "string", []);
var WIDGET_TYPE_GRID = Module.cwrap("WIDGET_TYPE_GRID", "string", []);
var WIDGET_TYPE_GRID_ITEM = Module.cwrap("WIDGET_TYPE_GRID_ITEM", "string", []);
var WIDGET_TYPE_ROW = Module.cwrap("WIDGET_TYPE_ROW", "string", []);
var WIDGET_TYPE_COLUMN = Module.cwrap("WIDGET_TYPE_COLUMN", "string", []);
var WIDGET_TYPE_CALIBRATION_WIN = Module.cwrap("WIDGET_TYPE_CALIBRATION_WIN", "string", []);
var WINDOW_STAGE_NONE = Module.cwrap("WINDOW_STAGE_NONE", "number", []);
var WINDOW_STAGE_LOADED = Module.cwrap("WINDOW_STAGE_LOADED", "number", []);
var WINDOW_STAGE_CREATED = Module.cwrap("WINDOW_STAGE_CREATED", "number", []);
var WINDOW_STAGE_OPENED = Module.cwrap("WINDOW_STAGE_OPENED", "number", []);
var WINDOW_STAGE_CLOSED = Module.cwrap("WINDOW_STAGE_CLOSED", "number", []);
var WINDOW_STAGE_SUSPEND = Module.cwrap("WINDOW_STAGE_SUSPEND", "number", []);
var WINDOW_CLOSABLE_YES = Module.cwrap("WINDOW_CLOSABLE_YES", "number", []);
var WINDOW_CLOSABLE_NO = Module.cwrap("WINDOW_CLOSABLE_NO", "number", []);
var WINDOW_CLOSABLE_CONFIRM = Module.cwrap("WINDOW_CLOSABLE_CONFIRM", "number", []);
var WIDGET_STATE_NONE = Module.cwrap("WIDGET_STATE_NONE", "string", []);
var WIDGET_STATE_NORMAL = Module.cwrap("WIDGET_STATE_NORMAL", "string", []);
var WIDGET_STATE_CHANGED = Module.cwrap("WIDGET_STATE_CHANGED", "string", []);
var WIDGET_STATE_PRESSED = Module.cwrap("WIDGET_STATE_PRESSED", "string", []);
var WIDGET_STATE_OVER = Module.cwrap("WIDGET_STATE_OVER", "string", []);
var WIDGET_STATE_DISABLE = Module.cwrap("WIDGET_STATE_DISABLE", "string", []);
var WIDGET_STATE_FOCUSED = Module.cwrap("WIDGET_STATE_FOCUSED", "string", []);
var WIDGET_STATE_CHECKED = Module.cwrap("WIDGET_STATE_CHECKED", "string", []);
var WIDGET_STATE_UNCHECKED = Module.cwrap("WIDGET_STATE_UNCHECKED", "string", []);
var WIDGET_STATE_EMPTY = Module.cwrap("WIDGET_STATE_EMPTY", "string", []);
var WIDGET_STATE_EMPTY_FOCUS = Module.cwrap("WIDGET_STATE_EMPTY_FOCUS", "string", []);
var WIDGET_STATE_ERROR = Module.cwrap("WIDGET_STATE_ERROR", "string", []);
var WIDGET_STATE_SELECTED = Module.cwrap("WIDGET_STATE_SELECTED", "string", []);
var WIDGET_STATE_NORMAL_OF_CHECKED = Module.cwrap("WIDGET_STATE_NORMAL_OF_CHECKED", "string", []);
var WIDGET_STATE_PRESSED_OF_CHECKED = Module.cwrap("WIDGET_STATE_PRESSED_OF_CHECKED", "string", []);
var WIDGET_STATE_OVER_OF_CHECKED = Module.cwrap("WIDGET_STATE_OVER_OF_CHECKED", "string", []);
var WIDGET_STATE_DISABLE_OF_CHECKED = Module.cwrap("WIDGET_STATE_DISABLE_OF_CHECKED", "string", []);
var WIDGET_STATE_FOCUSED_OF_CHECKED = Module.cwrap("WIDGET_STATE_FOCUSED_OF_CHECKED", "string", []);
var WIDGET_STATE_NORMAL_OF_ACTIVE = Module.cwrap("WIDGET_STATE_NORMAL_OF_ACTIVE", "string", []);
var WIDGET_STATE_PRESSED_OF_ACTIVE = Module.cwrap("WIDGET_STATE_PRESSED_OF_ACTIVE", "string", []);
var WIDGET_STATE_OVER_OF_ACTIVE = Module.cwrap("WIDGET_STATE_OVER_OF_ACTIVE", "string", []);
var WIDGET_STATE_DISABLE_OF_ACTIVE = Module.cwrap("WIDGET_STATE_DISABLE_OF_ACTIVE", "string", []);
var WIDGET_STATE_FOCUSED_OF_ACTIVE = Module.cwrap("WIDGET_STATE_FOCUSED_OF_ACTIVE", "string", []);
var WIDGET_CURSOR_DEFAULT = Module.cwrap("WIDGET_CURSOR_DEFAULT", "string", []);
var WIDGET_CURSOR_EDIT = Module.cwrap("WIDGET_CURSOR_EDIT", "string", []);
var WIDGET_CURSOR_HAND = Module.cwrap("WIDGET_CURSOR_HAND", "string", []);
var WIDGET_CURSOR_WAIT = Module.cwrap("WIDGET_CURSOR_WAIT", "string", []);
var WIDGET_CURSOR_CROSS = Module.cwrap("WIDGET_CURSOR_CROSS", "string", []);
var WIDGET_CURSOR_NO = Module.cwrap("WIDGET_CURSOR_NO", "string", []);
var WIDGET_CURSOR_SIZENWSE = Module.cwrap("WIDGET_CURSOR_SIZENWSE", "string", []);
var WIDGET_CURSOR_SIZENESW = Module.cwrap("WIDGET_CURSOR_SIZENESW", "string", []);
var WIDGET_CURSOR_SIZEWE = Module.cwrap("WIDGET_CURSOR_SIZEWE", "string", []);
var WIDGET_CURSOR_SIZENS = Module.cwrap("WIDGET_CURSOR_SIZENS", "string", []);
var WIDGET_CURSOR_SIZEALL = Module.cwrap("WIDGET_CURSOR_SIZEALL", "string", []);
var widget_count_children = Module.cwrap("widget_count_children", "number", ["TWidget"]);
var widget_get_child = Module.cwrap("widget_get_child", "TWidget", ["TWidget", "number"]);
var widget_get_focused_widget = Module.cwrap("widget_get_focused_widget", "TWidget", ["TWidget"]);
var widget_get_native_window = Module.cwrap("widget_get_native_window", "TNativeWindow", ["TWidget"]);
var widget_index_of = Module.cwrap("widget_index_of", "number", ["TWidget"]);
var widget_close_window = Module.cwrap("widget_close_window", "TRet", ["TWidget"]);
var widget_close_window_force = Module.cwrap("widget_close_window_force", "TRet", ["TWidget"]);
var widget_back = Module.cwrap("widget_back", "TRet", ["TWidget"]);
var widget_back_to_home = Module.cwrap("widget_back_to_home", "TRet", ["TWidget"]);
var widget_move = Module.cwrap("widget_move", "TRet", ["TWidget", "number", "number"]);
var widget_resize = Module.cwrap("widget_resize", "TRet", ["TWidget", "number", "number"]);
var widget_move_resize = Module.cwrap("widget_move_resize", "TRet", ["TWidget", "number", "number", "number", "number"]);
var widget_set_value = Module.cwrap("widget_set_value", "TRet", ["TWidget", "number"]);
var widget_animate_value_to = Module.cwrap("widget_animate_value_to", "TRet", ["TWidget", "number", "number"]);
var widget_add_value = Module.cwrap("widget_add_value", "TRet", ["TWidget", "number"]);
var widget_is_style_exist = Module.cwrap("widget_is_style_exist", "boolean", ["TWidget", "string", "string"]);
var widget_use_style = Module.cwrap("widget_use_style", "TRet", ["TWidget", "string"]);
var widget_set_text_utf8 = Module.cwrap("widget_set_text_utf8", "TRet", ["TWidget", "string"]);
var widget_set_child_text_utf8 = Module.cwrap("widget_set_child_text_utf8", "TRet", ["TWidget", "string", "string"]);
var widget_set_child_text_with_double = Module.cwrap("widget_set_child_text_with_double", "TRet", ["TWidget", "string", "string", "number"]);
var widget_set_child_text_with_int = Module.cwrap("widget_set_child_text_with_int", "TRet", ["TWidget", "string", "string", "number"]);
var widget_set_tr_text = Module.cwrap("widget_set_tr_text", "TRet", ["TWidget", "string"]);
var widget_get_value = Module.cwrap("widget_get_value", "number", ["TWidget"]);
var widget_get_enable = Module.cwrap("widget_get_enable", "boolean", ["TWidget"]);
var widget_get_floating = Module.cwrap("widget_get_floating", "boolean", ["TWidget"]);
var widget_get_auto_adjust_size = Module.cwrap("widget_get_auto_adjust_size", "boolean", ["TWidget"]);
var widget_get_with_focus_state = Module.cwrap("widget_get_with_focus_state", "boolean", ["TWidget"]);
var widget_get_focusable = Module.cwrap("widget_get_focusable", "boolean", ["TWidget"]);
var widget_get_sensitive = Module.cwrap("widget_get_sensitive", "boolean", ["TWidget"]);
var widget_get_visible = Module.cwrap("widget_get_visible", "boolean", ["TWidget"]);
var widget_get_feedback = Module.cwrap("widget_get_feedback", "boolean", ["TWidget"]);
var widget_get_text = Module.cwrap("widget_get_text", "any", ["TWidget"]);
var widget_set_name = Module.cwrap("widget_set_name", "TRet", ["TWidget", "string"]);
var widget_set_theme = Module.cwrap("widget_set_theme", "TRet", ["TWidget", "string"]);
var widget_set_pointer_cursor = Module.cwrap("widget_set_pointer_cursor", "TRet", ["TWidget", "string"]);
var widget_set_animation = Module.cwrap("widget_set_animation", "TRet", ["TWidget", "string"]);
var widget_create_animator = Module.cwrap("widget_create_animator", "TRet", ["TWidget", "string"]);
var widget_start_animator = Module.cwrap("widget_start_animator", "TRet", ["TWidget", "string"]);
var widget_set_animator_time_scale = Module.cwrap("widget_set_animator_time_scale", "TRet", ["TWidget", "string", "number"]);
var widget_pause_animator = Module.cwrap("widget_pause_animator", "TRet", ["TWidget", "string"]);
var widget_stop_animator = Module.cwrap("widget_stop_animator", "TRet", ["TWidget", "string"]);
var widget_destroy_animator = Module.cwrap("widget_destroy_animator", "TRet", ["TWidget", "string"]);
var widget_set_enable = Module.cwrap("widget_set_enable", "TRet", ["TWidget", "boolean"]);
var widget_set_feedback = Module.cwrap("widget_set_feedback", "TRet", ["TWidget", "boolean"]);
var widget_set_auto_adjust_size = Module.cwrap("widget_set_auto_adjust_size", "TRet", ["TWidget", "boolean"]);
var widget_set_floating = Module.cwrap("widget_set_floating", "TRet", ["TWidget", "boolean"]);
var widget_set_focused = Module.cwrap("widget_set_focused", "TRet", ["TWidget", "boolean"]);
var widget_set_focusable = Module.cwrap("widget_set_focusable", "TRet", ["TWidget", "boolean"]);
var widget_set_state = Module.cwrap("widget_set_state", "TRet", ["TWidget", "string"]);
var widget_set_opacity = Module.cwrap("widget_set_opacity", "TRet", ["TWidget", "number"]);
var widget_set_dirty_rect_tolerance = Module.cwrap("widget_set_dirty_rect_tolerance", "TRet", ["TWidget", "number"]);
var widget_destroy_children = Module.cwrap("widget_destroy_children", "TRet", ["TWidget"]);
var widget_add_child = Module.cwrap("widget_add_child", "TRet", ["TWidget", "TWidget"]);
var widget_remove_child = Module.cwrap("widget_remove_child", "TRet", ["TWidget", "TWidget"]);
var widget_insert_child = Module.cwrap("widget_insert_child", "TRet", ["TWidget", "number", "TWidget"]);
var widget_restack = Module.cwrap("widget_restack", "TRet", ["TWidget", "number"]);
var widget_child = Module.cwrap("widget_child", "TWidget", ["TWidget", "string"]);
var widget_lookup = Module.cwrap("widget_lookup", "TWidget", ["TWidget", "string", "boolean"]);
var widget_lookup_by_type = Module.cwrap("widget_lookup_by_type", "TWidget", ["TWidget", "string", "boolean"]);
var widget_set_visible = Module.cwrap("widget_set_visible", "TRet", ["TWidget", "boolean"]);
var widget_set_visible_only = Module.cwrap("widget_set_visible_only", "TRet", ["TWidget", "boolean"]);
var widget_set_sensitive = Module.cwrap("widget_set_sensitive", "TRet", ["TWidget", "boolean"]);
var widget_on = Module.cwrap("widget_on", "number", ["TWidget", "TEventType", "Function", "any"]);
var widget_off = Module.cwrap("widget_off", "TRet", ["TWidget", "number"]);
var widget_invalidate_force = Module.cwrap("widget_invalidate_force", "TRet", ["TWidget", "TRect"]);
var widget_set_prop_str = Module.cwrap("widget_set_prop_str", "TRet", ["TWidget", "string", "string"]);
var widget_get_prop_str = Module.cwrap("widget_get_prop_str", "string", ["TWidget", "string", "string"]);
var widget_set_prop_pointer = Module.cwrap("widget_set_prop_pointer", "TRet", ["TWidget", "string", "any"]);
var widget_get_prop_pointer = Module.cwrap("widget_get_prop_pointer", "any", ["TWidget", "string"]);
var widget_set_prop_int = Module.cwrap("widget_set_prop_int", "TRet", ["TWidget", "string", "number"]);
var widget_get_prop_int = Module.cwrap("widget_get_prop_int", "number", ["TWidget", "string", "number"]);
var widget_set_prop_bool = Module.cwrap("widget_set_prop_bool", "TRet", ["TWidget", "string", "boolean"]);
var widget_get_prop_bool = Module.cwrap("widget_get_prop_bool", "boolean", ["TWidget", "string", "boolean"]);
var widget_is_window_opened = Module.cwrap("widget_is_window_opened", "boolean", ["TWidget"]);
var widget_is_window_created = Module.cwrap("widget_is_window_created", "boolean", ["TWidget"]);
var widget_is_parent_of = Module.cwrap("widget_is_parent_of", "boolean", ["TWidget", "TWidget"]);
var widget_is_direct_parent_of = Module.cwrap("widget_is_direct_parent_of", "boolean", ["TWidget", "TWidget"]);
var widget_is_window = Module.cwrap("widget_is_window", "boolean", ["TWidget"]);
var widget_is_system_bar = Module.cwrap("widget_is_system_bar", "boolean", ["TWidget"]);
var widget_is_normal_window = Module.cwrap("widget_is_normal_window", "boolean", ["TWidget"]);
var widget_is_dialog = Module.cwrap("widget_is_dialog", "boolean", ["TWidget"]);
var widget_is_popup = Module.cwrap("widget_is_popup", "boolean", ["TWidget"]);
var widget_is_overlay = Module.cwrap("widget_is_overlay", "boolean", ["TWidget"]);
var widget_is_opened_dialog = Module.cwrap("widget_is_opened_dialog", "boolean", ["TWidget"]);
var widget_is_opened_popup = Module.cwrap("widget_is_opened_popup", "boolean", ["TWidget"]);
var widget_is_keyboard = Module.cwrap("widget_is_keyboard", "boolean", ["TWidget"]);
var widget_is_designing_window = Module.cwrap("widget_is_designing_window", "boolean", ["TWidget"]);
var widget_is_window_manager = Module.cwrap("widget_is_window_manager", "boolean", ["TWidget"]);
var widget_foreach = Module.cwrap("widget_foreach", "TRet", ["TWidget", "Function", "any"]);
var widget_get_window = Module.cwrap("widget_get_window", "TWidget", ["TWidget"]);
var widget_get_window_manager = Module.cwrap("widget_get_window_manager", "TWidget", ["TWidget"]);
var widget_get_type = Module.cwrap("widget_get_type", "string", ["TWidget"]);
var widget_clone = Module.cwrap("widget_clone", "TWidget", ["TWidget", "TWidget"]);
var widget_equal = Module.cwrap("widget_equal", "boolean", ["TWidget", "TWidget"]);
var widget_cast = Module.cwrap("widget_cast", "TWidget", ["TWidget"]);
var widget_destroy = Module.cwrap("widget_destroy", "TRet", ["TWidget"]);
var widget_destroy_async = Module.cwrap("widget_destroy_async", "TRet", ["TWidget"]);
var widget_unref = Module.cwrap("widget_unref", "TRet", ["TWidget"]);
var widget_stroke_border_rect = Module.cwrap("widget_stroke_border_rect", "TRet", ["TWidget", "TCanvas", "TRect"]);
var widget_fill_bg_rect = Module.cwrap("widget_fill_bg_rect", "TRet", ["TWidget", "TCanvas", "TRect", "TImageDrawType"]);
var widget_fill_fg_rect = Module.cwrap("widget_fill_fg_rect", "TRet", ["TWidget", "TCanvas", "TRect", "TImageDrawType"]);
var widget_dispatch_to_target = Module.cwrap("widget_dispatch_to_target", "TRet", ["TWidget", "TEvent"]);
var widget_dispatch_to_key_target = Module.cwrap("widget_dispatch_to_key_target", "TRet", ["TWidget", "TEvent"]);
var widget_get_style_type = Module.cwrap("widget_get_style_type", "string", ["TWidget"]);
var widget_update_style = Module.cwrap("widget_update_style", "TRet", ["TWidget"]);
var widget_update_style_recursive = Module.cwrap("widget_update_style_recursive", "TRet", ["TWidget"]);
var widget_set_as_key_target = Module.cwrap("widget_set_as_key_target", "TRet", ["TWidget"]);
var widget_focus_next = Module.cwrap("widget_focus_next", "TRet", ["TWidget"]);
var widget_focus_prev = Module.cwrap("widget_focus_prev", "TRet", ["TWidget"]);
var widget_get_state_for_style = Module.cwrap("widget_get_state_for_style", "string", ["TWidget", "boolean", "boolean"]);
var widget_layout = Module.cwrap("widget_layout", "TRet", ["TWidget"]);
var widget_set_self_layout = Module.cwrap("widget_set_self_layout", "TRet", ["TWidget", "string"]);
var widget_set_children_layout = Module.cwrap("widget_set_children_layout", "TRet", ["TWidget", "string"]);
var widget_set_self_layout_params = Module.cwrap("widget_set_self_layout_params", "TRet", ["TWidget", "string", "string", "string", "string"]);
var widget_set_style_int = Module.cwrap("widget_set_style_int", "TRet", ["TWidget", "string", "number"]);
var widget_set_style_str = Module.cwrap("widget_set_style_str", "TRet", ["TWidget", "string", "string"]);
var widget_set_style_color = Module.cwrap("widget_set_style_color", "TRet", ["TWidget", "string", "number"]);
...
var widget_t_get_prop_enable = Module.cwrap("widget_t_get_prop_enable", "boolean", ["number"]);
var widget_t_get_prop_feedback = Module.cwrap("widget_t_get_prop_feedback", "boolean", ["number"]);
var widget_t_get_prop_visible = Module.cwrap("widget_t_get_prop_visible", "boolean", ["number"]);
var widget_t_get_prop_sensitive = Module.cwrap("widget_t_get_prop_sensitive", "boolean", ["number"]);
var widget_t_get_prop_focusable = Module.cwrap("widget_t_get_prop_focusable", "boolean", ["number"]);
var widget_t_get_prop_with_focus_state = Module.cwrap("widget_t_get_prop_with_focus_state", "boolean", ["number"]);
var widget_t_get_prop_auto_adjust_size = Module.cwrap("widget_t_get_prop_auto_adjust_size", "boolean", ["number"]);
var widget_t_get_prop_floating = Module.cwrap("widget_t_get_prop_floating", "boolean", ["number"]);
var widget_t_get_prop_dirty_rect_tolerance = Module.cwrap("widget_t_get_prop_dirty_rect_tolerance", "number", ["number"]);
var widget_t_get_prop_parent = Module.cwrap("widget_t_get_prop_parent", "TWidget", ["number"]);
var app_conf_save = Module.cwrap("app_conf_save", "TRet", []);
var app_conf_reload = Module.cwrap("app_conf_reload", "TRet", []);
var app_conf_deinit = Module.cwrap("app_conf_deinit", "TRet", []);
var app_conf_exist = Module.cwrap("app_conf_exist", "boolean", ["string"]);
var app_conf_set_int = Module.cwrap("app_conf_set_int", "TRet", ["string", "number"]);
var app_conf_set_int64 = Module.cwrap("app_conf_set_int64", "TRet", ["string", "number"]);
var app_conf_set_bool = Module.cwrap("app_conf_set_bool", "TRet", ["string", "boolean"]);
var app_conf_set_double = Module.cwrap("app_conf_set_double", "TRet", ["string", "number"]);
var app_conf_set_str = Module.cwrap("app_conf_set_str", "TRet", ["string", "string"]);
...
var app_conf_get_bool = Module.cwrap("app_conf_get_bool", "boolean", ["string", "boolean"]);
...
var app_conf_remove = Module.cwrap("app_conf_remove", "TRet", ["string"]);
var tk_ext_widgets_init = Module.cwrap("tk_ext_widgets_init", "TRet", []);
var INDICATOR_DEFAULT_PAINT_AUTO = Module.cwrap("INDICATOR_DEFAULT_PAINT_AUTO", "number", []);
var INDICATOR_DEFAULT_PAINT_FILL_DOT = Module.cwrap("INDICATOR_DEFAULT_PAINT_FILL_DOT", "number", []);
var INDICATOR_DEFAULT_PAINT_STROKE_DOT = Module.cwrap("INDICATOR_DEFAULT_PAINT_STROKE_DOT", "number", []);
var INDICATOR_DEFAULT_PAINT_FILL_RECT = Module.cwrap("INDICATOR_DEFAULT_PAINT_FILL_RECT", "number", []);
var INDICATOR_DEFAULT_PAINT_STROKE_RECT = Module.cwrap("INDICATOR_DEFAULT_PAINT_STROKE_RECT", "number", []);
var EVT_VPAGE_WILL_OPEN = Module.cwrap("EVT_VPAGE_WILL_OPEN", "number", []);
var EVT_VPAGE_OPEN = Module.cwrap("EVT_VPAGE_OPEN", "number", []);
var EVT_VPAGE_CLOSE = Module.cwrap("EVT_VPAGE_CLOSE", "number", []);
var ASSET_TYPE_NONE = Module.cwrap("ASSET_TYPE_NONE", "number", []);
var ASSET_TYPE_FONT = Module.cwrap("ASSET_TYPE_FONT", "number", []);
var ASSET_TYPE_IMAGE = Module.cwrap("ASSET_TYPE_IMAGE", "number", []);
var ASSET_TYPE_STYLE = Module.cwrap("ASSET_TYPE_STYLE", "number", []);
var ASSET_TYPE_UI = Module.cwrap("ASSET_TYPE_UI", "number", []);
var ASSET_TYPE_XML = Module.cwrap("ASSET_TYPE_XML", "number", []);
var ASSET_TYPE_STRINGS = Module.cwrap("ASSET_TYPE_STRINGS", "number", []);
var ASSET_TYPE_SCRIPT = Module.cwrap("ASSET_TYPE_SCRIPT", "number", []);
var ASSET_TYPE_FLOW = Module.cwrap("ASSET_TYPE_FLOW", "number", []);
var ASSET_TYPE_DATA = Module.cwrap("ASSET_TYPE_DATA", "number", []);
var asset_info_get_type = Module.cwrap("asset_info_get_type", "number", ["TAssetInfo"]);
var asset_info_get_name = Module.cwrap("asset_info_get_name", "string", ["TAssetInfo"]);
...
var color_create = Module.cwrap("color_create", "TColor", ["number", "number", "number", "number"]);
var color_from_str = Module.cwrap("color_from_str", "TColor", ["TColor", "string"]);
var color_r = Module.cwrap("color_r", "number", ["TColor"]);
var color_g = Module.cwrap("color_g", "number", ["TColor"]);
var color_b = Module.cwrap("color_b", "number", ["TColor"]);
var color_a = Module.cwrap("color_a", "number", ["TColor"]);
var color_get_color = Module.cwrap("color_get_color", "number", ["TColor"]);
var color_cast = Module.cwrap("color_cast", "TColor", ["TColor"]);
var color_destroy = Module.cwrap("color_destroy", "TRet", ["TColor"]);
...
var date_time_create = Module.cwrap("date_time_create", "TDateTime", []);
var date_time_set_year = Module.cwrap("date_time_set_year", "TRet", ["TDateTime", "number"]);
var date_time_set_month = Module.cwrap("date_time_set_month", "TRet", ["TDateTime", "number"]);
var date_time_set_day = Module.cwrap("date_time_set_day", "TRet", ["TDateTime", "number"]);
var date_time_set_hour = Module.cwrap("date_time_set_hour", "TRet", ["TDateTime", "number"]);
var date_time_set_minute = Module.cwrap("date_time_set_minute", "TRet", ["TDateTime", "number"]);
var date_time_set_second = Module.cwrap("date_time_set_second", "TRet", ["TDateTime", "number"]);
var date_time_set = Module.cwrap("date_time_set", "TRet", ["TDateTime"]);
var date_time_from_time = Module.cwrap("date_time_from_time", "TRet", ["TDateTime", "number"]);
var date_time_to_time = Module.cwrap("date_time_to_time", "number", ["TDateTime"]);
var date_time_add_delta = Module.cwrap("date_time_add_delta", "TRet", ["TDateTime", "number"]);
var date_time_is_leap = Module.cwrap("date_time_is_leap", "boolean", ["number"]);
...
var date_time_destroy = Module.cwrap("date_time_destroy", "TRet", ["TDateTime"]);
...
var EASING_LINEAR = Module.cwrap("EASING_LINEAR", "number", []);
var EASING_QUADRATIC_IN = Module.cwrap("EASING_QUADRATIC_IN", "number", []);
var EASING_QUADRATIC_OUT = Module.cwrap("EASING_QUADRATIC_OUT", "number", []);
var EASING_QUADRATIC_INOUT = Module.cwrap("EASING_QUADRATIC_INOUT", "number", []);
var EASING_CUBIC_IN = Module.cwrap("EASING_CUBIC_IN", "number", []);
var EASING_CUBIC_OUT = Module.cwrap("EASING_CUBIC_OUT", "number", []);
var EASING_SIN_IN = Module.cwrap("EASING_SIN_IN", "number", []);
var EASING_SIN_OUT = Module.cwrap("EASING_SIN_OUT", "number", []);
var EASING_SIN_INOUT = Module.cwrap("EASING_SIN_INOUT", "number", []);
var EASING_POW_IN = Module.cwrap("EASING_POW_IN", "number", []);
var EASING_POW_OUT = Module.cwrap("EASING_POW_OUT", "number", []);
var EASING_POW_INOUT = Module.cwrap("EASING_POW_INOUT", "number", []);
var EASING_CIRCULAR_IN = Module.cwrap("EASING_CIRCULAR_IN", "number", []);
var EASING_CIRCULAR_OUT = Module.cwrap("EASING_CIRCULAR_OUT", "number", []);
var EASING_CIRCULAR_INOUT = Module.cwrap("EASING_CIRCULAR_INOUT", "number", []);
var EASING_ELASTIC_IN = Module.cwrap("EASING_ELASTIC_IN", "number", []);
var EASING_ELASTIC_OUT = Module.cwrap("EASING_ELASTIC_OUT", "number", []);
var EASING_ELASTIC_INOUT = Module.cwrap("EASING_ELASTIC_INOUT", "number", []);
var EASING_BACK_IN = Module.cwrap("EASING_BACK_IN", "number", []);
var EASING_BACK_OUT = Module.cwrap("EASING_BACK_OUT", "number", []);
var EASING_BACK_INOUT = Module.cwrap("EASING_BACK_INOUT", "number", []);
var EASING_BOUNCE_IN = Module.cwrap("EASING_BOUNCE_IN", "number", []);
var EASING_BOUNCE_OUT = Module.cwrap("EASING_BOUNCE_OUT", "number", []);
var EASING_BOUNCE_INOUT = Module.cwrap("EASING_BOUNCE_INOUT", "number", []);
var MIME_TYPE_APPLICATION_ENVOY = Module.cwrap("MIME_TYPE_APPLICATION_ENVOY", "string", []);
var MIME_TYPE_APPLICATION_FRACTALS = Module.cwrap("MIME_TYPE_APPLICATION_FRACTALS", "string", []);
var MIME_TYPE_APPLICATION_FUTURESPLASH = Module.cwrap("MIME_TYPE_APPLICATION_FUTURESPLASH", "string", []);
var MIME_TYPE_APPLICATION_HTA = Module.cwrap("MIME_TYPE_APPLICATION_HTA", "string", []);
var MIME_TYPE_APPLICATION_JSON = Module.cwrap("MIME_TYPE_APPLICATION_JSON", "string", []);
var MIME_TYPE_APPLICATION_UBJSON = Module.cwrap("MIME_TYPE_APPLICATION_UBJSON", "string", []);
var MIME_TYPE_APPLICATION_MAC_BINHEX40 = Module.cwrap("MIME_TYPE_APPLICATION_MAC_BINHEX40", "string", []);
var MIME_TYPE_APPLICATION_MSWORD = Module.cwrap("MIME_TYPE_APPLICATION_MSWORD", "string", []);
var MIME_TYPE_APPLICATION_OCTET_STREAM = Module.cwrap("MIME_TYPE_APPLICATION_OCTET_STREAM", "string", []);
var MIME_TYPE_APPLICATION_ODA = Module.cwrap("MIME_TYPE_APPLICATION_ODA", "string", []);
var MIME_TYPE_APPLICATION_OLESCRIPT = Module.cwrap("MIME_TYPE_APPLICATION_OLESCRIPT", "string", []);
var MIME_TYPE_APPLICATION_PDF = Module.cwrap("MIME_TYPE_APPLICATION_PDF", "string", []);
var MIME_TYPE_APPLICATION_PICS_RULES = Module.cwrap("MIME_TYPE_APPLICATION_PICS_RULES", "string", []);
var MIME_TYPE_APPLICATION_PKCS10 = Module.cwrap("MIME_TYPE_APPLICATION_PKCS10", "string", []);
var MIME_TYPE_APPLICATION_PKIX_CRL = Module.cwrap("MIME_TYPE_APPLICATION_PKIX_CRL", "string", []);
var MIME_TYPE_APPLICATION_POSTSCRIPT = Module.cwrap("MIME_TYPE_APPLICATION_POSTSCRIPT", "string", []);
var MIME_TYPE_APPLICATION_RTF = Module.cwrap("MIME_TYPE_APPLICATION_RTF", "string", []);
var MIME_TYPE_APPLICATION_VND_MS_EXCEL = Module.cwrap("MIME_TYPE_APPLICATION_VND_MS_EXCEL", "string", []);
var MIME_TYPE_APPLICATION_VND_MS_OUTLOOK = Module.cwrap("MIME_TYPE_APPLICATION_VND_MS_OUTLOOK", "string", []);
var MIME_TYPE_APPLICATION_VND_MS_PKICERTSTORE = Module.cwrap("MIME_TYPE_APPLICATION_VND_MS_PKICERTSTORE", "string", []);
var MIME_TYPE_APPLICATION_VND_MS_PKISECCAT = Module.cwrap("MIME_TYPE_APPLICATION_VND_MS_PKISECCAT", "string", []);
var MIME_TYPE_APPLICATION_VND_MS_PKISTL = Module.cwrap("MIME_TYPE_APPLICATION_VND_MS_PKISTL", "string", []);
var MIME_TYPE_APPLICATION_VND_MS_POWERPOINT = Module.cwrap("MIME_TYPE_APPLICATION_VND_MS_POWERPOINT", "string", []);
var MIME_TYPE_APPLICATION_VND_MS_PROJECT = Module.cwrap("MIME_TYPE_APPLICATION_VND_MS_PROJECT", "string", []);
var MIME_TYPE_APPLICATION_VND_MS_WORKS = Module.cwrap("MIME_TYPE_APPLICATION_VND_MS_WORKS", "string", []);
var MIME_TYPE_APPLICATION_WINHLP = Module.cwrap("MIME_TYPE_APPLICATION_WINHLP", "string", []);
var MIME_TYPE_APPLICATION_X_BCPIO = Module.cwrap("MIME_TYPE_APPLICATION_X_BCPIO", "string", []);
var MIME_TYPE_APPLICATION_X_CDF = Module.cwrap("MIME_TYPE_APPLICATION_X_CDF", "string", []);
var MIME_TYPE_APPLICATION_X_COMPRESS = Module.cwrap("MIME_TYPE_APPLICATION_X_COMPRESS", "string", []);
var MIME_TYPE_APPLICATION_X_COMPRESSED = Module.cwrap("MIME_TYPE_APPLICATION_X_COMPRESSED", "string", []);
var MIME_TYPE_APPLICATION_X_CPIO = Module.cwrap("MIME_TYPE_APPLICATION_X_CPIO", "string", []);
var MIME_TYPE_APPLICATION_X_CSH = Module.cwrap("MIME_TYPE_APPLICATION_X_CSH", "string", []);
var MIME_TYPE_APPLICATION_X_DIRECTOR = Module.cwrap("MIME_TYPE_APPLICATION_X_DIRECTOR", "string", []);
var MIME_TYPE_APPLICATION_X_DVI = Module.cwrap("MIME_TYPE_APPLICATION_X_DVI", "string", []);
var MIME_TYPE_APPLICATION_X_GTAR = Module.cwrap("MIME_TYPE_APPLICATION_X_GTAR", "string", []);
var MIME_TYPE_APPLICATION_X_GZIP = Module.cwrap("MIME_TYPE_APPLICATION_X_GZIP", "string", []);
var MIME_TYPE_APPLICATION_X_HDF = Module.cwrap("MIME_TYPE_APPLICATION_X_HDF", "string", []);
var MIME_TYPE_APPLICATION_X_IPHONE = Module.cwrap("MIME_TYPE_APPLICATION_X_IPHONE", "string", []);
var MIME_TYPE_APPLICATION_X_JAVASCRIPT = Module.cwrap("MIME_TYPE_APPLICATION_X_JAVASCRIPT", "string", []);
var MIME_TYPE_APPLICATION_X_LATEX = Module.cwrap("MIME_TYPE_APPLICATION_X_LATEX", "string", []);
var MIME_TYPE_APPLICATION_X_MSACCESS = Module.cwrap("MIME_TYPE_APPLICATION_X_MSACCESS", "string", []);
var MIME_TYPE_APPLICATION_X_MSCARDFILE = Module.cwrap("MIME_TYPE_APPLICATION_X_MSCARDFILE", "string", []);
var MIME_TYPE_APPLICATION_X_MSCLIP = Module.cwrap("MIME_TYPE_APPLICATION_X_MSCLIP", "string", []);
var MIME_TYPE_APPLICATION_X_MSDOWNLOAD = Module.cwrap("MIME_TYPE_APPLICATION_X_MSDOWNLOAD", "string", []);
var MIME_TYPE_APPLICATION_X_MSMEDIAVIEW = Module.cwrap("MIME_TYPE_APPLICATION_X_MSMEDIAVIEW", "string", []);
var MIME_TYPE_APPLICATION_X_MSMETAFILE = Module.cwrap("MIME_TYPE_APPLICATION_X_MSMETAFILE", "string", []);
var MIME_TYPE_APPLICATION_X_MSMONEY = Module.cwrap("MIME_TYPE_APPLICATION_X_MSMONEY", "string", []);
var MIME_TYPE_APPLICATION_X_MSPUBLISHER = Module.cwrap("MIME_TYPE_APPLICATION_X_MSPUBLISHER", "string", []);
var MIME_TYPE_APPLICATION_X_MSSCHEDULE = Module.cwrap("MIME_TYPE_APPLICATION_X_MSSCHEDULE", "string", []);
var MIME_TYPE_APPLICATION_X_MSTERMINAL = Module.cwrap("MIME_TYPE_APPLICATION_X_MSTERMINAL", "string", []);
var MIME_TYPE_APPLICATION_X_MSWRITE = Module.cwrap("MIME_TYPE_APPLICATION_X_MSWRITE", "string", []);
var MIME_TYPE_APPLICATION_X_NETCDF = Module.cwrap("MIME_TYPE_APPLICATION_X_NETCDF", "string", []);
var MIME_TYPE_APPLICATION_X_PERFMON = Module.cwrap("MIME_TYPE_APPLICATION_X_PERFMON", "string", []);
var MIME_TYPE_APPLICATION_X_PKCS12 = Module.cwrap("MIME_TYPE_APPLICATION_X_PKCS12", "string", []);
var MIME_TYPE_APPLICATION_X_SH = Module.cwrap("MIME_TYPE_APPLICATION_X_SH", "string", []);
var MIME_TYPE_APPLICATION_X_SHAR = Module.cwrap("MIME_TYPE_APPLICATION_X_SHAR", "string", []);
var MIME_TYPE_APPLICATION_X_SHOCKWAVE_FLASH = Module.cwrap("MIME_TYPE_APPLICATION_X_SHOCKWAVE_FLASH", "string", []);
var MIME_TYPE_APPLICATION_X_STUFFIT = Module.cwrap("MIME_TYPE_APPLICATION_X_STUFFIT", "string", []);
var MIME_TYPE_APPLICATION_X_SV4CPIO = Module.cwrap("MIME_TYPE_APPLICATION_X_SV4CPIO", "string", []);
var MIME_TYPE_APPLICATION_X_SV4CRC = Module.cwrap("MIME_TYPE_APPLICATION_X_SV4CRC", "string", []);
var MIME_TYPE_APPLICATION_X_TAR = Module.cwrap("MIME_TYPE_APPLICATION_X_TAR", "string", []);
var MIME_TYPE_APPLICATION_X_TCL = Module.cwrap("MIME_TYPE_APPLICATION_X_TCL", "string", []);
var MIME_TYPE_APPLICATION_X_TEX = Module.cwrap("MIME_TYPE_APPLICATION_X_TEX", "string", []);
var MIME_TYPE_APPLICATION_X_TEXINFO = Module.cwrap("MIME_TYPE_APPLICATION_X_TEXINFO", "string", []);
var MIME_TYPE_APPLICATION_X_TROFF = Module.cwrap("MIME_TYPE_APPLICATION_X_TROFF", "string", []);
var MIME_TYPE_APPLICATION_X_USTAR = Module.cwrap("MIME_TYPE_APPLICATION_X_USTAR", "string", []);
var MIME_TYPE_APPLICATION_ZIP = Module.cwrap("MIME_TYPE_APPLICATION_ZIP", "string", []);
var MIME_TYPE_AUDIO_BASIC = Module.cwrap("MIME_TYPE_AUDIO_BASIC", "string", []);
var MIME_TYPE_AUDIO_MID = Module.cwrap("MIME_TYPE_AUDIO_MID", "string", []);
var MIME_TYPE_AUDIO_MPEG = Module.cwrap("MIME_TYPE_AUDIO_MPEG", "string", []);
var MIME_TYPE_AUDIO_X_AIFF = Module.cwrap("MIME_TYPE_AUDIO_X_AIFF", "string", []);
var MIME_TYPE_AUDIO_X_MPEGURL = Module.cwrap("MIME_TYPE_AUDIO_X_MPEGURL", "string", []);
var MIME_TYPE_AUDIO_X_WAV = Module.cwrap("MIME_TYPE_AUDIO_X_WAV", "string", []);
var MIME_TYPE_IMAGE_BMP = Module.cwrap("MIME_TYPE_IMAGE_BMP", "string", []);
var MIME_TYPE_IMAGE_CIS_COD = Module.cwrap("MIME_TYPE_IMAGE_CIS_COD", "string", []);
var MIME_TYPE_IMAGE_GIF = Module.cwrap("MIME_TYPE_IMAGE_GIF", "string", []);
var MIME_TYPE_IMAGE_IEF = Module.cwrap("MIME_TYPE_IMAGE_IEF", "string", []);
var MIME_TYPE_IMAGE_JPEG = Module.cwrap("MIME_TYPE_IMAGE_JPEG", "string", []);
var MIME_TYPE_IMAGE_PIPEG = Module.cwrap("MIME_TYPE_IMAGE_PIPEG", "string", []);
var MIME_TYPE_IMAGE_SVG_XML = Module.cwrap("MIME_TYPE_IMAGE_SVG_XML", "string", []);
var MIME_TYPE_IMAGE_TIFF = Module.cwrap("MIME_TYPE_IMAGE_TIFF", "string", []);
var MIME_TYPE_IMAGE_X_CMX = Module.cwrap("MIME_TYPE_IMAGE_X_CMX", "string", []);
var MIME_TYPE_IMAGE_X_ICON = Module.cwrap("MIME_TYPE_IMAGE_X_ICON", "string", []);
var MIME_TYPE_IMAGE_X_RGB = Module.cwrap("MIME_TYPE_IMAGE_X_RGB", "string", []);
var MIME_TYPE_IMAGE_X_XBITMAP = Module.cwrap("MIME_TYPE_IMAGE_X_XBITMAP", "string", []);
var MIME_TYPE_IMAGE_X_XPIXMAP = Module.cwrap("MIME_TYPE_IMAGE_X_XPIXMAP", "string", []);
var MIME_TYPE_IMAGE_X_XWINDOWDUMP = Module.cwrap("MIME_TYPE_IMAGE_X_XWINDOWDUMP", "string", []);
var MIME_TYPE_MESSAGE_RFC822 = Module.cwrap("MIME_TYPE_MESSAGE_RFC822", "string", []);
var MIME_TYPE_TEXT_CSS = Module.cwrap("MIME_TYPE_TEXT_CSS", "string", []);
var MIME_TYPE_TEXT_H323 = Module.cwrap("MIME_TYPE_TEXT_H323", "string", []);
var MIME_TYPE_TEXT_HTML = Module.cwrap("MIME_TYPE_TEXT_HTML", "string", []);
var MIME_TYPE_TEXT_IULS = Module.cwrap("MIME_TYPE_TEXT_IULS", "string", []);
var MIME_TYPE_TEXT_PLAIN = Module.cwrap("MIME_TYPE_TEXT_PLAIN", "string", []);
var MIME_TYPE_TEXT_RICHTEXT = Module.cwrap("MIME_TYPE_TEXT_RICHTEXT", "string", []);
var MIME_TYPE_TEXT_SCRIPTLET = Module.cwrap("MIME_TYPE_TEXT_SCRIPTLET", "string", []);
var MIME_TYPE_TEXT_WEBVIEWHTML = Module.cwrap("MIME_TYPE_TEXT_WEBVIEWHTML", "string", []);
var MIME_TYPE_TEXT_X_COMPONENT = Module.cwrap("MIME_TYPE_TEXT_X_COMPONENT", "string", []);
var MIME_TYPE_TEXT_X_SETEXT = Module.cwrap("MIME_TYPE_TEXT_X_SETEXT", "string", []);
var MIME_TYPE_TEXT_X_VCARD = Module.cwrap("MIME_TYPE_TEXT_X_VCARD", "string", []);
var MIME_TYPE_VIDEO_MPEG = Module.cwrap("MIME_TYPE_VIDEO_MPEG", "string", []);
var MIME_TYPE_VIDEO_QUICKTIME = Module.cwrap("MIME_TYPE_VIDEO_QUICKTIME", "string", []);
var MIME_TYPE_VIDEO_X_MSVIDEO = Module.cwrap("MIME_TYPE_VIDEO_X_MSVIDEO", "string", []);
var named_value_create = Module.cwrap("named_value_create", "TNamedValue", []);
var named_value_cast = Module.cwrap("named_value_cast", "TNamedValue", ["TNamedValue"]);
var named_value_set_name = Module.cwrap("named_value_set_name", "TRet", ["TNamedValue", "string"]);
var named_value_set_value = Module.cwrap("named_value_set_value", "TRet", ["TNamedValue", "TValue"]);
var named_value_get_value = Module.cwrap("named_value_get_value", "TValue", ["TNamedValue"]);
var named_value_destroy = Module.cwrap("named_value_destroy", "TRet", ["TNamedValue"]);
var named_value_t_get_prop_name = Module.cwrap("named_value_t_get_prop_name", "string", ["number"]);
var OBJECT_CMD_SAVE = Module.cwrap("OBJECT_CMD_SAVE", "string", []);
var OBJECT_CMD_RELOAD = Module.cwrap("OBJECT_CMD_RELOAD", "string", []);
var OBJECT_CMD_MOVE_UP = Module.cwrap("OBJECT_CMD_MOVE_UP", "string", []);
var OBJECT_CMD_MOVE_DOWN = Module.cwrap("OBJECT_CMD_MOVE_DOWN", "string", []);
var OBJECT_CMD_REMOVE = Module.cwrap("OBJECT_CMD_REMOVE", "string", []);
var OBJECT_CMD_REMOVE_CHECKED = Module.cwrap("OBJECT_CMD_REMOVE_CHECKED", "string", []);
var OBJECT_CMD_CLEAR = Module.cwrap("OBJECT_CMD_CLEAR", "string", []);
var OBJECT_CMD_ADD = Module.cwrap("OBJECT_CMD_ADD", "string", []);
var OBJECT_CMD_DETAIL = Module.cwrap("OBJECT_CMD_DETAIL", "string", []);
var OBJECT_CMD_EDIT = Module.cwrap("OBJECT_CMD_EDIT", "string", []);
var OBJECT_PROP_SIZE = Module.cwrap("OBJECT_PROP_SIZE", "string", []);
var OBJECT_PROP_CHECKED = Module.cwrap("OBJECT_PROP_CHECKED", "string", []);
var rlog_create = Module.cwrap("rlog_create", "TRlog", ["string", "number", "number"]);
var rlog_write = Module.cwrap("rlog_write", "TRet", ["TRlog", "string"]);
...
var RET_OK = Module.cwrap("RET_OK", "number", []);
var RET_OOM = Module.cwrap("RET_OOM", "number", []);
var RET_FAIL = Module.cwrap("RET_FAIL", "number", []);
var RET_NOT_IMPL = Module.cwrap("RET_NOT_IMPL", "number", []);
var RET_QUIT = Module.cwrap("RET_QUIT", "number", []);
var RET_FOUND = Module.cwrap("RET_FOUND", "number", []);
var RET_BUSY = Module.cwrap("RET_BUSY", "number", []);
var RET_REMOVE = Module.cwrap("RET_REMOVE", "number", []);
var RET_REPEAT = Module.cwrap("RET_REPEAT", "number", []);
var RET_NOT_FOUND = Module.cwrap("RET_NOT_FOUND", "number", []);
var RET_DONE = Module.cwrap("RET_DONE", "number", []);
var RET_STOP = Module.cwrap("RET_STOP", "number", []);
var RET_SKIP = Module.cwrap("RET_SKIP", "number", []);
var RET_CONTINUE = Module.cwrap("RET_CONTINUE", "number", []);
var RET_OBJECT_CHANGED = Module.cwrap("RET_OBJECT_CHANGED", "number", []);
var RET_ITEMS_CHANGED = Module.cwrap("RET_ITEMS_CHANGED", "number", []);
var RET_BAD_PARAMS = Module.cwrap("RET_BAD_PARAMS", "number", []);
var RET_TIMEOUT = Module.cwrap("RET_TIMEOUT", "number", []);
var RET_CRC = Module.cwrap("RET_CRC", "number", []);
var RET_IO = Module.cwrap("RET_IO", "number", []);
var RET_EOS = Module.cwrap("RET_EOS", "number", []);
var RET_NOT_MODIFIED = Module.cwrap("RET_NOT_MODIFIED", "number", []);
var VALUE_TYPE_INVALID = Module.cwrap("VALUE_TYPE_INVALID", "number", []);
var VALUE_TYPE_BOOL = Module.cwrap("VALUE_TYPE_BOOL", "number", []);
var VALUE_TYPE_INT8 = Module.cwrap("VALUE_TYPE_INT8", "number", []);
var VALUE_TYPE_UINT8 = Module.cwrap("VALUE_TYPE_UINT8", "number", []);
var VALUE_TYPE_INT16 = Module.cwrap("VALUE_TYPE_INT16", "number", []);
var VALUE_TYPE_UINT16 = Module.cwrap("VALUE_TYPE_UINT16", "number", []);
var VALUE_TYPE_INT32 = Module.cwrap("VALUE_TYPE_INT32", "number", []);
var VALUE_TYPE_UINT32 = Module.cwrap("VALUE_TYPE_UINT32", "number", []);
var VALUE_TYPE_INT64 = Module.cwrap("VALUE_TYPE_INT64", "number", []);
var VALUE_TYPE_UINT64 = Module.cwrap("VALUE_TYPE_UINT64", "number", []);
var VALUE_TYPE_POINTER = Module.cwrap("VALUE_TYPE_POINTER", "number", []);
var VALUE_TYPE_FLOAT = Module.cwrap("VALUE_TYPE_FLOAT", "number", []);
var VALUE_TYPE_FLOAT32 = Module.cwrap("VALUE_TYPE_FLOAT32", "number", []);
var VALUE_TYPE_DOUBLE = Module.cwrap("VALUE_TYPE_DOUBLE", "number", []);
var VALUE_TYPE_STRING = Module.cwrap("VALUE_TYPE_STRING", "number", []);
var VALUE_TYPE_WSTRING = Module.cwrap("VALUE_TYPE_WSTRING", "number", []);
var VALUE_TYPE_OBJECT = Module.cwrap("VALUE_TYPE_OBJECT", "number", []);
var VALUE_TYPE_SIZED_STRING = Module.cwrap("VALUE_TYPE_SIZED_STRING", "number", []);
var VALUE_TYPE_BINARY = Module.cwrap("VALUE_TYPE_BINARY", "number", []);
var VALUE_TYPE_UBJSON = Module.cwrap("VALUE_TYPE_UBJSON", "number", []);
var VALUE_TYPE_TOKEN = Module.cwrap("VALUE_TYPE_TOKEN", "number", []);
var assets_manager = Module.cwrap("assets_manager", "TAssetsManager", []);
var assets_manager_set_theme = Module.cwrap("assets_manager_set_theme", "TRet", ["TAssetsManager", "string"]);
var assets_manager_ref = Module.cwrap("assets_manager_ref", "TAssetInfo", ["TAssetsManager", "TAssetType", "string"]);
var assets_manager_ref_ex = Module.cwrap("assets_manager_ref_ex", "TAssetInfo", ["TAssetsManager", "TAssetType", "number", "string"]);
var assets_manager_unref = Module.cwrap("assets_manager_unref", "TRet", ["TAssetsManager", "TAssetInfo"]);
var wheel_event_cast = Module.cwrap("wheel_event_cast", "TWheelEvent", ["TEvent"]);
var wheel_event_t_get_prop_dy = Module.cwrap("wheel_event_t_get_prop_dy", "number", ["number"]);
var wheel_event_t_get_prop_alt = Module.cwrap("wheel_event_t_get_prop_alt", "boolean", ["number"]);
var wheel_event_t_get_prop_ctrl = Module.cwrap("wheel_event_t_get_prop_ctrl", "boolean", ["number"]);
var wheel_event_t_get_prop_shift = Module.cwrap("wheel_event_t_get_prop_shift", "boolean", ["number"]);
var orientation_event_cast = Module.cwrap("orientation_event_cast", "TOrientationEvent", ["TEvent"]);
var orientation_event_t_get_prop_orientation = Module.cwrap("orientation_event_t_get_prop_orientation", "number", ["number"]);
var value_change_event_cast = Module.cwrap("value_change_event_cast", "TValueChangeEvent", ["TEvent"]);
var pointer_event_cast = Module.cwrap("pointer_event_cast", "TPointerEvent", ["TEvent"]);
...
var pointer_event_t_get_prop_pressed = Module.cwrap("pointer_event_t_get_prop_pressed", "boolean", ["number"]);
var pointer_event_t_get_prop_alt = Module.cwrap("pointer_event_t_get_prop_alt", "boolean", ["number"]);
var pointer_event_t_get_prop_ctrl = Module.cwrap("pointer_event_t_get_prop_ctrl", "boolean", ["number"]);
var pointer_event_t_get_prop_cmd = Module.cwrap("pointer_event_t_get_prop_cmd", "boolean", ["number"]);
var pointer_event_t_get_prop_menu = Module.cwrap("pointer_event_t_get_prop_menu", "boolean", ["number"]);
var pointer_event_t_get_prop_shift = Module.cwrap("pointer_event_t_get_prop_shift", "boolean", ["number"]);
var key_event_cast = Module.cwrap("key_event_cast", "TKeyEvent", ["TEvent"]);
var key_event_t_get_prop_key = Module.cwrap("key_event_t_get_prop_key", "number", ["number"]);
var key_event_t_get_prop_alt = Module.cwrap("key_event_t_get_prop_alt", "boolean", ["number"]);
var key_event_t_get_prop_lalt = Module.cwrap("key_event_t_get_prop_lalt", "boolean", ["number"]);
var key_event_t_get_prop_ralt = Module.cwrap("key_event_t_get_prop_ralt", "boolean", ["number"]);
var key_event_t_get_prop_ctrl = Module.cwrap("key_event_t_get_prop_ctrl", "boolean", ["number"]);
var key_event_t_get_prop_lctrl = Module.cwrap("key_event_t_get_prop_lctrl", "boolean", ["number"]);
var key_event_t_get_prop_rctrl = Module.cwrap("key_event_t_get_prop_rctrl", "boolean", ["number"]);
var key_event_t_get_prop_shift = Module.cwrap("key_event_t_get_prop_shift", "boolean", ["number"]);
var key_event_t_get_prop_lshift = Module.cwrap("key_event_t_get_prop_lshift", "boolean", ["number"]);
var key_event_t_get_prop_rshift = Module.cwrap("key_event_t_get_prop_rshift", "boolean", ["number"]);
var key_event_t_get_prop_cmd = Module.cwrap("key_event_t_get_prop_cmd", "boolean", ["number"]);
var key_event_t_get_prop_menu = Module.cwrap("key_event_t_get_prop_menu", "boolean", ["number"]);
var key_event_t_get_prop_capslock = Module.cwrap("key_event_t_get_prop_capslock", "boolean", ["number"]);
var paint_event_cast = Module.cwrap("paint_event_cast", "TPaintEvent", ["TEvent"]);
var paint_event_t_get_prop_c = Module.cwrap("paint_event_t_get_prop_c", "TCanvas", ["number"]);
var window_event_cast = Module.cwrap("window_event_cast", "TWindowEvent", ["TEvent"]);
var window_event_t_get_prop_window = Module.cwrap("window_event_t_get_prop_window", "TWidget", ["number"]);
var multi_gesture_event_cast = Module.cwrap("multi_gesture_event_cast", "TMultiGestureEvent", ["TEvent"]);
...
var image_base_set_image = Module.cwrap("image_base_set_image", "TRet", ["TWidget", "string"]);
var image_base_set_rotation = Module.cwrap("image_base_set_rotation", "TRet", ["TWidget", "number"]);
var image_base_set_scale = Module.cwrap("image_base_set_scale", "TRet", ["TWidget", "number", "number"]);
var image_base_set_anchor = Module.cwrap("image_base_set_anchor", "TRet", ["TWidget", "number", "number"]);
var image_base_set_selected = Module.cwrap("image_base_set_selected", "TRet", ["TWidget", "boolean"]);
var image_base_set_selectable = Module.cwrap("image_base_set_selectable", "TRet", ["TWidget", "boolean"]);
var image_base_set_clickable = Module.cwrap("image_base_set_clickable", "TRet", ["TWidget", "boolean"]);
var image_base_cast = Module.cwrap("image_base_cast", "TWidget", ["TWidget"]);
...
var image_base_t_get_prop_clickable = Module.cwrap("image_base_t_get_prop_clickable", "boolean", ["number"]);
var image_base_t_get_prop_selectable = Module.cwrap("image_base_t_get_prop_selectable", "boolean", ["number"]);
var image_base_t_get_prop_selected = Module.cwrap("image_base_t_get_prop_selected", "boolean", ["number"]);
var style_mutable_set_name = Module.cwrap("style_mutable_set_name", "TRet", ["TStyle", "string"]);
var style_mutable_set_int = Module.cwrap("style_mutable_set_int", "TRet", ["TStyle", "string", "string", "number"]);
var style_mutable_cast = Module.cwrap("style_mutable_cast", "TStyle", ["TStyle"]);
var style_mutable_create = Module.cwrap("style_mutable_create", "TStyle", ["TStyle"]);
var style_mutable_t_get_prop_name = Module.cwrap("style_mutable_t_get_prop_name", "string", ["number"]);
var window_base_cast = Module.cwrap("window_base_cast", "TWidget", ["TWidget"]);
...
var window_base_t_get_prop_auto_scale_children_x = Module.cwrap("window_base_t_get_prop_auto_scale_children_x", "boolean", ["number"]);
var window_base_t_get_prop_auto_scale_children_y = Module.cwrap("window_base_t_get_prop_auto_scale_children_y", "boolean", ["number"]);
var window_base_t_get_prop_auto_scale_children_w = Module.cwrap("window_base_t_get_prop_auto_scale_children_w", "boolean", ["number"]);
var window_base_t_get_prop_auto_scale_children_h = Module.cwrap("window_base_t_get_prop_auto_scale_children_h", "boolean", ["number"]);
var window_base_t_get_prop_disable_anim = Module.cwrap("window_base_t_get_prop_disable_anim", "boolean", ["number"]);
var window_base_t_get_prop_closable = Module.cwrap("window_base_t_get_prop_closable", "TWindowClosable", ["number"]);
...
var window_base_t_get_prop_single_instance = Module.cwrap("window_base_t_get_prop_single_instance", "boolean", ["number"]);
var window_base_t_get_prop_strongly_focus = Module.cwrap("window_base_t_get_prop_strongly_focus", "boolean", ["number"]);
var window_manager = Module.cwrap("window_manager", "TWidget", []);
var window_manager_cast = Module.cwrap("window_manager_cast", "TWidget", ["TWidget"]);
var window_manager_get_top_main_window = Module.cwrap("window_manager_get_top_main_window", "TWidget", ["TWidget"]);
var window_manager_get_top_window = Module.cwrap("window_manager_get_top_window", "TWidget", ["TWidget"]);
var window_manager_get_prev_window = Module.cwrap("window_manager_get_prev_window", "TWidget", ["TWidget"]);
var window_manager_get_pointer_x = Module.cwrap("window_manager_get_pointer_x", "number", ["TWidget"]);
var window_manager_get_pointer_y = Module.cwrap("window_manager_get_pointer_y", "number", ["TWidget"]);
var window_manager_get_pointer_pressed = Module.cwrap("window_manager_get_pointer_pressed", "boolean", ["TWidget"]);
var window_manager_is_animating = Module.cwrap("window_manager_is_animating", "boolean", ["TWidget"]);
var window_manager_set_show_fps = Module.cwrap("window_manager_set_show_fps", "TRet", ["TWidget", "boolean"]);
var window_manager_set_max_fps = Module.cwrap("window_manager_set_max_fps", "TRet", ["TWidget", "number"]);
var window_manager_set_ignore_input_events = Module.cwrap("window_manager_set_ignore_input_events", "TRet", ["TWidget", "boolean"]);
var window_manager_set_screen_saver_time = Module.cwrap("window_manager_set_screen_saver_time", "TRet", ["TWidget", "number"]);
var window_manager_set_cursor = Module.cwrap("window_manager_set_cursor", "TRet", ["TWidget", "string"]);
var window_manager_back = Module.cwrap("window_manager_back", "TRet", ["TWidget"]);
var window_manager_back_to_home = Module.cwrap("window_manager_back_to_home", "TRet", ["TWidget"]);
var window_manager_back_to = Module.cwrap("window_manager_back_to", "TRet", ["TWidget", "string"]);
var window_manager_resize = Module.cwrap("window_manager_resize", "TRet", ["TWidget", "number", "number"]);
var window_manager_close_all = Module.cwrap("window_manager_close_all", "TRet", ["TWidget"]);
var canvas_widget_create = Module.cwrap("canvas_widget_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var canvas_widget_cast = Module.cwrap("canvas_widget_cast", "TWidget", ["TWidget"]);
var color_component_create = Module.cwrap("color_component_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var color_component_cast = Module.cwrap("color_component_cast", "TWidget", ["TWidget"]);
var color_picker_create = Module.cwrap("color_picker_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var color_picker_set_color = Module.cwrap("color_picker_set_color", "TRet", ["TWidget", "string"]);
var color_picker_cast = Module.cwrap("color_picker_cast", "TWidget", ["TWidget"]);
var color_picker_t_get_prop_value = Module.cwrap("color_picker_t_get_prop_value", "string", ["number"]);
var draggable_create = Module.cwrap("draggable_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var draggable_cast = Module.cwrap("draggable_cast", "TWidget", ["TWidget"]);
var draggable_set_top = Module.cwrap("draggable_set_top", "TRet", ["TWidget", "number"]);
var draggable_set_bottom = Module.cwrap("draggable_set_bottom", "TRet", ["TWidget", "number"]);
var draggable_set_left = Module.cwrap("draggable_set_left", "TRet", ["TWidget", "number"]);
var draggable_set_right = Module.cwrap("draggable_set_right", "TRet", ["TWidget", "number"]);
var draggable_set_vertical_only = Module.cwrap("draggable_set_vertical_only", "TRet", ["TWidget", "boolean"]);
var draggable_set_horizontal_only = Module.cwrap("draggable_set_horizontal_only", "TRet", ["TWidget", "boolean"]);
var draggable_set_drag_window = Module.cwrap("draggable_set_drag_window", "TRet", ["TWidget", "boolean"]);
...
var draggable_t_get_prop_vertical_only = Module.cwrap("draggable_t_get_prop_vertical_only", "boolean", ["number"]);
var draggable_t_get_prop_horizontal_only = Module.cwrap("draggable_t_get_prop_horizontal_only", "boolean", ["number"]);
var draggable_t_get_prop_drag_window = Module.cwrap("draggable_t_get_prop_drag_window", "boolean", ["number"]);
var file_browser_view_create = Module.cwrap("file_browser_view_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var file_browser_view_cast = Module.cwrap("file_browser_view_cast", "TWidget", ["TWidget"]);
var file_browser_view_set_init_dir = Module.cwrap("file_browser_view_set_init_dir", "TRet", ["TWidget", "string"]);
var file_browser_view_set_top_dir = Module.cwrap("file_browser_view_set_top_dir", "TRet", ["TWidget", "string"]);
var file_browser_view_set_filter = Module.cwrap("file_browser_view_set_filter", "TRet", ["TWidget", "string"]);
var file_browser_view_reload = Module.cwrap("file_browser_view_reload", "TRet", ["TWidget"]);
var file_browser_view_set_ignore_hidden_files = Module.cwrap("file_browser_view_set_ignore_hidden_files", "TRet", ["TWidget", "boolean"]);
var file_browser_view_set_sort_ascending = Module.cwrap("file_browser_view_set_sort_ascending", "TRet", ["TWidget", "boolean"]);
var file_browser_view_set_show_check_button = Module.cwrap("file_browser_view_set_show_check_button", "TRet", ["TWidget", "boolean"]);
var file_browser_view_set_sort_by = Module.cwrap("file_browser_view_set_sort_by", "TRet", ["TWidget", "string"]);
var file_browser_view_get_cwd = Module.cwrap("file_browser_view_get_cwd", "string", ["TWidget"]);
var file_browser_view_create_dir = Module.cwrap("file_browser_view_create_dir", "TRet", ["TWidget", "string"]);
var file_browser_view_create_file = Module.cwrap("file_browser_view_create_file", "TRet", ["TWidget", "string", "string", "number"]);
...
var file_browser_view_t_get_prop_ignore_hidden_files = Module.cwrap("file_browser_view_t_get_prop_ignore_hidden_files", "boolean", ["number"]);
var file_browser_view_t_get_prop_sort_ascending = Module.cwrap("file_browser_view_t_get_prop_sort_ascending", "boolean", ["number"]);
var file_browser_view_t_get_prop_show_check_button = Module.cwrap("file_browser_view_t_get_prop_show_check_button", "boolean", ["number"]);
var file_browser_view_t_get_prop_sort_by = Module.cwrap("file_browser_view_t_get_prop_sort_by", "string", ["number"]);
var file_chooser_create = Module.cwrap("file_chooser_create", "TFileChooser", []);
var file_chooser_set_init_dir = Module.cwrap("file_chooser_set_init_dir", "TRet", ["TFileChooser", "string"]);
var file_chooser_set_top_dir = Module.cwrap("file_chooser_set_top_dir", "TRet", ["TFileChooser", "string"]);
var file_chooser_set_filter = Module.cwrap("file_chooser_set_filter", "TRet", ["TFileChooser", "string"]);
var file_chooser_cast = Module.cwrap("file_chooser_cast", "TFileChooser", ["TFileChooser"]);
var file_chooser_choose_file_for_save = Module.cwrap("file_chooser_choose_file_for_save", "TRet", ["TFileChooser"]);
var file_chooser_choose_file_for_open = Module.cwrap("file_chooser_choose_file_for_open", "TRet", ["TFileChooser"]);
var file_chooser_choose_folder = Module.cwrap("file_chooser_choose_folder", "TRet", ["TFileChooser"]);
var file_chooser_get_dir = Module.cwrap("file_chooser_get_dir", "string", ["TFileChooser"]);
var file_chooser_get_filename = Module.cwrap("file_chooser_get_filename", "string", ["TFileChooser"]);
var file_chooser_is_aborted = Module.cwrap("file_chooser_is_aborted", "boolean", ["TFileChooser"]);
var gauge_pointer_create = Module.cwrap("gauge_pointer_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var gauge_pointer_cast = Module.cwrap("gauge_pointer_cast", "TWidget", ["TWidget"]);
var gauge_pointer_set_angle = Module.cwrap("gauge_pointer_set_angle", "TRet", ["TWidget", "number"]);
var gauge_pointer_set_image = Module.cwrap("gauge_pointer_set_image", "TRet", ["TWidget", "string"]);
var gauge_pointer_set_anchor = Module.cwrap("gauge_pointer_set_anchor", "TRet", ["TWidget", "string", "string"]);
...
var gauge_create = Module.cwrap("gauge_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var gauge_cast = Module.cwrap("gauge_cast", "TWidget", ["TWidget"]);
var gauge_set_image = Module.cwrap("gauge_set_image", "TRet", ["TWidget", "string"]);
var gauge_set_draw_type = Module.cwrap("gauge_set_draw_type", "TRet", ["TWidget", "TImageDrawType"]);
var gauge_t_get_prop_image = Module.cwrap("gauge_t_get_prop_image", "string", ["number"]);
var gauge_t_get_prop_draw_type = Module.cwrap("gauge_t_get_prop_draw_type", "TImageDrawType", ["number"]);
var image_animation_create = Module.cwrap("image_animation_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var image_animation_set_loop = Module.cwrap("image_animation_set_loop", "TRet", ["TWidget", "boolean"]);
var image_animation_set_image = Module.cwrap("image_animation_set_image", "TRet", ["TWidget", "string"]);
var image_animation_set_interval = Module.cwrap("image_animation_set_interval", "TRet", ["TWidget", "number"]);
var image_animation_set_delay = Module.cwrap("image_animation_set_delay", "TRet", ["TWidget", "number"]);
var image_animation_set_auto_play = Module.cwrap("image_animation_set_auto_play", "TRet", ["TWidget", "boolean"]);
var image_animation_set_sequence = Module.cwrap("image_animation_set_sequence", "TRet", ["TWidget", "string"]);
var image_animation_set_range_sequence = Module.cwrap("image_animation_set_range_sequence", "TRet", ["TWidget", "number", "number"]);
var image_animation_play = Module.cwrap("image_animation_play", "TRet", ["TWidget"]);
var image_animation_stop = Module.cwrap("image_animation_stop", "TRet", ["TWidget"]);
var image_animation_pause = Module.cwrap("image_animation_pause", "TRet", ["TWidget"]);
var image_animation_next = Module.cwrap("image_animation_next", "TRet", ["TWidget"]);
var image_animation_set_format = Module.cwrap("image_animation_set_format", "TRet", ["TWidget", "string"]);
var image_animation_set_unload_after_paint = Module.cwrap("image_animation_set_unload_after_paint", "TRet", ["TWidget", "boolean"]);
var image_animation_set_reverse = Module.cwrap("image_animation_set_reverse", "TRet", ["TWidget", "boolean"]);
var image_animation_set_show_when_done = Module.cwrap("image_animation_set_show_when_done", "TRet", ["TWidget", "boolean"]);
var image_animation_cast = Module.cwrap("image_animation_cast", "TWidget", ["TWidget"]);
var image_animation_is_playing = Module.cwrap("image_animation_is_playing", "boolean", ["TWidget"]);
...
var image_animation_t_get_prop_reverse = Module.cwrap("image_animation_t_get_prop_reverse", "boolean", ["number"]);
var image_animation_t_get_prop_loop = Module.cwrap("image_animation_t_get_prop_loop", "boolean", ["number"]);
var image_animation_t_get_prop_auto_play = Module.cwrap("image_animation_t_get_prop_auto_play", "boolean", ["number"]);
var image_animation_t_get_prop_unload_after_paint = Module.cwrap("image_animation_t_get_prop_unload_after_paint", "boolean", ["number"]);
...
var image_animation_t_get_prop_show_when_done = Module.cwrap("image_animation_t_get_prop_show_when_done", "boolean", ["number"]);
var image_value_create = Module.cwrap("image_value_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var image_value_set_image = Module.cwrap("image_value_set_image", "TRet", ["TWidget", "string"]);
var image_value_set_format = Module.cwrap("image_value_set_format", "TRet", ["TWidget", "string"]);
var image_value_set_click_add_delta = Module.cwrap("image_value_set_click_add_delta", "TRet", ["TWidget", "number"]);
var image_value_set_value = Module.cwrap("image_value_set_value", "TRet", ["TWidget", "number"]);
var image_value_set_min = Module.cwrap("image_value_set_min", "TRet", ["TWidget", "number"]);
var image_value_set_max = Module.cwrap("image_value_set_max", "TRet", ["TWidget", "number"]);
var image_value_cast = Module.cwrap("image_value_cast", "TWidget", ["TWidget"]);
...
var candidates_create = Module.cwrap("candidates_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var candidates_cast = Module.cwrap("candidates_cast", "TWidget", ["TWidget"]);
var candidates_set_pre = Module.cwrap("candidates_set_pre", "TRet", ["TWidget", "boolean"]);
var candidates_set_select_by_num = Module.cwrap("candidates_set_select_by_num", "TRet", ["TWidget", "boolean"]);
var candidates_set_auto_hide = Module.cwrap("candidates_set_auto_hide", "TRet", ["TWidget", "boolean"]);
var candidates_set_button_style = Module.cwrap("candidates_set_button_style", "TRet", ["TWidget", "string"]);
var candidates_t_get_prop_pre = Module.cwrap("candidates_t_get_prop_pre", "boolean", ["number"]);
var candidates_t_get_prop_select_by_num = Module.cwrap("candidates_t_get_prop_select_by_num", "boolean", ["number"]);
var candidates_t_get_prop_auto_hide = Module.cwrap("candidates_t_get_prop_auto_hide", "boolean", ["number"]);
var candidates_t_get_prop_button_style = Module.cwrap("candidates_t_get_prop_button_style", "string", ["number"]);
var lang_indicator_create = Module.cwrap("lang_indicator_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var lang_indicator_set_image = Module.cwrap("lang_indicator_set_image", "TRet", ["TWidget", "string"]);
var lang_indicator_cast = Module.cwrap("lang_indicator_cast", "TWidget", ["TWidget"]);
var lang_indicator_t_get_prop_image = Module.cwrap("lang_indicator_t_get_prop_image", "string", ["number"]);
var line_number_create = Module.cwrap("line_number_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var line_number_set_top_margin = Module.cwrap("line_number_set_top_margin", "TRet", ["TWidget", "number"]);
var line_number_set_bottom_margin = Module.cwrap("line_number_set_bottom_margin", "TRet", ["TWidget", "number"]);
var line_number_set_line_height = Module.cwrap("line_number_set_line_height", "TRet", ["TWidget", "number"]);
var line_number_set_yoffset = Module.cwrap("line_number_set_yoffset", "TRet", ["TWidget", "number"]);
var line_number_cast = Module.cwrap("line_number_cast", "TWidget", ["TWidget"]);
var mledit_create = Module.cwrap("mledit_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var mledit_set_readonly = Module.cwrap("mledit_set_readonly", "TRet", ["TWidget", "boolean"]);
var mledit_set_cancelable = Module.cwrap("mledit_set_cancelable", "TRet", ["TWidget", "boolean"]);
var mledit_set_focus = Module.cwrap("mledit_set_focus", "TRet", ["TWidget", "boolean"]);
var mledit_set_wrap_word = Module.cwrap("mledit_set_wrap_word", "TRet", ["TWidget", "boolean"]);
var mledit_set_max_lines = Module.cwrap("mledit_set_max_lines", "TRet", ["TWidget", "number"]);
var mledit_set_max_chars = Module.cwrap("mledit_set_max_chars", "TRet", ["TWidget", "number"]);
var mledit_set_tips = Module.cwrap("mledit_set_tips", "TRet", ["TWidget", "string"]);
var mledit_set_tr_tips = Module.cwrap("mledit_set_tr_tips", "TRet", ["TWidget", "string"]);
var mledit_set_keyboard = Module.cwrap("mledit_set_keyboard", "TRet", ["TWidget", "string"]);
var mledit_set_cursor = Module.cwrap("mledit_set_cursor", "TRet", ["TWidget", "number"]);
var mledit_get_cursor = Module.cwrap("mledit_get_cursor", "number", ["TWidget"]);
var mledit_set_scroll_line = Module.cwrap("mledit_set_scroll_line", "TRet", ["TWidget", "number"]);
var mledit_scroll_to_offset = Module.cwrap("mledit_scroll_to_offset", "TRet", ["TWidget", "number"]);
var mledit_set_open_im_when_focused = Module.cwrap("mledit_set_open_im_when_focused", "TRet", ["TWidget", "boolean"]);
var mledit_set_close_im_when_blured = Module.cwrap("mledit_set_close_im_when_blured", "TRet", ["TWidget", "boolean"]);
var mledit_set_select = Module.cwrap("mledit_set_select", "TRet", ["TWidget", "number", "number"]);
var mledit_get_selected_text = Module.cwrap("mledit_get_selected_text", "string", ["TWidget"]);
var mledit_cast = Module.cwrap("mledit_cast", "TWidget", ["TWidget"]);
...
var mledit_t_get_prop_wrap_word = Module.cwrap("mledit_t_get_prop_wrap_word", "boolean", ["number"]);
var mledit_t_get_prop_scroll_line = Module.cwrap("mledit_t_get_prop_scroll_line", "number", ["number"]);
var mledit_t_get_prop_readonly = Module.cwrap("mledit_t_get_prop_readonly", "boolean", ["number"]);
var mledit_t_get_prop_cancelable = Module.cwrap("mledit_t_get_prop_cancelable", "boolean", ["number"]);
var mledit_t_get_prop_open_im_when_focused = Module.cwrap("mledit_t_get_prop_open_im_when_focused", "boolean", ["number"]);
var mledit_t_get_prop_close_im_when_blured = Module.cwrap("mledit_t_get_prop_close_im_when_blured", "boolean", ["number"]);
var progress_circle_create = Module.cwrap("progress_circle_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var progress_circle_cast = Module.cwrap("progress_circle_cast", "TWidget", ["TWidget"]);
var progress_circle_set_value = Module.cwrap("progress_circle_set_value", "TRet", ["TWidget", "number"]);
var progress_circle_set_max = Module.cwrap("progress_circle_set_max", "TRet", ["TWidget", "number"]);
var progress_circle_set_format = Module.cwrap("progress_circle_set_format", "TRet", ["TWidget", "string"]);
var progress_circle_set_line_width = Module.cwrap("progress_circle_set_line_width", "TRet", ["TWidget", "number"]);
var progress_circle_set_start_angle = Module.cwrap("progress_circle_set_start_angle", "TRet", ["TWidget", "number"]);
var progress_circle_set_line_cap = Module.cwrap("progress_circle_set_line_cap", "TRet", ["TWidget", "string"]);
var progress_circle_set_show_text = Module.cwrap("progress_circle_set_show_text", "TRet", ["TWidget", "boolean"]);
var progress_circle_set_counter_clock_wise = Module.cwrap("progress_circle_set_counter_clock_wise", "TRet", ["TWidget", "boolean"]);
...
var progress_circle_t_get_prop_counter_clock_wise = Module.cwrap("progress_circle_t_get_prop_counter_clock_wise", "boolean", ["number"]);
var progress_circle_t_get_prop_show_text = Module.cwrap("progress_circle_t_get_prop_show_text", "boolean", ["number"]);
var rich_text_view_create = Module.cwrap("rich_text_view_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var rich_text_view_cast = Module.cwrap("rich_text_view_cast", "TWidget", ["TWidget"]);
var rich_text_create = Module.cwrap("rich_text_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var rich_text_set_text = Module.cwrap("rich_text_set_text", "TRet", ["TWidget", "string"]);
var rich_text_set_yslidable = Module.cwrap("rich_text_set_yslidable", "TRet", ["TWidget", "boolean"]);
var rich_text_cast = Module.cwrap("rich_text_cast", "TWidget", ["TWidget"]);
var rich_text_t_get_prop_line_gap = Module.cwrap("rich_text_t_get_prop_line_gap", "number", ["number"]);
var rich_text_t_get_prop_yslidable = Module.cwrap("rich_text_t_get_prop_yslidable", "boolean", ["number"]);
var hscroll_label_create = Module.cwrap("hscroll_label_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var hscroll_label_set_lull = Module.cwrap("hscroll_label_set_lull", "TRet", ["TWidget", "number"]);
var hscroll_label_set_duration = Module.cwrap("hscroll_label_set_duration", "TRet", ["TWidget", "number"]);
var hscroll_label_set_only_focus = Module.cwrap("hscroll_label_set_only_focus", "TRet", ["TWidget", "boolean"]);
var hscroll_label_set_only_parent_focus = Module.cwrap("hscroll_label_set_only_parent_focus", "TRet", ["TWidget", "boolean"]);
var hscroll_label_set_loop = Module.cwrap("hscroll_label_set_loop", "TRet", ["TWidget", "boolean"]);
var hscroll_label_set_yoyo = Module.cwrap("hscroll_label_set_yoyo", "TRet", ["TWidget", "boolean"]);
var hscroll_label_set_ellipses = Module.cwrap("hscroll_label_set_ellipses", "TRet", ["TWidget", "boolean"]);
var hscroll_label_set_xoffset = Module.cwrap("hscroll_label_set_xoffset", "TRet", ["TWidget", "number"]);
var hscroll_label_start = Module.cwrap("hscroll_label_start", "TRet", ["TWidget"]);
var hscroll_label_stop = Module.cwrap("hscroll_label_stop", "TRet", ["TWidget"]);
var hscroll_label_cast = Module.cwrap("hscroll_label_cast", "TWidget", ["TWidget"]);
var hscroll_label_t_get_prop_only_focus = Module.cwrap("hscroll_label_t_get_prop_only_focus", "boolean", ["number"]);
var hscroll_label_t_get_prop_only_parent_focus = Module.cwrap("hscroll_label_t_get_prop_only_parent_focus", "boolean", ["number"]);
var hscroll_label_t_get_prop_loop = Module.cwrap("hscroll_label_t_get_prop_loop", "boolean", ["number"]);
var hscroll_label_t_get_prop_yoyo = Module.cwrap("hscroll_label_t_get_prop_yoyo", "boolean", ["number"]);
var hscroll_label_t_get_prop_ellipses = Module.cwrap("hscroll_label_t_get_prop_ellipses", "boolean", ["number"]);
...
var list_item_create = Module.cwrap("list_item_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var list_item_cast = Module.cwrap("list_item_cast", "TWidget", ["TWidget"]);
var list_view_h_create = Module.cwrap("list_view_h_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var list_view_h_set_item_width = Module.cwrap("list_view_h_set_item_width", "TRet", ["TWidget", "number"]);
var list_view_h_set_spacing = Module.cwrap("list_view_h_set_spacing", "TRet", ["TWidget", "number"]);
var list_view_h_cast = Module.cwrap("list_view_h_cast", "TWidget", ["TWidget"]);
...
var list_view_create = Module.cwrap("list_view_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var list_view_set_item_height = Module.cwrap("list_view_set_item_height", "TRet", ["TWidget", "number"]);
var list_view_set_default_item_height = Module.cwrap("list_view_set_default_item_height", "TRet", ["TWidget", "number"]);
var list_view_set_auto_hide_scroll_bar = Module.cwrap("list_view_set_auto_hide_scroll_bar", "TRet", ["TWidget", "boolean"]);
var list_view_set_floating_scroll_bar = Module.cwrap("list_view_set_floating_scroll_bar", "TRet", ["TWidget", "boolean"]);
var list_view_cast = Module.cwrap("list_view_cast", "TWidget", ["TWidget"]);
var list_view_reinit = Module.cwrap("list_view_reinit", "TRet", ["TWidget"]);
...
var list_view_t_get_prop_auto_hide_scroll_bar = Module.cwrap("list_view_t_get_prop_auto_hide_scroll_bar", "boolean", ["number"]);
var list_view_t_get_prop_floating_scroll_bar = Module.cwrap("list_view_t_get_prop_floating_scroll_bar", "boolean", ["number"]);
var scroll_bar_create = Module.cwrap("scroll_bar_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var scroll_bar_cast = Module.cwrap("scroll_bar_cast", "TWidget", ["TWidget"]);
var scroll_bar_create_mobile = Module.cwrap("scroll_bar_create_mobile", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var scroll_bar_create_desktop = Module.cwrap("scroll_bar_create_desktop", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var scroll_bar_set_params = Module.cwrap("scroll_bar_set_params", "TRet", ["TWidget", "number", "number"]);
var scroll_bar_scroll_to = Module.cwrap("scroll_bar_scroll_to", "TRet", ["TWidget", "number", "number"]);
var scroll_bar_set_value = Module.cwrap("scroll_bar_set_value", "TRet", ["TWidget", "number"]);
var scroll_bar_add_delta = Module.cwrap("scroll_bar_add_delta", "TRet", ["TWidget", "number"]);
var scroll_bar_scroll_delta = Module.cwrap("scroll_bar_scroll_delta", "TRet", ["TWidget", "number"]);
var scroll_bar_set_value_only = Module.cwrap("scroll_bar_set_value_only", "TRet", ["TWidget", "number"]);
var scroll_bar_set_auto_hide = Module.cwrap("scroll_bar_set_auto_hide", "TRet", ["TWidget", "boolean"]);
var scroll_bar_is_mobile = Module.cwrap("scroll_bar_is_mobile", "boolean", ["TWidget"]);
...
var scroll_bar_t_get_prop_animatable = Module.cwrap("scroll_bar_t_get_prop_animatable", "boolean", ["number"]);
var scroll_bar_t_get_prop_auto_hide = Module.cwrap("scroll_bar_t_get_prop_auto_hide", "boolean", ["number"]);
var scroll_view_create = Module.cwrap("scroll_view_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var scroll_view_cast = Module.cwrap("scroll_view_cast", "TWidget", ["TWidget"]);
var scroll_view_set_virtual_w = Module.cwrap("scroll_view_set_virtual_w", "TRet", ["TWidget", "number"]);
var scroll_view_set_virtual_h = Module.cwrap("scroll_view_set_virtual_h", "TRet", ["TWidget", "number"]);
var scroll_view_set_xslidable = Module.cwrap("scroll_view_set_xslidable", "TRet", ["TWidget", "boolean"]);
var scroll_view_set_yslidable = Module.cwrap("scroll_view_set_yslidable", "TRet", ["TWidget", "boolean"]);
var scroll_view_set_snap_to_page = Module.cwrap("scroll_view_set_snap_to_page", "TRet", ["TWidget", "boolean"]);
var scroll_view_set_move_to_page = Module.cwrap("scroll_view_set_move_to_page", "TRet", ["TWidget", "boolean"]);
var scroll_view_set_recursive = Module.cwrap("scroll_view_set_recursive", "TRet", ["TWidget", "boolean"]);
var scroll_view_set_recursive_only = Module.cwrap("scroll_view_set_recursive_only", "TRet", ["TWidget", "boolean"]);
var scroll_view_set_offset = Module.cwrap("scroll_view_set_offset", "TRet", ["TWidget", "number", "number"]);
var scroll_view_set_speed_scale = Module.cwrap("scroll_view_set_speed_scale", "TRet", ["TWidget", "number", "number"]);
var scroll_view_scroll_to = Module.cwrap("scroll_view_scroll_to", "TRet", ["TWidget", "number", "number", "number"]);
var scroll_view_scroll_delta_to = Module.cwrap("scroll_view_scroll_delta_to", "TRet", ["TWidget", "number", "number", "number"]);
...
var scroll_view_t_get_prop_xslidable = Module.cwrap("scroll_view_t_get_prop_xslidable", "boolean", ["number"]);
var scroll_view_t_get_prop_yslidable = Module.cwrap("scroll_view_t_get_prop_yslidable", "boolean", ["number"]);
var scroll_view_t_get_prop_snap_to_page = Module.cwrap("scroll_view_t_get_prop_snap_to_page", "boolean", ["number"]);
var scroll_view_t_get_prop_move_to_page = Module.cwrap("scroll_view_t_get_prop_move_to_page", "boolean", ["number"]);
var scroll_view_t_get_prop_recursive = Module.cwrap("scroll_view_t_get_prop_recursive", "boolean", ["number"]);
var slide_menu_create = Module.cwrap("slide_menu_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var slide_menu_cast = Module.cwrap("slide_menu_cast", "TWidget", ["TWidget"]);
var slide_menu_set_value = Module.cwrap("slide_menu_set_value", "TRet", ["TWidget", "number"]);
var slide_menu_set_align_v = Module.cwrap("slide_menu_set_align_v", "TRet", ["TWidget", "TAlignV"]);
var slide_menu_set_min_scale = Module.cwrap("slide_menu_set_min_scale", "TRet", ["TWidget", "number"]);
var slide_menu_t_get_prop_value = Module.cwrap("slide_menu_t_get_prop_value", "number", ["number"]);
var slide_menu_t_get_prop_align_v = Module.cwrap("slide_menu_t_get_prop_align_v", "TAlignV", ["number"]);
var slide_menu_t_get_prop_min_scale = Module.cwrap("slide_menu_t_get_prop_min_scale", "number", ["number"]);
var slide_indicator_create = Module.cwrap("slide_indicator_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var slide_indicator_create_linear = Module.cwrap("slide_indicator_create_linear", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var slide_indicator_create_arc = Module.cwrap("slide_indicator_create_arc", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var slide_indicator_cast = Module.cwrap("slide_indicator_cast", "TWidget", ["TWidget"]);
var slide_indicator_set_value = Module.cwrap("slide_indicator_set_value", "TRet", ["TWidget", "number"]);
var slide_indicator_set_max = Module.cwrap("slide_indicator_set_max", "TRet", ["TWidget", "number"]);
var slide_indicator_set_default_paint = Module.cwrap("slide_indicator_set_default_paint", "TRet", ["TWidget", "TIndicatorDefaultPaint"]);
var slide_indicator_set_auto_hide = Module.cwrap("slide_indicator_set_auto_hide", "TRet", ["TWidget", "number"]);
var slide_indicator_set_margin = Module.cwrap("slide_indicator_set_margin", "TRet", ["TWidget", "number"]);
var slide_indicator_set_spacing = Module.cwrap("slide_indicator_set_spacing", "TRet", ["TWidget", "number"]);
var slide_indicator_set_size = Module.cwrap("slide_indicator_set_size", "TRet", ["TWidget", "number"]);
var slide_indicator_set_anchor = Module.cwrap("slide_indicator_set_anchor", "TRet", ["TWidget", "string", "string"]);
var slide_indicator_set_indicated_target = Module.cwrap("slide_indicator_set_indicated_target", "TRet", ["TWidget", "string"]);
...
var slide_indicator_t_get_prop_default_paint = Module.cwrap("slide_indicator_t_get_prop_default_paint", "TIndicatorDefaultPaint", ["number"]);
...
var slide_view_create = Module.cwrap("slide_view_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var slide_view_cast = Module.cwrap("slide_view_cast", "TWidget", ["TWidget"]);
var slide_view_set_auto_play = Module.cwrap("slide_view_set_auto_play", "TRet", ["TWidget", "number"]);
var slide_view_set_active = Module.cwrap("slide_view_set_active", "TRet", ["TWidget", "number"]);
var slide_view_set_active_ex = Module.cwrap("slide_view_set_active_ex", "TRet", ["TWidget", "number", "boolean"]);
var slide_view_set_vertical = Module.cwrap("slide_view_set_vertical", "TRet", ["TWidget", "boolean"]);
var slide_view_set_anim_hint = Module.cwrap("slide_view_set_anim_hint", "TRet", ["TWidget", "string"]);
var slide_view_set_loop = Module.cwrap("slide_view_set_loop", "TRet", ["TWidget", "boolean"]);
var slide_view_remove_index = Module.cwrap("slide_view_remove_index", "TRet", ["TWidget", "number"]);
var slide_view_t_get_prop_vertical = Module.cwrap("slide_view_t_get_prop_vertical", "boolean", ["number"]);
var slide_view_t_get_prop_auto_play = Module.cwrap("slide_view_t_get_prop_auto_play", "number", ["number"]);
var slide_view_t_get_prop_loop = Module.cwrap("slide_view_t_get_prop_loop", "boolean", ["number"]);
var slide_view_t_get_prop_anim_hint = Module.cwrap("slide_view_t_get_prop_anim_hint", "string", ["number"]);
var switch_create = Module.cwrap("switch_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var switch_set_value = Module.cwrap("switch_set_value", "TRet", ["TWidget", "boolean"]);
var switch_cast = Module.cwrap("switch_cast", "TWidget", ["TWidget"]);
var switch_t_get_prop_value = Module.cwrap("switch_t_get_prop_value", "boolean", ["number"]);
var switch_t_get_prop_max_xoffset_ratio = Module.cwrap("switch_t_get_prop_max_xoffset_ratio", "number", ["number"]);
var text_selector_create = Module.cwrap("text_selector_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var text_selector_cast = Module.cwrap("text_selector_cast", "TWidget", ["TWidget"]);
var text_selector_reset_options = Module.cwrap("text_selector_reset_options", "TRet", ["TWidget"]);
var text_selector_count_options = Module.cwrap("text_selector_count_options", "number", ["TWidget"]);
var text_selector_append_option = Module.cwrap("text_selector_append_option", "TRet", ["TWidget", "number", "string"]);
var text_selector_set_options = Module.cwrap("text_selector_set_options", "TRet", ["TWidget", "string"]);
var text_selector_set_range_options_ex = Module.cwrap("text_selector_set_range_options_ex", "TRet", ["TWidget", "number", "number", "number", "string"]);
var text_selector_set_range_options = Module.cwrap("text_selector_set_range_options", "TRet", ["TWidget", "number", "number", "number"]);
var text_selector_get_value = Module.cwrap("text_selector_get_value", "number", ["TWidget"]);
var text_selector_set_value = Module.cwrap("text_selector_set_value", "TRet", ["TWidget", "number"]);
var text_selector_get_text = Module.cwrap("text_selector_get_text", "string", ["TWidget"]);
var text_selector_set_text = Module.cwrap("text_selector_set_text", "TRet", ["TWidget", "string"]);
var text_selector_set_selected_index = Module.cwrap("text_selector_set_selected_index", "TRet", ["TWidget", "number"]);
var text_selector_set_visible_nr = Module.cwrap("text_selector_set_visible_nr", "TRet", ["TWidget", "number"]);
var text_selector_set_localize_options = Module.cwrap("text_selector_set_localize_options", "TRet", ["TWidget", "boolean"]);
var text_selector_set_loop_options = Module.cwrap("text_selector_set_loop_options", "TRet", ["TWidget", "boolean"]);
var text_selector_set_yspeed_scale = Module.cwrap("text_selector_set_yspeed_scale", "TRet", ["TWidget", "number"]);
var text_selector_set_animating_time = Module.cwrap("text_selector_set_animating_time", "TRet", ["TWidget", "number"]);
var text_selector_set_enable_value_animator = Module.cwrap("text_selector_set_enable_value_animator", "TRet", ["TWidget", "boolean"]);
...
var text_selector_t_get_prop_localize_options = Module.cwrap("text_selector_t_get_prop_localize_options", "boolean", ["number"]);
var text_selector_t_get_prop_loop_options = Module.cwrap("text_selector_t_get_prop_loop_options", "boolean", ["number"]);
var text_selector_t_get_prop_enable_value_animator = Module.cwrap("text_selector_t_get_prop_enable_value_animator", "boolean", ["number"]);
var time_clock_create = Module.cwrap("time_clock_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var time_clock_cast = Module.cwrap("time_clock_cast", "TWidget", ["TWidget"]);
var time_clock_set_hour = Module.cwrap("time_clock_set_hour", "TRet", ["TWidget", "number"]);
var time_clock_set_minute = Module.cwrap("time_clock_set_minute", "TRet", ["TWidget", "number"]);
var time_clock_set_second = Module.cwrap("time_clock_set_second", "TRet", ["TWidget", "number"]);
var time_clock_set_hour_image = Module.cwrap("time_clock_set_hour_image", "TRet", ["TWidget", "string"]);
var time_clock_set_minute_image = Module.cwrap("time_clock_set_minute_image", "TRet", ["TWidget", "string"]);
var time_clock_set_second_image = Module.cwrap("time_clock_set_second_image", "TRet", ["TWidget", "string"]);
var time_clock_set_bg_image = Module.cwrap("time_clock_set_bg_image", "TRet", ["TWidget", "string"]);
var time_clock_set_image = Module.cwrap("time_clock_set_image", "TRet", ["TWidget", "string"]);
var time_clock_set_hour_anchor = Module.cwrap("time_clock_set_hour_anchor", "TRet", ["TWidget", "string", "string"]);
var time_clock_set_minute_anchor = Module.cwrap("time_clock_set_minute_anchor", "TRet", ["TWidget", "string", "string"]);
var time_clock_set_second_anchor = Module.cwrap("time_clock_set_second_anchor", "TRet", ["TWidget", "string", "string"]);
...
var vpage_create = Module.cwrap("vpage_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var vpage_cast = Module.cwrap("vpage_cast", "TWidget", ["TWidget"]);
var vpage_set_ui_asset = Module.cwrap("vpage_set_ui_asset", "TRet", ["TWidget", "string"]);
var vpage_set_anim_hint = Module.cwrap("vpage_set_anim_hint", "TRet", ["TWidget", "string"]);
...
var prop_change_event_cast = Module.cwrap("prop_change_event_cast", "TPropChangeEvent", ["TEvent"]);
var prop_change_event_t_get_prop_name = Module.cwrap("prop_change_event_t_get_prop_name", "string", ["number"]);
var prop_change_event_t_get_prop_value = Module.cwrap("prop_change_event_t_get_prop_value", "TValue", ["number"]);
var progress_event_cast = Module.cwrap("progress_event_cast", "TProgressEvent", ["TEvent"]);
var progress_event_t_get_prop_percent = Module.cwrap("progress_event_t_get_prop_percent", "number", ["number"]);
var done_event_cast = Module.cwrap("done_event_cast", "TDoneEvent", ["TEvent"]);
var done_event_t_get_prop_result = Module.cwrap("done_event_t_get_prop_result", "TRet", ["number"]);
var error_event_cast = Module.cwrap("error_event_cast", "TErrorEvent", ["TEvent"]);
...
var cmd_exec_event_cast = Module.cwrap("cmd_exec_event_cast", "TCmdExecEvent", ["TEvent"]);
...
var cmd_exec_event_t_get_prop_result = Module.cwrap("cmd_exec_event_t_get_prop_result", "TRet", ["number"]);
var cmd_exec_event_t_get_prop_can_exec = Module.cwrap("cmd_exec_event_t_get_prop_can_exec", "boolean", ["number"]);
var app_bar_create = Module.cwrap("app_bar_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var app_bar_cast = Module.cwrap("app_bar_cast", "TWidget", ["TWidget"]);
var button_group_create = Module.cwrap("button_group_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var button_group_cast = Module.cwrap("button_group_cast", "TWidget", ["TWidget"]);
var button_create = Module.cwrap("button_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var button_cast = Module.cwrap("button_cast", "TWidget", ["TWidget"]);
var button_set_repeat = Module.cwrap("button_set_repeat", "TRet", ["TWidget", "number"]);
var button_set_long_press_time = Module.cwrap("button_set_long_press_time", "TRet", ["TWidget", "number"]);
var button_set_enable_long_press = Module.cwrap("button_set_enable_long_press", "TRet", ["TWidget", "boolean"]);
var button_t_get_prop_repeat = Module.cwrap("button_t_get_prop_repeat", "number", ["number"]);
var button_t_get_prop_enable_long_press = Module.cwrap("button_t_get_prop_enable_long_press", "boolean", ["number"]);
var button_t_get_prop_long_press_time = Module.cwrap("button_t_get_prop_long_press_time", "number", ["number"]);
var check_button_create = Module.cwrap("check_button_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var check_button_create_radio = Module.cwrap("check_button_create_radio", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var check_button_set_value = Module.cwrap("check_button_set_value", "TRet", ["TWidget", "boolean"]);
var check_button_cast = Module.cwrap("check_button_cast", "TWidget", ["TWidget"]);
var check_button_t_get_prop_value = Module.cwrap("check_button_t_get_prop_value", "boolean", ["number"]);
var clip_view_create = Module.cwrap("clip_view_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var clip_view_cast = Module.cwrap("clip_view_cast", "TWidget", ["TWidget"]);
var color_tile_create = Module.cwrap("color_tile_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var color_tile_cast = Module.cwrap("color_tile_cast", "TWidget", ["TWidget"]);
var color_tile_set_bg_color = Module.cwrap("color_tile_set_bg_color", "TRet", ["TWidget", "string"]);
var color_tile_get_bg_color = Module.cwrap("color_tile_get_bg_color", "string", ["TWidget"]);
var color_tile_get_border_color = Module.cwrap("color_tile_get_border_color", "string", ["TWidget"]);
...
var column_create = Module.cwrap("column_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var column_cast = Module.cwrap("column_cast", "TWidget", ["TWidget"]);
var combo_box_item_create = Module.cwrap("combo_box_item_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var combo_box_item_cast = Module.cwrap("combo_box_item_cast", "TWidget", ["TWidget"]);
var combo_box_item_set_checked = Module.cwrap("combo_box_item_set_checked", "TRet", ["TWidget", "boolean"]);
var combo_box_item_set_value = Module.cwrap("combo_box_item_set_value", "TRet", ["TWidget", "number"]);
var combo_box_item_t_get_prop_value = Module.cwrap("combo_box_item_t_get_prop_value", "number", ["number"]);
var combo_box_item_t_get_prop_checked = Module.cwrap("combo_box_item_t_get_prop_checked", "boolean", ["number"]);
var dialog_client_create = Module.cwrap("dialog_client_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var dialog_client_cast = Module.cwrap("dialog_client_cast", "TWidget", ["TWidget"]);
var dialog_title_create = Module.cwrap("dialog_title_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var dialog_title_cast = Module.cwrap("dialog_title_cast", "TWidget", ["TWidget"]);
var digit_clock_create = Module.cwrap("digit_clock_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var digit_clock_cast = Module.cwrap("digit_clock_cast", "TWidget", ["TWidget"]);
var digit_clock_set_format = Module.cwrap("digit_clock_set_format", "TRet", ["TWidget", "string"]);
var digit_clock_t_get_prop_format = Module.cwrap("digit_clock_t_get_prop_format", "string", ["number"]);
var dragger_create = Module.cwrap("dragger_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var dragger_cast = Module.cwrap("dragger_cast", "TWidget", ["TWidget"]);
var dragger_set_range = Module.cwrap("dragger_set_range", "TRet", ["TWidget", "number", "number", "number", "number"]);
...
var edit_create = Module.cwrap("edit_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var edit_cast = Module.cwrap("edit_cast", "TWidget", ["TWidget"]);
var edit_get_int = Module.cwrap("edit_get_int", "number", ["TWidget"]);
var edit_get_double = Module.cwrap("edit_get_double", "number", ["TWidget"]);
var edit_set_int = Module.cwrap("edit_set_int", "TRet", ["TWidget", "number"]);
var edit_set_double = Module.cwrap("edit_set_double", "TRet", ["TWidget", "number"]);
var edit_set_text_limit = Module.cwrap("edit_set_text_limit", "TRet", ["TWidget", "number", "number"]);
var edit_set_int_limit = Module.cwrap("edit_set_int_limit", "TRet", ["TWidget", "number", "number", "number"]);
var edit_set_float_limit = Module.cwrap("edit_set_float_limit", "TRet", ["TWidget", "number", "number", "number"]);
var edit_set_readonly = Module.cwrap("edit_set_readonly", "TRet", ["TWidget", "boolean"]);
var edit_set_cancelable = Module.cwrap("edit_set_cancelable", "TRet", ["TWidget", "boolean"]);
var edit_set_auto_fix = Module.cwrap("edit_set_auto_fix", "TRet", ["TWidget", "boolean"]);
var edit_set_select_none_when_focused = Module.cwrap("edit_set_select_none_when_focused", "TRet", ["TWidget", "boolean"]);
var edit_set_open_im_when_focused = Module.cwrap("edit_set_open_im_when_focused", "TRet", ["TWidget", "boolean"]);
var edit_set_close_im_when_blured = Module.cwrap("edit_set_close_im_when_blured", "TRet", ["TWidget", "boolean"]);
var edit_set_input_type = Module.cwrap("edit_set_input_type", "TRet", ["TWidget", "TInputType"]);
var edit_set_action_text = Module.cwrap("edit_set_action_text", "TRet", ["TWidget", "string"]);
var edit_set_tips = Module.cwrap("edit_set_tips", "TRet", ["TWidget", "string"]);
var edit_set_tr_tips = Module.cwrap("edit_set_tr_tips", "TRet", ["TWidget", "string"]);
var edit_set_keyboard = Module.cwrap("edit_set_keyboard", "TRet", ["TWidget", "string"]);
var edit_set_password_visible = Module.cwrap("edit_set_password_visible", "TRet", ["TWidget", "boolean"]);
var edit_set_focus = Module.cwrap("edit_set_focus", "TRet", ["TWidget", "boolean"]);
var edit_set_cursor = Module.cwrap("edit_set_cursor", "TRet", ["TWidget", "number"]);
var edit_get_cursor = Module.cwrap("edit_get_cursor", "number", ["TWidget"]);
var edit_set_select = Module.cwrap("edit_set_select", "TRet", ["TWidget", "number", "number"]);
var edit_get_selected_text = Module.cwrap("edit_get_selected_text", "string", ["TWidget"]);
...
var edit_t_get_prop_input_type = Module.cwrap("edit_t_get_prop_input_type", "TInputType", ["number"]);
var edit_t_get_prop_readonly = Module.cwrap("edit_t_get_prop_readonly", "boolean", ["number"]);
var edit_t_get_prop_password_visible = Module.cwrap("edit_t_get_prop_password_visible", "boolean", ["number"]);
var edit_t_get_prop_auto_fix = Module.cwrap("edit_t_get_prop_auto_fix", "boolean", ["number"]);
var edit_t_get_prop_select_none_when_focused = Module.cwrap("edit_t_get_prop_select_none_when_focused", "boolean", ["number"]);
var edit_t_get_prop_open_im_when_focused = Module.cwrap("edit_t_get_prop_open_im_when_focused", "boolean", ["number"]);
var edit_t_get_prop_close_im_when_blured = Module.cwrap("edit_t_get_prop_close_im_when_blured", "boolean", ["number"]);
var edit_t_get_prop_cancelable = Module.cwrap("edit_t_get_prop_cancelable", "boolean", ["number"]);
var grid_item_create = Module.cwrap("grid_item_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var grid_item_cast = Module.cwrap("grid_item_cast", "TWidget", ["TWidget"]);
var grid_create = Module.cwrap("grid_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var grid_cast = Module.cwrap("grid_cast", "TWidget", ["TWidget"]);
var group_box_create = Module.cwrap("group_box_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var group_box_cast = Module.cwrap("group_box_cast", "TWidget", ["TWidget"]);
var label_create = Module.cwrap("label_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var label_set_length = Module.cwrap("label_set_length", "TRet", ["TWidget", "number"]);
var label_set_max_w = Module.cwrap("label_set_max_w", "TRet", ["TWidget", "number"]);
var label_set_line_wrap = Module.cwrap("label_set_line_wrap", "TRet", ["TWidget", "boolean"]);
var label_set_word_wrap = Module.cwrap("label_set_word_wrap", "TRet", ["TWidget", "boolean"]);
var label_resize_to_content = Module.cwrap("label_resize_to_content", "TRet", ["TWidget", "number", "number", "number", "number"]);
var label_cast = Module.cwrap("label_cast", "TWidget", ["TWidget"]);
var label_t_get_prop_length = Module.cwrap("label_t_get_prop_length", "number", ["number"]);
var label_t_get_prop_line_wrap = Module.cwrap("label_t_get_prop_line_wrap", "boolean", ["number"]);
var label_t_get_prop_word_wrap = Module.cwrap("label_t_get_prop_word_wrap", "boolean", ["number"]);
var label_t_get_prop_max_w = Module.cwrap("label_t_get_prop_max_w", "number", ["number"]);
var pages_create = Module.cwrap("pages_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var pages_cast = Module.cwrap("pages_cast", "TWidget", ["TWidget"]);
var pages_set_active = Module.cwrap("pages_set_active", "TRet", ["TWidget", "number"]);
var pages_set_active_by_name = Module.cwrap("pages_set_active_by_name", "TRet", ["TWidget", "string"]);
var pages_t_get_prop_active = Module.cwrap("pages_t_get_prop_active", "number", ["number"]);
var progress_bar_create = Module.cwrap("progress_bar_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var progress_bar_cast = Module.cwrap("progress_bar_cast", "TWidget", ["TWidget"]);
var progress_bar_set_value = Module.cwrap("progress_bar_set_value", "TRet", ["TWidget", "number"]);
var progress_bar_set_max = Module.cwrap("progress_bar_set_max", "TRet", ["TWidget", "number"]);
var progress_bar_set_format = Module.cwrap("progress_bar_set_format", "TRet", ["TWidget", "string"]);
var progress_bar_set_vertical = Module.cwrap("progress_bar_set_vertical", "TRet", ["TWidget", "boolean"]);
var progress_bar_set_show_text = Module.cwrap("progress_bar_set_show_text", "TRet", ["TWidget", "boolean"]);
var progress_bar_set_reverse = Module.cwrap("progress_bar_set_reverse", "TRet", ["TWidget", "boolean"]);
var progress_bar_get_percent = Module.cwrap("progress_bar_get_percent", "number", ["TWidget"]);
...
var progress_bar_t_get_prop_vertical = Module.cwrap("progress_bar_t_get_prop_vertical", "boolean", ["number"]);
var progress_bar_t_get_prop_show_text = Module.cwrap("progress_bar_t_get_prop_show_text", "boolean", ["number"]);
var progress_bar_t_get_prop_reverse = Module.cwrap("progress_bar_t_get_prop_reverse", "boolean", ["number"]);
var row_create = Module.cwrap("row_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var row_cast = Module.cwrap("row_cast", "TWidget", ["TWidget"]);
var slider_create = Module.cwrap("slider_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var slider_cast = Module.cwrap("slider_cast", "TWidget", ["TWidget"]);
var slider_set_value = Module.cwrap("slider_set_value", "TRet", ["TWidget", "number"]);
var slider_set_min = Module.cwrap("slider_set_min", "TRet", ["TWidget", "number"]);
var slider_set_max = Module.cwrap("slider_set_max", "TRet", ["TWidget", "number"]);
var slider_set_step = Module.cwrap("slider_set_step", "TRet", ["TWidget", "number"]);
var slider_set_bar_size = Module.cwrap("slider_set_bar_size", "TRet", ["TWidget", "number"]);
var slider_set_vertical = Module.cwrap("slider_set_vertical", "TRet", ["TWidget", "boolean"]);
...
var slider_t_get_prop_vertical = Module.cwrap("slider_t_get_prop_vertical", "boolean", ["number"]);
...
var slider_t_get_prop_dragger_adapt_to_icon = Module.cwrap("slider_t_get_prop_dragger_adapt_to_icon", "boolean", ["number"]);
var slider_t_get_prop_slide_with_bar = Module.cwrap("slider_t_get_prop_slide_with_bar", "boolean", ["number"]);
var tab_button_group_create = Module.cwrap("tab_button_group_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var tab_button_group_set_compact = Module.cwrap("tab_button_group_set_compact", "TRet", ["TWidget", "boolean"]);
var tab_button_group_set_scrollable = Module.cwrap("tab_button_group_set_scrollable", "TRet", ["TWidget", "boolean"]);
var tab_button_group_cast = Module.cwrap("tab_button_group_cast", "TWidget", ["TWidget"]);
var tab_button_group_t_get_prop_compact = Module.cwrap("tab_button_group_t_get_prop_compact", "boolean", ["number"]);
var tab_button_group_t_get_prop_scrollable = Module.cwrap("tab_button_group_t_get_prop_scrollable", "boolean", ["number"]);
var tab_button_create = Module.cwrap("tab_button_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var tab_button_cast = Module.cwrap("tab_button_cast", "TWidget", ["TWidget"]);
var tab_button_set_value = Module.cwrap("tab_button_set_value", "TRet", ["TWidget", "boolean"]);
var tab_button_set_icon = Module.cwrap("tab_button_set_icon", "TRet", ["TWidget", "string"]);
var tab_button_set_active_icon = Module.cwrap("tab_button_set_active_icon", "TRet", ["TWidget", "string"]);
var tab_button_set_load_ui = Module.cwrap("tab_button_set_load_ui", "TRet", ["TWidget", "string"]);
var tab_button_t_get_prop_value = Module.cwrap("tab_button_t_get_prop_value", "boolean", ["number"]);
...
var tab_control_create = Module.cwrap("tab_control_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var tab_control_cast = Module.cwrap("tab_control_cast", "TWidget", ["TWidget"]);
var view_create = Module.cwrap("view_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var view_set_default_focused_child = Module.cwrap("view_set_default_focused_child", "TRet", ["TWidget", "string"]);
var view_cast = Module.cwrap("view_cast", "TWidget", ["TWidget"]);
var view_t_get_prop_default_focused_child = Module.cwrap("view_t_get_prop_default_focused_child", "string", ["number"]);
var dialog_create = Module.cwrap("dialog_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var dialog_create_simple = Module.cwrap("dialog_create_simple", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var dialog_cast = Module.cwrap("dialog_cast", "TWidget", ["TWidget"]);
var dialog_get_title = Module.cwrap("dialog_get_title", "TWidget", ["TWidget"]);
var dialog_get_client = Module.cwrap("dialog_get_client", "TWidget", ["TWidget"]);
var dialog_open = Module.cwrap("dialog_open", "TWidget", ["string"]);
var dialog_set_title = Module.cwrap("dialog_set_title", "TRet", ["TWidget", "string"]);
var dialog_modal = Module.cwrap("dialog_modal", "TDialogQuitCode", ["TWidget"]);
var dialog_quit = Module.cwrap("dialog_quit", "TRet", ["TWidget", "number"]);
var dialog_is_quited = Module.cwrap("dialog_is_quited", "boolean", ["TWidget"]);
var dialog_is_modal = Module.cwrap("dialog_is_modal", "boolean", ["TWidget"]);
var dialog_toast = Module.cwrap("dialog_toast", "TRet", ["string", "number"]);
var dialog_info = Module.cwrap("dialog_info", "TRet", ["string", "string"]);
var dialog_warn = Module.cwrap("dialog_warn", "TRet", ["string", "string"]);
var dialog_confirm = Module.cwrap("dialog_confirm", "TRet", ["string", "string"]);
var dialog_t_get_prop_highlight = Module.cwrap("dialog_t_get_prop_highlight", "string", ["number"]);
var native_window_move = Module.cwrap("native_window_move", "TRet", ["TNativeWindow", "number", "number", "boolean"]);
var native_window_resize = Module.cwrap("native_window_resize", "TRet", ["TNativeWindow", "number", "number", "boolean"]);
var native_window_minimize = Module.cwrap("native_window_minimize", "TRet", ["TNativeWindow"]);
var native_window_maximize = Module.cwrap("native_window_maximize", "TRet", ["TNativeWindow"]);
var native_window_restore = Module.cwrap("native_window_restore", "TRet", ["TNativeWindow"]);
var native_window_center = Module.cwrap("native_window_center", "TRet", ["TNativeWindow"]);
var native_window_show_border = Module.cwrap("native_window_show_border", "TRet", ["TNativeWindow", "boolean"]);
var native_window_set_fullscreen = Module.cwrap("native_window_set_fullscreen", "TRet", ["TNativeWindow", "boolean"]);
var native_window_set_cursor = Module.cwrap("native_window_set_cursor", "TRet", ["TNativeWindow", "string", "TBitmap"]);
var window_create = Module.cwrap("window_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var window_create_default = Module.cwrap("window_create_default", "TWidget", []);
var window_set_fullscreen = Module.cwrap("window_set_fullscreen", "TRet", ["TWidget", "boolean"]);
var window_set_auto_scale_children = Module.cwrap("window_set_auto_scale_children", "TRet", ["TWidget", "number", "number"]);
var window_open = Module.cwrap("window_open", "TWidget", ["string"]);
var window_open_and_close = Module.cwrap("window_open_and_close", "TWidget", ["string", "TWidget"]);
var window_close = Module.cwrap("window_close", "TRet", ["TWidget"]);
var window_close_force = Module.cwrap("window_close_force", "TRet", ["TWidget"]);
var window_cast = Module.cwrap("window_cast", "TWidget", ["TWidget"]);
var window_t_get_prop_fullscreen = Module.cwrap("window_t_get_prop_fullscreen", "boolean", ["number"]);
var gif_image_create = Module.cwrap("gif_image_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var gif_image_play = Module.cwrap("gif_image_play", "TRet", ["TWidget"]);
var gif_image_stop = Module.cwrap("gif_image_stop", "TRet", ["TWidget"]);
var gif_image_pause = Module.cwrap("gif_image_pause", "TRet", ["TWidget"]);
var gif_image_cast = Module.cwrap("gif_image_cast", "TWidget", ["TWidget"]);
var keyboard_create = Module.cwrap("keyboard_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var keyboard_cast = Module.cwrap("keyboard_cast", "TWidget", ["TWidget"]);
var mutable_image_create = Module.cwrap("mutable_image_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var svg_image_create = Module.cwrap("svg_image_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var svg_image_set_image = Module.cwrap("svg_image_set_image", "TRet", ["TWidget", "string"]);
var svg_image_cast = Module.cwrap("svg_image_cast", "TWidget", ["TWidget"]);
var idle_info_cast = Module.cwrap("idle_info_cast", "TIdleInfo", ["TIdleInfo"]);
var idle_info_t_get_prop_ctx = Module.cwrap("idle_info_t_get_prop_ctx", "any", ["number"]);
var idle_info_t_get_prop_extra_ctx = Module.cwrap("idle_info_t_get_prop_extra_ctx", "any", ["number"]);
var idle_info_t_get_prop_id = Module.cwrap("idle_info_t_get_prop_id", "number", ["number"]);
var object_array_create = Module.cwrap("object_array_create", "TObject", []);
var object_array_unref = Module.cwrap("object_array_unref", "TRet", ["TObject"]);
var object_array_clear_props = Module.cwrap("object_array_clear_props", "TRet", ["TObject"]);
var object_array_insert = Module.cwrap("object_array_insert", "TRet", ["TObject", "number", "TValue"]);
var object_array_push = Module.cwrap("object_array_push", "TRet", ["TObject", "TValue"]);
var object_array_index_of = Module.cwrap("object_array_index_of", "number", ["TObject", "TValue"]);
var object_array_last_index_of = Module.cwrap("object_array_last_index_of", "number", ["TObject", "TValue"]);
var object_array_remove = Module.cwrap("object_array_remove", "TRet", ["TObject", "number"]);
var object_array_get_and_remove = Module.cwrap("object_array_get_and_remove", "TRet", ["TObject", "number", "TValue"]);
var object_array_t_get_prop_size = Module.cwrap("object_array_t_get_prop_size", "number", ["number"]);
var object_default_create = Module.cwrap("object_default_create", "TObject", []);
var object_default_unref = Module.cwrap("object_default_unref", "TRet", ["TObject"]);
var object_default_clear_props = Module.cwrap("object_default_clear_props", "TRet", ["TObject"]);
var object_default_t_get_prop_props_size = Module.cwrap("object_default_t_get_prop_props_size", "number", ["number"]);
var timer_info_cast = Module.cwrap("timer_info_cast", "TTimerInfo", ["TTimerInfo"]);
var timer_info_t_get_prop_ctx = Module.cwrap("timer_info_t_get_prop_ctx", "any", ["number"]);
var timer_info_t_get_prop_extra_ctx = Module.cwrap("timer_info_t_get_prop_extra_ctx", "any", ["number"]);
...
var calibration_win_create = Module.cwrap("calibration_win_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var calibration_win_cast = Module.cwrap("calibration_win_cast", "TWidget", ["TWidget"]);
var combo_box_create = Module.cwrap("combo_box_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var combo_box_cast = Module.cwrap("combo_box_cast", "TWidget", ["TWidget"]);
var combo_box_set_open_window = Module.cwrap("combo_box_set_open_window", "TRet", ["TWidget", "string"]);
var combo_box_reset_options = Module.cwrap("combo_box_reset_options", "TRet", ["TWidget"]);
var combo_box_count_options = Module.cwrap("combo_box_count_options", "number", ["TWidget"]);
var combo_box_set_selected_index = Module.cwrap("combo_box_set_selected_index", "TRet", ["TWidget", "number"]);
var combo_box_set_localize_options = Module.cwrap("combo_box_set_localize_options", "TRet", ["TWidget", "boolean"]);
var combo_box_set_value = Module.cwrap("combo_box_set_value", "TRet", ["TWidget", "number"]);
var combo_box_set_item_height = Module.cwrap("combo_box_set_item_height", "TRet", ["TWidget", "number"]);
var combo_box_append_option = Module.cwrap("combo_box_append_option", "TRet", ["TWidget", "number", "string"]);
var combo_box_remove_option = Module.cwrap("combo_box_remove_option", "TRet", ["TWidget", "number"]);
var combo_box_set_options = Module.cwrap("combo_box_set_options", "TRet", ["TWidget", "string"]);
var combo_box_get_value = Module.cwrap("combo_box_get_value", "number", ["TWidget"]);
var combo_box_get_text = Module.cwrap("combo_box_get_text", "string", ["TWidget"]);
...
var combo_box_t_get_prop_localize_options = Module.cwrap("combo_box_t_get_prop_localize_options", "boolean", ["number"]);
...
var image_create = Module.cwrap("image_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var image_set_draw_type = Module.cwrap("image_set_draw_type", "TRet", ["TWidget", "TImageDrawType"]);
var image_cast = Module.cwrap("image_cast", "TWidget", ["TWidget"]);
var image_t_get_prop_draw_type = Module.cwrap("image_t_get_prop_draw_type", "TImageDrawType", ["number"]);
var overlay_create = Module.cwrap("overlay_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var overlay_set_click_through = Module.cwrap("overlay_set_click_through", "TRet", ["TWidget", "boolean"]);
var overlay_set_always_on_top = Module.cwrap("overlay_set_always_on_top", "TRet", ["TWidget", "boolean"]);
var overlay_cast = Module.cwrap("overlay_cast", "TWidget", ["TWidget"]);
var overlay_t_get_prop_click_through = Module.cwrap("overlay_t_get_prop_click_through", "boolean", ["number"]);
var overlay_t_get_prop_always_on_top = Module.cwrap("overlay_t_get_prop_always_on_top", "boolean", ["number"]);
var popup_create = Module.cwrap("popup_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var popup_cast = Module.cwrap("popup_cast", "TWidget", ["TWidget"]);
var popup_set_close_when_click = Module.cwrap("popup_set_close_when_click", "TRet", ["TWidget", "boolean"]);
var popup_set_close_when_click_outside = Module.cwrap("popup_set_close_when_click_outside", "TRet", ["TWidget", "boolean"]);
var popup_set_close_when_timeout = Module.cwrap("popup_set_close_when_timeout", "TRet", ["TWidget", "number"]);
var popup_t_get_prop_close_when_click = Module.cwrap("popup_t_get_prop_close_when_click", "boolean", ["number"]);
var popup_t_get_prop_close_when_click_outside = Module.cwrap("popup_t_get_prop_close_when_click_outside", "boolean", ["number"]);
var popup_t_get_prop_close_when_timeout = Module.cwrap("popup_t_get_prop_close_when_timeout", "number", ["number"]);
var spin_box_create = Module.cwrap("spin_box_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var spin_box_cast = Module.cwrap("spin_box_cast", "TWidget", ["TWidget"]);
var system_bar_create = Module.cwrap("system_bar_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
var system_bar_cast = Module.cwrap("system_bar_cast", "TWidget", ["TWidget"]);
var combo_box_ex_create = Module.cwrap("combo_box_ex_create", "TWidget", ["TWidget", "number", "number", "number", "number"]);
/**
 * 事件分发器, 用于实现观察者模式。
 *
 */
