...
static ret_t vgcanvas_web_bezier_to(vgcanvas_t *vgcanvas, float_t cp1x, float_t cp1y,
...
static ret_t vgcanvas_web_arc(vgcanvas_t *vgcanvas, float_t x, float_t y, float_t r,
...
{
  float_t font_size = 24;
  const char* font = vgcanvas->font != NULL ? vgcanvas->font : "Sans";
  printf("font_size:%f %f\n", vgcanvas->font_size, font_size);
                                     ...
                                     float_t dh)
{
  ...
  EM_ASM_INT({ return awtkCanvasDrawImage($0, $1, $2, $3, $4, $5, $6, $7, $8); }, 
                                                   ...
                                                   color_t ocolor)
{
  ...
  EM_ASM_INT({ return awtkCanvasSetFillLinearGradient($0, $1, $2, $3, $4, $5); }, 
                                                   ...
                                                   color_t ocolor)
{
  ...
  EM_ASM_INT({ return awtkCanvasSetFillRadialGradient($0, $1, $2, $3, $4, $5); }, 
...
static ret_t vgcanvas_web_set_stroke_linear_gradient(vgcanvas_t *vgcanvas, float_t sx,
                                                     ...
                                                     color_t icolor, color_t ocolor)
{
  ...
  EM_ASM_INT({ return awtkCanvasSetStrokeLinearGradient($0, $1, $2, $3, $4, $5); }, 
    sx, sy, ex, ey, web->start_color, web->end_color);

  return RET_OK;
}

static ret_t vgcanvas_web_set_stroke_radial_gradient(vgcanvas_t *vgcanvas, float_t cx,
                                                     ...
                                                     color_t icolor, color_t ocolor)
{
  ...
  EM_ASM_INT({ return awtkCanvasSetStrokeRadialGradient($0, $1, $2, $3, $4, $5); }, 
    cx, cy, inr, outr, web->start_color, web->end_color);
                            ...
                            void *sdl_window)
{
  ...
  web->base.ratio = EM_ASM_INT({ return awtkCanvasGetDevicePixelRatio(); }, 0);
